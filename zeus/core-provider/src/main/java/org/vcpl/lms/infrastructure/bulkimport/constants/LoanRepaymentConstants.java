 ...
 * under the License.
 */
package org.vcpl.lms.infrastructure.bulkimport.constants;
...
public final class LoanRepaymentConstants {
    ...
    public static final int LOOKUP_LOAN_DISBURSEMENT_DATE_COL = 23;
    public static final int REPAYMENT_MODE_COL = 24;
    public static final String REPAYMENT_MODE = "repaymentMode";
    public static final String repaymentModeIdParamName = "repaymentMode";
    public static final String repaymentModeParamName = "repaymentMode";// U
}
