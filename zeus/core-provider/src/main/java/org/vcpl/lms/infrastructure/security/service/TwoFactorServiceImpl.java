...
import org.vcpl.lms.infrastructure.core.service.PlatformEmailService;
...
import org.vcpl.lms.infrastructure.security.domain.OTPRequestRepository;
import org.vcpl.lms.infrastructure.security.domain.TFAccessToken;
import org.vcpl.lms.infrastructure.security.domain.TFAccessTokenRepository;
import org.vcpl.lms.infrastructure.security.exception.AccessTokenInvalidIException;
import org.vcpl.lms.infrastructure.security.exception.OTPDeliveryMethodInvalidException;
import org.vcpl.lms.infrastructure.security.exception.OTPTokenInvalidException;
...
public class TwoFactorServiceImpl implements TwoFactorService {
    ...
    @Override
    @CachePut(value = "userTFAccessToken", key = "T(org.vcpl.lms.infrastructure.core.service.ThreadLocalContextUtil)"
    ...
    @Override
    @CacheEvict(value = "userTFAccessToken", key = "T(org.vcpl.lms.infrastructure.core.service.ThreadLocalContextUtil)"
            + ".getTenant().getTenantIdentifier().concat(#user.username).concat(#result.token + 'tok')")
    ...
    @Override
    @Cacheable(value = "userTFAccessToken", key = "T(org.vcpl.lms.infrastructure.core.service.ThreadLocalContextUtil)"
