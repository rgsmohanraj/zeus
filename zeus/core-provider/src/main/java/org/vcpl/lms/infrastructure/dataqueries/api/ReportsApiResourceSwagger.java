...
final class ReportsApiResourceSwagger {
    ...
    public static final class PostRepostRequest {
        ...
        @Schema(example = "New Report")
        public String reportName;

        @Schema(example = "CSV")
        public String reportType;

        @Schema(example = "NonTriggered")
        public String reportSubType;

        @Schema(example = "Loan")
        public String reportCategory;

        @Schema(example = "Report Generation for Loans")
        public String description;

        @Schema(example = "select * from report_table")
        public String reportSql;
        ...
        public Collection<ReportParameterData> reportParameters;
        @Schema(example = "zeus/reports/jasperReports")
        public String jasperReportTemplate;
    }
