...
public class LoanSummaryData {
    ...
    private final BigDecimal selfInterestWaived;
    private final BigDecimal partnerInterestWaived;
    ...
    private  final BigDecimal bounceChargesCharged;

    private  final BigDecimal bounceChargesPaid;

    private  final BigDecimal bounceChargesOutstanding;
    private  final BigDecimal bounceChargesWaived;
    private  final BigDecimal bounceChargesWrittenOff;

    private final BigDecimal bounceChargesOverdue;

    private  final BigDecimal coolingOffReversedChargeAmount;
    ...
    public LoanSummaryData(final CurrencyData currency, final BigDecimal principalDisbursed, final BigDecimal principalPaid,
                           ...
                           final BigDecimal totalRecovered,final BigDecimal totalSelfRepayment,final BigDecimal totalPartnerRepayment,
                           final BigDecimal selfPrincipalPaid,final BigDecimal principalPrincipalPaid,final BigDecimal selfInterestPaid,
                           final BigDecimal partnerInterestPaid,final BigDecimal selfInterestWaived,final BigDecimal partnerInterestWaived,final BigDecimal selfFeeChargesWaived,final BigDecimal partnerFeeChargesWaived,
                           final BigDecimal bounceChargesCharged,final BigDecimal bounceChargesPaid,final BigDecimal bounceChargesOutstanding,final BigDecimal bounceChargesWaived,
                           final BigDecimal bounceChargesWrittenOff,BigDecimal bounceChargesOverdue, final BigDecimal coolingOffReversedChargeAmount) {
        ...
        this.selfInterestWaived=selfInterestWaived;
        this.partnerInterestWaived=partnerInterestWaived;
        ...
        this.selfFeeChargesWaived = selfFeeChargesWaived;
        ...
        this.selfPrincipalPaid=principalPaid;
        this.partnerPrincipalPaid=selfPrincipalPaid;
        this.bounceChargesCharged=bounceChargesCharged;
        this.bounceChargesPaid=bounceChargesPaid;
        this.bounceChargesOutstanding=bounceChargesOutstanding;
        this.bounceChargesWaived=bounceChargesWaived;
        this.bounceChargesWrittenOff=bounceChargesWrittenOff;
        this.bounceChargesOverdue=bounceChargesOverdue;
        this.coolingOffReversedChargeAmount = coolingOffReversedChargeAmount;
    }
