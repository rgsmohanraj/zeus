 ...
 * under the License.
 */
package org.vcpl.lms.infrastructure.documentmanagement.service;
...
import org.vcpl.lms.infrastructure.documentmanagement.command.DocumentCommandValidator;
import org.vcpl.lms.infrastructure.documentmanagement.contentrepository.ContentRepository;
import org.vcpl.lms.infrastructure.documentmanagement.contentrepository.ContentRepositoryFactory;
...
import org.vcpl.lms.infrastructure.documentmanagement.domain.StorageType;
import org.vcpl.lms.infrastructure.documentmanagement.exception.ContentManagementException;
import org.vcpl.lms.infrastructure.documentmanagement.exception.DocumentNotFoundException;
import org.vcpl.lms.infrastructure.documentmanagement.exception.InvalidEntityTypeForDocumentManagementException;
...
public class DocumentWritePlatformServiceJpaRepositoryImpl implements DocumentWritePlatformService {
    ...
    @Override
    public Document create(DocumentCommand documentCommand, InputStream inputStream) {
        try {
            this.context.authenticatedUser().validateHasPermissionTo("CREATE_DOCUMENT");
            this.context.authenticatedUser();
            final DocumentCommandValidator validator = new DocumentCommandValidator(documentCommand);
            validateParentEntityType(documentCommand);
            validator.validateForCreate();
    ...
    public Boolean isFileNameExist(String filename) {
        this.context.authenticatedUser().validateHasPermissionTo("CREATE_DOCUMENT");
        return documentRepository.getByFileName(filename).isPresent();
    }
    ...
    public enum DocumentManagementEntity {
        ...
        CLIENTS, CLIENT_IDENTIFIERS, STAFF, LOANS, SAVINGS, GROUPS, IMPORT,BULK_LOANS_REPAYMENT,
        BULK_CLIENT_LOANS_CREATION,
        BULK_CHARGE_REPAYMENT;
