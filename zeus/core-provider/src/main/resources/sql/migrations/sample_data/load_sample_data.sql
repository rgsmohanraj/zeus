...
INSERT INTO `c_configuration` (`id`, `name`, `value`, `date_value`, `enabled`, `is_trap_door`, `description`) VALUES
    ...
    (10, 'penalty-wait-period', 0, NULL, 0, 0, NULL),
...
INSERT INTO `m_appuser` (`id`, `is_deleted`, `office_id`, `staff_id`, `username`, `firstname`, `lastname`, `password`, `email`, `firsttime_login_remaining`, `nonexpired`, `nonlocked`, `nonexpired_credentials`, `enabled`, `last_time_password_updated`, `password_never_expires`, `is_self_service_user`) VALUES
    (1, 0, 1, NULL, 'admin', 'App', 'Administrator', '5787039480429368bf94732aacc771cd0a3ea02bcf504ffe1185ab94213bc63a', 'IT.Development@vivriticapital.com', b'0', b'1', b'1', b'1', b'1', '2014-03-07', 0, b'0'),
    (2, 0, 1, NULL, 'adama', 'Adam', 'A', '08a5c6ee6e7361aa153b4c8620d31bcedef514238a69c0f30f05fe460663cbc6', 'IT.Development@vivriticapital.com', b'0', b'1', b'1', b'1', b'1', '2014-03-07', 0, b'0'),
    (4, 0, 2, NULL, 'benb', 'Ben', 'B', '19d327dc34e2f7b889b571ad9651355e8cce87493611847c70fabf1fcfa914c8', 'IT.Development@vivriticapital.com', b'0', b'1', b'1', b'1', b'1', '2014-03-07', 0, b'0'),
    (5, 0, 3, NULL, 'janej', 'Jane', 'J', 'f37ddcab2b9cfb015d94becdda719361ce13df943058cbf3130db468c288acb9', 'IT.Development@vivriticapital.com', b'0', b'1', b'1', b'1', b'1', '2014-03-07', 0, b'0'),
    (6, 0, 1, NULL, 'system', 'system', 'system', '5787039480429368bf94732aacc771cd0a3ea02bcf504ffe1185ab94213bc63a', 'IT.Development@vivriticapital.com', b'0', b'1', b'1', b'1', b'1', '2014-03-07', 0, b'0');
...
INSERT INTO `m_code_value` (`id`, `code_id`, `code_value`, `code_description`, `order_position`, `code_score`, `is_active`, `is_mandatory`) VALUES
    ...
    (29, 56, 'Charge', NULL, 1, NULL, 1, 0),
    (30, 56, 'Fees', NULL, 2, NULL, 1, 0),
    (31, 57, 'ProcessingFee', NULL, 1, NULL, 1, 0),
    (32, 57, 'Document Charges', NULL, 2, NULL, 1, 0),
    (33, 57, 'InsuranceCharges', NULL, 3, NULL, 1, 0),
    (34, 57, 'Other Charges', NULL, 4, NULL, 1, 0);
...
INSERT INTO `m_currency` (`id`, `code`, `decimal_places`, `currency_multiplesof`, `display_symbol`, `name`, `internationalized_name_code`) VALUES
    ...
    (32, 'CRC', 2, NULL, NULL, 'Costa Rican Colon', 'currency.CRC'),
...
CREATE TABLE IF NOT EXISTS `m_loan_charge` (
  ...
  `gst_enabled` bit(1) DEFAULT NULL,
  `self_share_amount` decimal(19,6) DEFAULT NULL,
   `partner_share_amount` decimal(19,6) DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `m_partner` (
  ...
  `underlying_assets_cv_id` bigint(20) DEFAULT NULL,
  `security_cv_id` bigint(20) DEFAULT NULL,
  `fldg_calculation_on_cv_id` bigint(20) DEFAULT NULL,
  PRIMARY KEY (`id`),
...
-- Dumping structure for table mifostenant-reference.m_product_loan_age_limits_config
...
-- Dumping data for table mifostenant-reference.m_product_loan_age_limits_config: ~0 rows (approximately)
...
-- Dumping structure for table mifostenant-reference.m_colending_charge
...
-- Dumping data for table mifostenant-reference.m_colending_charge: ~0 rows (approximately)
/*!40000 ALTER TABLE `m_colending_charge` DISABLE KEYS */;
/*!40000 ALTER TABLE `m_colending_charge` ENABLE KEYS */;

-- Dumping structure for table mifostenant-reference.m_colending_accepted_dates
...
-- Dumping data for table mifostenant-reference.m_colending_accepted_dates: ~0 rows (approximately)
...
CREATE TABLE IF NOT EXISTS `m_product_loan_fees_charges` (
 `id` bigint(20) NOT NULL AUTO_INCREMENT,
   `product_loan_id` bigint(20) DEFAULT NULL,
   `charge_id` decimal(19,6) DEFAULT NULL,
   `self_share` decimal(19,6) DEFAULT NULL,
   `partner_share` bigint(20) DEFAULT NULL,
