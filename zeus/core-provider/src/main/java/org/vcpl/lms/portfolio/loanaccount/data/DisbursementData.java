...
public class DisbursementData implements Comparable<DisbursementData> {
    ...
    private final BigDecimal selfChargeAmount;
    private final BigDecimal partnerChargeAmount;
    ...
    private DisbursementData(LocalDate actualDisbursementDate, String linkAccountId, Integer rowIndex, String locale, String dateFormat) {
        ...
        this.selfChargeAmount = null;
        this.partnerChargeAmount = null;
    ...
    public DisbursementData(Long id, final LocalDate expectedDisbursementDate, final LocalDate actualDisbursementDate,
            ...
            BigDecimal waivedChargeAmount,final BigDecimal selfPrincipalAmount,final BigDecimal partnerPrincipalAmount,BigDecimal selfChargeAmount,BigDecimal partnerChargeAmount) {
        this.id = id;
        ...
        this.selfChargeAmount = selfChargeAmount;
        this.partnerChargeAmount=partnerChargeAmount;
    ...
    public BigDecimal getSelfPrincipalAmount() {
        return selfPrincipalAmount;
    }
    ...
    public BigDecimal getSelfChargeAmount() {
        return selfChargeAmount;
    }

    public BigDecimal getPartnerChargeAmount() {
        return partnerChargeAmount;
    }
