...
/**
 * Implements {@link org.vcpl.lms.batch.command.CommandStrategy} to handle creation of a new client. It passes
 * the contents of the body from the BatchRequest to {@link org.vcpl.lms.portfolio.client.api.ClientsApiResource}
 * and gets back the response. This class will also catch any errors raised by
 * {@link org.vcpl.lms.portfolio.client.api.ClientsApiResource} and map those errors to appropriate status codes
 * in BatchResponse.
 *
