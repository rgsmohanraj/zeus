...
public enum ChargeTimeType {
    ...
    FORECLOSURE_CHARGE(17, "chargeTimeType.foreclosureCharge"),
    ADHOC_CHARGE(18, "chargeTimeType.adhocCharge"),
    BOUNCE_CHARGE(19,"chargeTimeType.bounceCharge");
    ...
    public static Object[] validLoanValues() {
        return new Integer[] { ChargeTimeType.DISBURSEMENT.getValue(), ChargeTimeType.SPECIFIED_DUE_DATE.getValue(),
                ...
                ChargeTimeType.TRANCHE_DISBURSEMENT.getValue(),ChargeTimeType.FORECLOSURE_CHARGE.getValue(),ChargeTimeType.ADHOC_CHARGE.getValue(),
                ChargeTimeType.BOUNCE_CHARGE.getValue() };
    }
    ...
    public static ChargeTimeType fromInt(final Integer chargeTime) {
        ...
        if (chargeTime != null) {
            switch (chargeTime) {
                ...
                break;
                case 17:
                    chargeTimeType = FORECLOSURE_CHARGE;
                break;
                case 18:
                    chargeTimeType = ADHOC_CHARGE;
                    break;
                case 19:
                    chargeTimeType = BOUNCE_CHARGE;
                    break;
                default:
    ...
    public boolean isAllowedLoanChargeTime() {
        return isTimeOfDisbursement() || isOnSpecifiedDueDate() || isInstalmentFee() ||
               isOverdueInstallment() || isTrancheDisbursement() || isForeclosureCharge() || isAdhocCharge() || isBounceCharge();
    }
    ...
    public boolean isForeclosureCharge() {
        return this.value.equals(ChargeTimeType.FORECLOSURE_CHARGE.getValue());
    }

    public boolean isAdhocCharge() {
        return this.value.equals(ChargeTimeType.ADHOC_CHARGE.getValue());
    }

    public boolean isBounceCharge() { return this.value.equals(ChargeTimeType.BOUNCE_CHARGE.getValue()); }
