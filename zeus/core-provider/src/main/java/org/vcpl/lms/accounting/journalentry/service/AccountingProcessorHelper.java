 ...
 * under the License.
 */
package org.vcpl.lms.accounting.journalentry.service;
...
import org.vcpl.lms.accounting.closure.domain.GLClosure;
import org.vcpl.lms.accounting.closure.domain.GLClosureRepository;
import org.vcpl.lms.accounting.common.AccountingConstants.AccrualAccountsForLoan;
import org.vcpl.lms.accounting.common.AccountingConstants.CashAccountsForLoan;
import org.vcpl.lms.accounting.common.AccountingConstants.CashAccountsForSavings;
import org.vcpl.lms.accounting.common.AccountingConstants.CashAccountsForShares;
import org.vcpl.lms.accounting.common.AccountingConstants.FinancialActivity;
import org.vcpl.lms.accounting.financialactivityaccount.domain.FinancialActivityAccount;
import org.vcpl.lms.accounting.financialactivityaccount.domain.FinancialActivityAccountRepositoryWrapper;
...
import org.vcpl.lms.accounting.journalentry.data.ChargePaymentDTO;
import org.vcpl.lms.accounting.journalentry.data.ClientChargePaymentDTO;
import org.vcpl.lms.accounting.journalentry.data.ClientTransactionDTO;
import org.vcpl.lms.accounting.journalentry.data.LoanDTO;
import org.vcpl.lms.accounting.journalentry.data.LoanTransactionDTO;
import org.vcpl.lms.accounting.journalentry.data.SavingsDTO;
import org.vcpl.lms.accounting.journalentry.data.SavingsTransactionDTO;
import org.vcpl.lms.accounting.journalentry.data.SharesDTO;
import org.vcpl.lms.accounting.journalentry.data.SharesTransactionDTO;
import org.vcpl.lms.accounting.journalentry.data.TaxPaymentDTO;
import org.vcpl.lms.accounting.journalentry.domain.JournalEntry;
import org.vcpl.lms.accounting.journalentry.domain.JournalEntryRepository;
import org.vcpl.lms.accounting.journalentry.domain.JournalEntryType;
import org.vcpl.lms.accounting.journalentry.exception.JournalEntryInvalidException;
import org.vcpl.lms.accounting.journalentry.exception.JournalEntryInvalidException.GlJournalEntryInvalidReason;
import org.vcpl.lms.accounting.producttoaccountmapping.domain.PortfolioProductType;
import org.vcpl.lms.accounting.producttoaccountmapping.domain.ProductToGLAccountMapping;
import org.vcpl.lms.accounting.producttoaccountmapping.domain.ProductToGLAccountMappingRepository;
import org.vcpl.lms.accounting.producttoaccountmapping.exception.ProductToGLAccountMappingNotFoundException;
...
import org.vcpl.lms.portfolio.client.domain.ClientTransaction;
import org.vcpl.lms.portfolio.client.domain.ClientTransactionRepositoryWrapper;
...
import org.vcpl.lms.portfolio.loanaccount.domain.LoanTransactionRepository;
import org.vcpl.lms.portfolio.paymentdetail.domain.PaymentDetail;
import org.vcpl.lms.portfolio.savings.data.SavingsAccountTransactionEnumData;
import org.vcpl.lms.portfolio.savings.domain.SavingsAccountTransaction;
import org.vcpl.lms.portfolio.savings.domain.SavingsAccountTransactionRepository;
import org.vcpl.lms.portfolio.shareaccounts.data.ShareAccountTransactionEnumData;
...
public class AccountingProcessorHelper {
    ...
    public LoanDTO populateLoanDtoFromMap(final Map<String, Object> accountingBridgeData, final boolean cashBasedAccountingEnabled,
        ...
        for (final Map<String, Object> map : newTransactionsMap) {
            ...
            final BigDecimal selfDue = (BigDecimal) map.get("selfDue");
            final BigDecimal partnerDue = (BigDecimal) map.get("partnerDue");
            final BigDecimal principal = (BigDecimal) map.get("principalPortion");
            final BigDecimal selfPrincipal = (BigDecimal) map.get("selfPrincipalPortion");
            final BigDecimal partnerPrincipal = (BigDecimal) map.get("partnerPrincipalPortion");

            final BigDecimal interest = (BigDecimal) map.get("interestPortion");
            final BigDecimal selfInterestCharged = (BigDecimal) map.get("selfInterestPortion");
            final BigDecimal partnerInterestCharged = (BigDecimal) map.get("partnerInterestPortion");
