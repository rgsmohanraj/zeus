...
public interface LoanWritePlatformService {
    ...
    void updateDaysPastDuesForPaidDues();
    ...
    void updateTransactionForXIRR(Collection<XIRRTransactionUpdateRecord> xirrTransactionUpdateRecords);

    void initiateXirrRecalculation(Collection<XIRRTransactionUpdateRecord> xirrTransactionUpdateRecords);

    void calculateDaysPastDueForLoanInstallments(List<OverdueLoanInstallment> overdueLoanInstallments);

    void calculateAdvanceAmountOnDueDate(List<AppropriateAdvanceAmountOnDueDate> AppropriateAdvanceAmountOnDueDate) throws JobExecutionException;

    void updateMaxDPD(List<OverdueLoanInstallment> overdueLoanInstallments);
}
