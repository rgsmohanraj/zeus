...
public class CreocoreLoanRepaymentScheduleTransactionProcessor extends AbstractLoanRepaymentScheduleTransactionProcessor {
    ...
    protected Money handleTransactionThatIsPaymentInAdvanceOfInstallment(final LoanRepaymentScheduleInstallment currentInstallment,
                                                                         ...
                                                                         Money partnerPaymentInAdvance, List<CollectionReport> collectionReports, LoanHistoryRepo loanHistoryRepo,List<LoanTransaction> listOfLoanTransaction,LoanTransaction lateLoanTransaction,LoanTransaction advanceLoanTransction) {
    ...
    protected Money handleTransactionThatIsALateRepaymentOfInstallment(final LoanRepaymentScheduleInstallment currentInstallment,
            final List<LoanRepaymentScheduleInstallment> installments, final LoanTransaction loanTransaction,
            final Money transactionAmountUnprocessed, final List<LoanTransactionToRepaymentScheduleMapping> transactionMappings,Money transactionSelfAmountUnprocessed,Money transactionPartnerAmountUnprocessed,
                                                                       final List<CollectionReport> collectionReports,LoanHistoryRepo loanHistoryRepo,
    ...
    protected Money handleTransactionThatIsOnTimePaymentOfInstallment(final LoanRepaymentScheduleInstallment currentInstallment,
            ...
            final List<LoanTransactionToRepaymentScheduleMapping> transactionMappings,final Money transactionSelfAmountUnprocessed,final Money transactionPartnerAmountUnprocessed,
                                                                      final  List<CollectionReport> collectionReports, LoanHistoryRepo loanHistoryRepo,List<LoanTransaction> overDueLoanTransaction,
