...
public interface ChargeReadPlatformService {
    ...
    Collection<ChargeData> retrieveLoanApplicableForeclosure();
    ...
    Collection<LoanProductFeesChargesData> retrieveColendingCharge(Long loanProductId);

    Collection<ColendingChargeData> retrieveColendingLoanForeclosureCharge(Long productId);

    Collection<ColendingChargeData> retrieveColendingOtherCharges(Long productId);

    Collection<LoanProductFeesChargesData> retrieveOverdueCharge(Long loanProductId);

    Collection<ColendingChargeData> retrieveColendingLoanBounceCharge(Long productId);
