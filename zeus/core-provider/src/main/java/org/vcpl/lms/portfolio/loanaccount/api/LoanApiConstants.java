...
public interface LoanApiConstants {
    ...
    String selfShare ="selfShare";
    String partnerShare ="partnerShare";
    String loanEvent = "loanEvent";
    String xirrValue = "xirrValue";
    String createdDate = "createdDate";
    String amount = "amount";
    String foreclosureChargesParameterName = "foreclosureCharges";
    String overduechargeParameterName = "overdueCharges";
    String chargeAmount = "ChargeAmount";
    String partnerName= "partnerName";
    String REPAYMENTMODE = "RepaymentMode";
    String repaymentModeIdParamName = "repaymentMode";
    String repaymentModeParamName = "repaymentMode";

    String partnerId = "partnerId";
    String productId = "productId";
    String loanAccNoPreference = "loanAccNoPreference";
    String shortName = "shortName";
    String sequenceNumber = "sequenceNumber";

    String bounceChargeParameterName = "bounceCharge";
