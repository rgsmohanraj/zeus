 ...
 * under the License.
 */
package org.vcpl.lms.infrastructure.core.serialization;
    ...
    public Boolean extractBooleanNamed(final String parameterName, final JsonElement element, final Set<String> requestParamatersDetected) {
        ...
        if (element.isJsonObject()) {
            ...
            if (object.has(parameterName) && object.get(parameterName).isJsonPrimitive()) {
                ...
                if (StringUtils.isNotBlank(primitive.getAsString())) {
                    if (!primitive.isBoolean()) {
                        final String stringValue = primitive.getAsString();
                        throw new PlatformApiDataValidationException(Collections.singletonList(
                                ApiParameterError.parameterErrorWithValue("validation.msg." + parameterName + ".value" + ".is.not.a.boolean.value",
                                        "The " + parameterName + " value `" + stringValue + "` must be a boolean value ",
                                        parameterName, stringValue, stringValue)));
                    }
            ...
            if (object.has(parameterName) && object.get(parameterName).isJsonPrimitive()) {
                ...
                if (StringUtils.isNotBlank(stringValue)) {
                    if(!StringUtils.isNumeric(stringValue)){
                        throw new PlatformApiDataValidationException(Collections.singletonList(
                                ApiParameterError.parameterErrorWithValue("validation.msg." + parameterName + ".value" + ".is.not.a.numeric.value",
                                "The " + parameterName + " value `" + stringValue + "` must be a numeric value ", parameterName , stringValue, stringValue )));
                    }
            ...
            if (object.has(parameterName) && object.get(parameterName).isJsonPrimitive()) {
                ...
                if (StringUtils.isNotBlank(valueAsString)) {
                    if(!StringUtils.isNumeric(valueAsString)) {
                        throw new PlatformApiDataValidationException(Collections.singletonList(
                                ApiParameterError.parameterErrorWithValue("validation.msg." + parameterName + ".value" + ".is.not.a.numeric.value",
                                        "The " + parameterName + " value `" + valueAsString + "` must be a numeric value ",
                                        parameterName, valueAsString, valueAsString)));
                    }
