...
-- Dumping structure for table mifostenant-reference.m_loan_product_class
DROP TABLE IF EXISTS `m_loan_product_class`;
CREATE TABLE IF NOT EXISTS `m_loan_product_class` (
...
-- Dumping data for table mifostenant-reference.m_loan_product_class: ~0 rows (approximately)
/*!40000 ALTER TABLE `m_loan_product_class` DISABLE KEYS */;
/*!40000 ALTER TABLE `m_loan_product_class` ENABLE KEYS */;

-- Dumping structure for table mifostenant-reference.m_loan_product_type
DROP TABLE IF EXISTS `m_loan_product_type`;
CREATE TABLE IF NOT EXISTS `m_loan_product_type` (
  `id` bigint(20) NOT NULL AUTO_INCREMENT,
...
-- Dumping data for table mifostenant-reference.m_loan_product_type: ~0 rows (approximately)
