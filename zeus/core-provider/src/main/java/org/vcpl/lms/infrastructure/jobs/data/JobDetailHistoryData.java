 ...
 * under the License.
 */
package org.vcpl.lms.infrastructure.jobs.data;
...
public class JobDetailHistoryData {
    ...
    @SuppressWarnings("unused")
    private final String jobRunStartTime;

    @SuppressWarnings("unused")
    private final String jobRunEndTime;
    ...
    public JobDetailHistoryData(final Long version, final String jobRunStartTime, final String jobRunEndTime, final String status,
