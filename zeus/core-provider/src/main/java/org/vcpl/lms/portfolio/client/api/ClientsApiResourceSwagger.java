...
final class ClientsApiResourceSwagger {
    ...
    public static final class PostClientsRequest {
        ...
        @Schema(example = "12 January 2023")
        public String activationDate;

        @Schema(example = "Nethaji")
        public String firstname;
        ...
        @Schema(example = "Dravid")
        public String beneficiaryName;

        @Schema(example = "Chennai")
        public String city;

        @Schema(example = "12247245647364")
        public String beneficiaryAccountNumber;

        @Schema(example = "DRR8659456k")
        public String ifscCode;

        @Schema(example = "866609876")
        public Long micrCode;

        @Schema(example = "SWQ27364545")
        ...
        @Schema(example = "lms@gmail.com")
        public String emailAddress;

        @Schema(example = "12 January 2023")
        public LocalDate dateOfBirth;
        @Schema(example = "TN09886660")
        public String voterId;
        @Schema(example = "Y0943245")
        public String passportNumber;

        @Schema(example = "987654669871209")
        ...
        @Schema(example = "1")
        public transient Integer rowIndex;
        ...
        @Schema(example = "128")
        public Integer clientClassificationId;
        @Schema(example = "1")
        public Integer legalFormId;

        @Schema(example = "12 June 2023")
        public LocalDate submittedOnDate;

        @Schema(example = "KDESM1234M")
        public String pan;

        @Schema(example = "866609876098")
        public String aadhaar;

        @Schema(example = "80")
        public Integer accountTypeId;

        @Schema(example = "6th Street gandhi nagar chennai")
        public String address;

        @Schema(example = "800119")
        public Long pincode;
        @Schema(example = "TN12243554656")
    ...
    static final class PostAaadhaarData{
        private PostAaadhaarData(){   }
