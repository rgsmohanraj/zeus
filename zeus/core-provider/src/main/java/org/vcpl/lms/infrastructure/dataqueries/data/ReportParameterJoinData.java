 ...
 * under the License.
 */
package org.vcpl.lms.infrastructure.dataqueries.data;
...
public final class ReportParameterJoinData {
    ...
    private final String jasperReportTemplate;
    ...
    public ReportParameterJoinData(final Long reportId, final String reportName, final String reportType, final String reportSubType,
            ...
            final String parameterName,final String jasperReportTemplate) {
    ...
    public String getJasperReportTemplate(){return this.jasperReportTemplate;}
}
