...
public interface LoanAccountDomainService {
    ...
    LoanTransaction makeRepayment(LoanTransactionType repaymentTransactionType, Loan loan, CommandProcessingResultBuilder builderResult,
                                  ...
                                  BigDecimal selfDue, BigDecimal partnerDue, Integer installmentNumber, String receiptReferenceNumber, String partnerTransferUtr,
                                  Date partnerTransferDate, CodeValue repaymentMode,Integer triggeredBy,LoanHistoryRepo loanHistoryRepo);
    ...
    LoanTransaction makeRepayment(LoanTransactionType repaymentTransactionType, Loan loan, CommandProcessingResultBuilder builderResult,
                                  ...
                                  boolean isLoanToLoanTransfer, BigDecimal selfDue, BigDecimal partnerDue, Integer installmentNumber, String receiptReferenceNumber,
                                  String partnerTransferUtr, Date partnerTransferDate, CodeValue repaymentMode, Integer triggeredBy,LoanHistoryRepo loanHistoryRepo);

    void saveLoanWithDataIntegrityViolationChecks(Loan loan);

    Map<String, Object> foreCloseLoan(Loan loan, LocalDate foreClosureDate, String noteText, String receiptReferenceNumber, String partnerTransferUtr, Date partnerTransferDate, CodeValue repaymentMode);
