 ...
 * under the License.
 */
package org.vcpl.lms.portfolio.fund.service;
...
import org.vcpl.lms.portfolio.fund.serialization.FundCommandFromApiJsonDeserializer;
...
public class FundWritePlatformServiceJpaRepositoryImpl implements FundWritePlatformService {
    ...
    @Transactional
    @Override
    @CacheEvict(value = "funds", key = "T(org.vcpl.lms.infrastructure.core.service.ThreadLocalContextUtil).getTenant().getTenantIdentifier().concat('fn')")
