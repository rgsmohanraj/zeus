 ...
 * under the License.
 */
package org.vcpl.lms.infrastructure.sms.scheduler;
...
import org.vcpl.lms.infrastructure.campaigns.helper.SmsConfigUtils;
import org.vcpl.lms.infrastructure.campaigns.sms.constants.SmsCampaignConstants;
import org.vcpl.lms.infrastructure.campaigns.sms.domain.SmsCampaign;
import org.vcpl.lms.infrastructure.campaigns.sms.exception.ConnectionFailureException;
...
import org.vcpl.lms.infrastructure.gcm.service.NotificationSenderService;
import org.vcpl.lms.infrastructure.jobs.annotation.CronTarget;
import org.vcpl.lms.infrastructure.jobs.service.JobName;
import org.vcpl.lms.infrastructure.sms.data.SmsMessageApiQueueResourceData;
import org.vcpl.lms.infrastructure.sms.data.SmsMessageDeliveryReportData;
...
import org.vcpl.lms.infrastructure.sms.service.SmsReadPlatformService;
...
public class SmsMessageScheduledJobServiceImpl implements SmsMessageScheduledJobService {
    ...
    class SmsTask implements Runnable, ApplicationListener<ContextClosedEvent> {
        ...
        private final ZeusPlatformTenant tenant;
        private final Collection<SmsMessageApiQueueResourceData> apiQueueResourceDatas;

        SmsTask(final ZeusPlatformTenant tenant, final Collection<SmsMessageApiQueueResourceData> apiQueueResourceDatas) {
            this.tenant = tenant;
    ...
    private void connectAndSendToIntermediateServer(Collection<SmsMessageApiQueueResourceData> apiQueueResourceDatas) {
        ...
        if (responseOne != null) {
            ...
            if (!responseOne.getStatusCode().equals(HttpStatus.ACCEPTED)) {
                LOG.debug("{}", responseOne.getStatusCode());
