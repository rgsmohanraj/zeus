...
//    private boolean allowForeclosureLockingPeriod;
    ...
    @Column(name = "partner_interest_rate")
    private Integer partnerInterestRate;
...
//        final boolean overAmountDetails=command.booleanObjectValueOfParameterNamed("overAmountDetails");
        ...
        final Integer partnerInterestRate=command.integerValueOfParameterNamed("partnerInterestRate");
...
//        }
        ...
        return new LoanProduct(fund,loanProductClass,loanProductType, loanTransactionProcessingStrategy, name, shortName, description, currency, principal, minPrincipal,
                ...
                selfInterestRate,principalShare,feeShare,penaltyShare,overpaidShare,interestRate,selectPartner,enableChargeWiseBifacation,acceptedDateType,acceptedStartDate,acceptedEndDate,acceptedDate,selectCharge,partnerPrincipalShare,partnerFeeShare,partnerPenaltyShare,partnerOverpaidShare,partnerInterestRate);
...
//    }
    ...
    public Integer getSelfInterestRate() {
    ...
    public Integer getPartnerInterestRate() {
