...
export const environment = {
  ...
  baseApiUrls: 'https://zeus-datamigration.vivriticapital.com',
  // For connecting to server running elsewhere set the base API URL
  //baseApiUrl: window['env']['fineractApiUrl'] || 'https://demo.fineract.dev',
  baseApiUrl: 'https://zeus-datamigration.vivriticapital.com',
...
console.log("Loading environment.migration.ts - server URL: ", environment.serverUrl);
