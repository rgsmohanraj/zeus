...
import org.vcpl.lms.infrastructure.survey.data.SurveyData;
import org.vcpl.lms.infrastructure.survey.data.SurveyDataTableData;
import org.vcpl.lms.infrastructure.survey.service.ReadSurveyService;
...
public class SurveyApiResource {
    ...
    @Consumes({ MediaType.APPLICATION_JSON })
    @Produces({ MediaType.APPLICATION_JSON })
    @Operation(summary = "Retrieve survey", description = "Lists a registered survey table details and the Zeus Core application table they are registered to.")
    @ApiResponses({
