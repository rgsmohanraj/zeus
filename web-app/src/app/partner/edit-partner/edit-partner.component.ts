...
/**
     ...
     * @param {PartnerService} partnerService Clients Service
...
//                         ...this.partnerPartnerStep.partnerPartnerDetails,
  ...
  submit() {
      ...
      this.partnerService.updateDataPartner(this.partnerTemplate.id,partnerData)
