 ...
 * under the License.
 */
package org.vcpl.lms.commands.api;
...
import org.vcpl.lms.commands.service.AuditReadPlatformService;
...
@Component
@Scope("singleton")
@Tag(name = "Audits", description = "Every non-read zeus API request is audited. A fully processed request can not be changed or deleted. See maker checker api for situations where an audit is not fully processed.\n"
        + "\n"
