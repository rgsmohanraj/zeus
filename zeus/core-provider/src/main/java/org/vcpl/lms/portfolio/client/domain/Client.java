...
import org.vcpl.lms.infrastructure.documentmanagement.domain.Image;
...
public final class Client extends AbstractPersistableCustom {
    ...
    @Column(name = "beneficiary_name", length = 50, nullable = true)
    private String beneficiaryName;

    @Column(name = "beneficiary_account_number", length = 40, nullable = true)
    private String beneficiaryAccountNumber;

    @Column(name = "ifsc_code", length = 50, nullable = true)
    private String ifscCode;

    @Column(name = "micr_code", length = 50, nullable = true)
    ...
    @Column(name = "age", length = 50, nullable = true, unique = true)
    private Integer age;
...
//    @ManyToOne(fetch = FetchType.LAZY)
//    @JoinColumn(name = "repaymentMode_cv_id", nullable = true)
//    private CodeValue repaymentMode;
    ...
    @Column(name = "pan", length = 50, nullable = true, unique = true)
    private String pan;

    @Convert(converter = AadhaarEncryptor.class)
    @Column(name = "aadhaar", length = 50, nullable = true, unique = true)
    ...
    @Column(name = "voter_id", length = 10, nullable = true)
    private String voterId;

    @Column(name = "passport_number", length = 12, nullable = true)
    private String passportNumber;

    @Column(name = "driving_license", length = 18, nullable = true)
    private String drivingLicense;

    @Column(name = "pincode", length = 6, nullable = true)
    private Long pincode;

    @Column(name = "ration_card_number", length = 30, nullable = true)
    private String rationCardNumber;

    public static Client createNew(final AppUser currentUser, final Office clientOffice, final Group clientParentGroup, final Staff staff,
            final Long savingsProductId, final CodeValue gender,final CodeValue state, final CodeValue clientType, final CodeValue clientClassification,
            final Integer legalForm, final JsonCommand command,final CodeValue accountType) {
        ...
        final Integer age = command.integerValueOfParameterNamed(ClientApiConstants.ageParamName);
        ...
        final String beneficiaryName = command.stringValueOfParameterNamed(ClientApiConstants.beneficiaryNameParamName);
        final String city = command.stringValueOfParameterNamed(ClientApiConstants.cityParamName);

        final String beneficiaryAccountNumber = command.stringValueOfParameterNamed(ClientApiConstants.beneficiaryAccountNumberParamName);

        final String ifscCode = command.stringValueOfParameterNamed(ClientApiConstants.ifscCodeParamName).toUpperCase();

        final Long micrCode = command.longValueOfParameterNamed(ClientApiConstants.micrCodeParamName);

        final String swiftCode = command.stringValueOfParameterNamed(ClientApiConstants.swiftCodeParamName);

        final String branch = command.stringValueOfParameterNamed(ClientApiConstants.branchParamName);
        ...
        final String voterId = command.stringValueOfParameterNamed(ClientApiConstants.voterIdParamName).toUpperCase();
        final String passportNumber = command.stringValueOfParameterNamed(ClientApiConstants.passportNumberParamName).toUpperCase();
        final String drivingLicense = command.stringValueOfParameterNamed(ClientApiConstants.drivingLicenseParamName).toUpperCase();
        ...
        final String pan = command.stringValueOfParameterNamed(ClientApiConstants.panParamName).toUpperCase();
        final String aadhaar = command.stringValueOfParameterNamed(ClientApiConstants.aadhaarParamName).toUpperCase();

        final Long savingsAccountId = null;
        final String address = command.stringValueOfParameterNamed(ClientApiConstants.addressParamName);
        final Long pincode = command.longValueOfParameterNamed(ClientApiConstants.pincodeParamName);
        final String rationCardNumber = command.stringValueOfParameterNamed(ClientApiConstants.rationCardNumberParamName).toUpperCase();

        return new Client(currentUser, status, clientOffice, clientParentGroup, accountNo, firstname, middlename, lastname,beneficiaryName,beneficiaryAccountNumber,ifscCode,micrCode,swiftCode,branch, fullname,
                activationDate, officeJoiningDate, externalId, mobileNo,age, emailAddress, staff, submittedOnDate, savingsProductId,
                savingsAccountId, dataOfBirth, gender,state,city,clientType, clientClassification, legalForm, isStaff,pan,aadhaar,accountType, address,voterId,passportNumber,drivingLicense,pincode,rationCardNumber);
    }
    ...
    private Client(final AppUser currentUser, final ClientStatus status, final Office office, final Group clientParentGroup,
            final String accountNo, final String firstname, final String middlename, final String lastname,final String beneficiaryName,final String beneficiaryAccountNumber,final String ifscCode,final Long micrCode,final String swiftCode,final String branch, final String fullname,
            final LocalDate activationDate, final LocalDate officeJoiningDate, final String externalId, final String mobileNo,final Integer age,
            final String emailAddress, final Staff staff, final LocalDate submittedOnDate, final Long savingsProductId,
            final Long savingsAccountId, final LocalDate dateOfBirth, final CodeValue gender,final CodeValue state,final String city,final CodeValue clientType,
            final CodeValue clientClassification, final Integer legalForm, final Boolean isStaff,final String pan, final String aadhaar,final CodeValue accountType,
                   final String address,final String voterId,final String passportNumber,String drivingLicense,Long pincode,final String rationCardNumber) {
...
//        }
    ...
    public Map<String, Object> update(final JsonCommand command) {
        ...
        if (command.isChangeInIntegerParameterNamed(ClientApiConstants.ageParamName, this.age)) {
            final Integer newValue = command.integerValueOfParameterNamed(ClientApiConstants.ageParamName);
...
//            this.mobileNo = StringUtils.defaultIfEmpty(newValue, null);
        ...
        if (command.isChangeInStringParameterNamed(ClientApiConstants.beneficiaryNameParamName, this.beneficiaryName)) {
            final String newValue = command.stringValueOfParameterNamed(ClientApiConstants.beneficiaryNameParamName);
            actualChanges.put(ClientApiConstants.beneficiaryNameParamName, newValue);
        ...
        if (command.isChangeInStringParameterNamed(ClientApiConstants.beneficiaryAccountNumberParamName, this.beneficiaryAccountNumber)) {
            final String newValue = command.stringValueOfParameterNamed(ClientApiConstants.beneficiaryAccountNumberParamName);
            actualChanges.put(ClientApiConstants.beneficiaryAccountNumberParamName, newValue);
            this.beneficiaryAccountNumber =  newValue;


        }
        if (command.isChangeInStringParameterNamed(ClientApiConstants.ifscCodeParamName, this.ifscCode)) {
            final String newValue = command.stringValueOfParameterNamed(ClientApiConstants.ifscCodeParamName).toUpperCase();
            actualChanges.put(ClientApiConstants.ifscCodeParamName, newValue);
            this.ifscCode = StringUtils.defaultIfEmpty(newValue, null);
        }
        if (command.isChangeInLongParameterNamed(ClientApiConstants.micrCodeParamName, this.micrCode)) {
            final Long newValue = command.longValueOfParameterNamed(ClientApiConstants.micrCodeParamName);
            actualChanges.put(ClientApiConstants.micrCodeParamName, newValue);
            this.micrCode = newValue;

//            this.lastname = StringUtils.defaultIfEmpty(newValue, null);
        }
        if (command.isChangeInStringParameterNamed(ClientApiConstants.swiftCodeParamName, this.swiftCode)) {
            final String newValue = command.stringValueOfParameterNamed(ClientApiConstants.swiftCodeParamName);
            actualChanges.put(ClientApiConstants.swiftCodeParamName, newValue);
            this.swiftCode = StringUtils.defaultIfEmpty(newValue, null);
        }
        if (command.isChangeInStringParameterNamed(ClientApiConstants.branchParamName, this.branch)) {
            final String newValue = command.stringValueOfParameterNamed(ClientApiConstants.branchParamName);
            actualChanges.put(ClientApiConstants.branchParamName, newValue);
        ...
        if (command.isChangeInLongParameterNamed(ClientApiConstants.stateIdParamName, stateId())) {
            final Long newValue = command.longValueOfParameterNamed(ClientApiConstants.stateIdParamName);
            actualChanges.put(ClientApiConstants.stateIdParamName, newValue);
        }

//        if (command.isChangeInLongParameterNamed(ClientApiConstants.repaymentModeIdParamName, repaymentModeId())) {
//            final Long newValue = command.longValueOfParameterNamed(ClientApiConstants.repaymentModeIdParamName);
//            actualChanges.put(ClientApiConstants.repaymentModeIdParamName, newValue);
//        }
...
//        }
        ...
        if (command.isChangeInStringParameterNamed(ClientApiConstants.panParamName, this.pan)) {
            final String newValue = command.stringValueOfParameterNamed(ClientApiConstants.panParamName).toUpperCase();
            actualChanges.put(ClientApiConstants.panParamName, newValue);
            this.pan = StringUtils.defaultIfEmpty(newValue,null);
//
        }

        if (command.isChangeInStringParameterNamed(ClientApiConstants.aadhaarParamName, this.aadhaar)) {
            final String newValue = command.stringValueOfParameterNamed(ClientApiConstants.aadhaarParamName).toUpperCase();
            actualChanges.put(ClientApiConstants.aadhaarParamName, newValue);
            this.aadhaar = StringUtils.defaultIfEmpty(newValue,null);
        }

        if (command.isChangeInLongParameterNamed(ClientApiConstants.accountTypeIdParamName, accountTypeId())) {
            final Long newValue = command.longValueOfParameterNamed(ClientApiConstants.accountTypeIdParamName);
            actualChanges.put(ClientApiConstants.accountTypeIdParamName, newValue);
        }

        if (command.isChangeInStringParameterNamed(ClientApiConstants.voterIdParamName, this.voterId)) {
            final String newValue = command.stringValueOfParameterNamed(ClientApiConstants.voterIdParamName).toUpperCase();
            actualChanges.put(ClientApiConstants.voterIdParamName, newValue);
            this.voterId = StringUtils.defaultIfEmpty(newValue, null);
        }

        if (command.isChangeInStringParameterNamed(ClientApiConstants.passportNumberParamName, this.passportNumber)) {
            final String newValue = command.stringValueOfParameterNamed(ClientApiConstants.passportNumberParamName).toUpperCase();
            actualChanges.put(ClientApiConstants.passportNumberParamName, newValue);
            this.passportNumber = StringUtils.defaultIfEmpty(newValue, null);
        }

        if (command.isChangeInStringParameterNamed(ClientApiConstants.drivingLicenseParamName, this.drivingLicense)) {
            final String newValue = command.stringValueOfParameterNamed(ClientApiConstants.drivingLicenseParamName).toUpperCase();
            actualChanges.put(ClientApiConstants.drivingLicenseParamName, newValue);
            this.drivingLicense = StringUtils.defaultIfEmpty(newValue, null);
        }
        ...
        if (command.isChangeInLongParameterNamed(ClientApiConstants.pincodeParamName, this.pincode)) {
            final Long newValue = command.longValueOfParameterNamed(ClientApiConstants.pincodeParamName);
            actualChanges.put(ClientApiConstants.pincodeParamName, newValue);
            this.pincode = newValue;
        }
        if (command.isChangeInStringParameterNamed(ClientApiConstants.rationCardNumberParamName, this.rationCardNumber)) {
            final String newValue = command.stringValueOfParameterNamed(ClientApiConstants.rationCardNumberParamName).toUpperCase();
            actualChanges.put(ClientApiConstants.rationCardNumberParamName, newValue);
            this.rationCardNumber = StringUtils.defaultIfEmpty(newValue,null);
        }
    ...
    public String pan(){return this.pan;}

    public String getAadhaar(){return this.aadhaar;}

    public void setPan(final String pan){this.pan = pan;}

    public void setAadhaar(final String aadhaar){this.aadhaar = aadhaar;}
...
//    public Long repaymentModeId() {
//        Long repaymentModeId = null;
//        if (this.repaymentMode != null) {
//            repaymentModeId = this.repaymentMode.getId();
//        }
//        return repaymentModeId;
//    }
    ...
    public CodeValue state() {
        return this.state;
    }



//    public CodeValue repaymentMode(){return this. repaymentMode;}
    ...
    public CodeValue accountType(){return this.accountType;}

    public void updateGender(CodeValue gender) {
        this.gender = gender;
    }

    public void updateState(CodeValue state) {
        this.state = state;
    }


//    public void updateRepaymentMode(CodeValue repaymentMode) {
//        this.repaymentMode = repaymentMode;
//    }
...
//    public CodeValue getRepaymentMode(){return repaymentMode;}

    public  CodeValue getAccountType(){return accountType;}
