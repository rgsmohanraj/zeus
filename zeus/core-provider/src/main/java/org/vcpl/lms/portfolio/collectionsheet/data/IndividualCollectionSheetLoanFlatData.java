...
public class IndividualCollectionSheetLoanFlatData {
    ...
    public IndividualCollectionSheetLoanFlatData(final String clientName, final Long clientId, final Long loanId, final String accountId,
                                                 ...
                                                 final BigDecimal feePaid,final BigDecimal selfPrincipal,final BigDecimal partnerPrincipal,final BigDecimal selfInterestCharged,final BigDecimal partnerInterestCharged,final BigDecimal selfDue,final BigDecimal partnerDue) {
    ...
    public LoanDueData getLoanDueData() {
        return new LoanDueData(this.loanId, this.accountId, this.accountStatusId, this.productShortName, this.productId, this.currency,
                ...
                this.feeDue, this.feePaid,this.selfPrincipal,this.partnerPrincipal,this.selfInterestCharged,this.partnerInterestCharged,this.selfDue,this.partnerDue);
    }
