...
export class ClientsService {
  ...
  getClientSignatureImage(clientId: string, documentId: string) {
    const httpParams = new HttpParams().set('tenantIdentifier', environment.zeusPlatformTenantId);
  ...
  executeClientCommand(clientId: string, command: string, data: any): Observable<any> {
    ...
    updateAadhaar(clientId: string ,data:any): Observable<any>  {
        return this.http.put(`/clients/${clientId}/aadhaar`,data);
      }
