...
import { DisbursementSummaryComponent } from './loans-view/disbursement-summary/disbursement-summary.component';
...
import { BankTransactionTabComponent } from './loans-view/bank-transaction-tab/bank-transaction-tab.component';
import { BankTransactionResolver } from './common-resolvers/bank-transaction.resolver';
import { InitiatePennydropComponent } from './loans-view/loan-account-actions/initiate-pennydrop/initiate-pennydrop.component';
// import { InitiateDisbursementComponent } from './loans-view/loan-account-actions/initiate-disbursement/initiate-disbursement.component';
...
import { MonthlyAccrualTabComponent } from './loans-view/monthly-accrual-tab/monthly-accrual-tab.component';
...
const routes: Routes = [
  {
    ...
    children: [
      {
        path: 'create',
        data: { title: extract('Create Loans Account'), breadcrumb: 'Create Loans Account',routePermission:'CREATE_LOAN' },
      ...
      {
      path: ':loanId',
      data: { title: extract('Loan View'), routeParamBreadcrumb: 'loanId',routePermission:'READ_LOAN' },
      resolve: {
      ...
      children: [
        {
          ...
          children: [
...

            {
                  ...
                  component: DisbursementSummaryComponent,
                   data: { title: extract('Disbursement Summary'), breadcrumb: 'Disbursement Summary', routeParamBreadcrumb: false }
               },
            ...
            },
            {
               ...
               component: BankTransactionTabComponent,
               data: { title: extract('Bank Transaction'), breadcrumb: 'Bank Transaction', routeParamBreadcrumb: false },
             },
            ...
            {
              path: 'accruals',
              component: MonthlyAccrualTabComponent,
              data: { title: extract('Monthly Accruals'), breadcrumb: 'Monthly Accruals', routeParamBreadcrumb: false },
            },
            {
              path: 'loan-collateral',
              component: LoanCollateralTabComponent,
              data: { title: extract('Loan Collateral Details'), breadcrumb: 'Loan Collateral Details', routeParamBreadcrumb: false,routePermission:'READ_COLLATERAL' },
            },
            {
            ...
            },
            {
              ...
              data: { title: extract('Loan Documents'), breadcrumb: 'Loan Documents', routeParamBreadcrumb: false,routePermission:'READ_DOCUMENT' },
              resolve: {
            ...
            },
            {
              ...
              data: { title: extract('Notes'), breadcrumb: 'Notes', routeParamBreadcrumb: false,routePermission:'READ_LOANNOTE' },
              resolve: {
            ...
            },
            {
              ...
              data: { title: extract('Standing Instructions'), breadcrumb: 'Standing Instructions', routeParamBreadcrumb: false,routePermission:'READ_STANDINGINSTRUCTION' }
            },
            {
              path: 'datatables',
              children: [{
...
//         },
        {
          ...
          data: { title: extract('Edit Loans Account'), breadcrumb: 'Edit Loans Account', routeParamBreadcrumb: 'Edit',routePermission:'UPDATE_LOAN' },
