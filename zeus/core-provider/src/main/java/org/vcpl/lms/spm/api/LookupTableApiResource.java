...
import org.vcpl.lms.spm.data.LookupTableData;
import org.vcpl.lms.spm.domain.LookupTable;
import org.vcpl.lms.spm.domain.Survey;
import org.vcpl.lms.spm.exception.LookupTableNotFoundException;
import org.vcpl.lms.spm.exception.SurveyNotFoundException;
import org.vcpl.lms.spm.service.LookupTableService;
import org.vcpl.lms.spm.service.SpmService;
import org.vcpl.lms.spm.util.LookupTableMapper;
...
@Component
@Scope("singleton")
@Tag(name = "SPM API - LookUp Table", description = "The Zeus SPM API provides the ability to create custom surveys to collect social performance measurentment data or any additional questionnaire a financial institute want to collect.")
