...
import org.vcpl.lms.portfolio.loanaccount.service.LoanChargeWaiverService;
...
public class WaiveLoanChargeCommandHandler implements NewCommandSourceHandler {
    ...
    private final LoanChargeWaiverService loanChargeWaiverService;

    @Autowired
    public WaiveLoanChargeCommandHandler(final ChargeCollectionApiJsonValidator validator,final LoanChargeWaiverService loanChargeWaiverService) {
        this.loanChargeWaiverService = loanChargeWaiverService;
    ...
    public CommandProcessingResult processCommand(final JsonCommand command) {
        ChargeTransactionRequest chargeTransactionRequest = validator.chargeTransaction(command.json(), true);
        LoanTransaction transaction = this.loanChargeWaiverService.waive(chargeTransactionRequest);
