...
export class PeriodicAccrualsComponent implements OnInit {
  ...
  submit() {
    ...
    console.log(periodicAccruals.dateFormat,"periodicAccruals.tillDate");
    if (periodicAccruals.tillDate instanceof Date) {
      periodicAccruals.tillDate = this.dateUtils.getDate(periodicAccruals.tillDate);
      console.log(periodicAccruals.tillDate,"periodicAccruals.tillDate");
      console.log(this.dateUtils.getDate(periodicAccruals.tillDate));
    }
