...
public enum LoanTransactionType {
    ...
    FORECLOSURE(11, "loanTransactionType.foreclosure"),//
    ...
    SCHEDULER(24, "loanTransactionType.scheduler"),
    ADHOC_CHARGE(25,"loanTransactionType.adhocCharge"),
    COOLING_OFF(26, "loanTransactionType.coolingOff"),
    CHARGE_REVERSAL(27, "loanTransactionType.chargeReversal");//
    ...
    public static LoanTransactionType fromInt(final Integer transactionType) {
        ...
        switch (transactionType) {
            ...
            break;
            case 11:
                loanTransactionType = LoanTransactionType.FORECLOSURE;
                break;
            case 12:
            ...
            break;
            case 24:
                loanTransactionType = LoanTransactionType.SCHEDULER;
                break;
            case 25:
                loanTransactionType = LoanTransactionType.ADHOC_CHARGE;
                break;
            case 26:
                loanTransactionType = LoanTransactionType.COOLING_OFF;
                break;
            case 27:
                loanTransactionType = LoanTransactionType.CHARGE_REVERSAL;
                break;
            default:
    ...
    public boolean isScheduler() {
        return this.value.equals(LoanTransactionType.SCHEDULER.getValue());
    }
    ...
    public boolean isForeClosure() {
        return this.value.equals(LoanTransactionType.FORECLOSURE.getValue());
    }
    public boolean isCoolingOff() {
        return this.value.equals(LoanTransactionType.COOLING_OFF.getValue());
    }
    public boolean isChargeReversal() {
        return this.value.equals(LoanTransactionType.CHARGE_REVERSAL.getValue());
    }
    ...
    public boolean isAdhocCharge() {
        return this.value.equals(LoanTransactionType.ADHOC_CHARGE.getValue());
    }
}
