...
const routes: Routes = [
  Route.withShell([
    {
      path: 'accounting',
      data: { title: extract('Accounting'), breadcrumb: 'Accounting',routePermission:'READ_ACCOUNTINGRULE' },
      children: [
        {
          path: '', 
        ...
        },
        {
          ...
          data: { title: extract('Search Journal Entry'), breadcrumb: 'Journal Entries',routePermission:'READ_JOURNALENTRY' },
          children: [
            {
              path: '',
            ...
            },
            {
              ...
              data: { title: extract('Create Journal Entry'), breadcrumb: 'Create',routePermission:'CREATE_JOURNALENTRY' },
              resolve: {
                offices: OfficesResolver,
                currencies: CurrenciesResolver,
                paymentTypes: PaymentTypesResolver,
        ...
        },
        {
          ...
          data: { title: extract('Financial Activity Mappings'), breadcrumb: 'Financial Activity Mappings',routePermission:'READ_FINANCIALACTIVITYACCOUNT'},
          children: [
            {
              path: '',
            ...
            },
            {
              ...
              data: { title: extract('Create Financial Activity Mapping'), breadcrumb: 'Create',routePermission:'CREATE_FINANCIALACTIVITYACCOUNT' },
              resolve: {
            ...
            },
            {
              ...
              children: [
                ...
                },
                {
                  ...
                  data: { title: extract('Edit Financial Activity Mapping'), breadcrumb: 'Edit', routeParamBreadcrumb: false,routePermission:'UPDATE_FINANCIALACTIVITYACCOUNT' },
                  resolve: {
        ...
        },
        {
          ...
          data: { title:  extract('Migrate Opening Balances'), breadcrumb: 'Migrate Opening Balances',routePermission:'DEFINEOPENINGBALANCE_JOURNALENTRY' },
          resolve: {
            offices: OfficesResolver,
            currencies: CurrenciesResolver
          }
              ...
              children: [
                {
                  ...
                  data: { title: extract('Create GL Account'), breadcrumb: 'Create GL Account',routePermission:'CREATE_GLACCOUNT' },
                  resolve: {
                ...
                },
                {
                  ...
                  children: [
                    ...
                    },
                    {
                      ...
                      data: { title: extract('Edit GL Account'), breadcrumb: 'Edit', routeResolveBreadcrumb: false,routePermission:'UPDATE_GLACCOUNT' }
                    }
                  ]
                }
              ]
        ...
        },
        {
          ...
          children: [
            ...
            },
            {
              ...
              data: { title: extract('Create Accounting Rule'), breadcrumb: 'Create',routePermission:'CREATE_ACCOUNTINGRULE' },
              resolve: {
            ...
            },
            {
              ...
              children: [
                ...
                },
                {
                  ...
                  data: { title: extract('Edit Accounting Rules'), breadcrumb: 'Edit', routeResolveBreadcrumb: false,routePermission:'UPDATE_ACCOUNTINGRULE' },
                  resolve: {
                    accountingRulesTemplate: AccountingRulesTemplateResolver
                  }
                }
        ...
        },
        {
          ...
          data: { title: extract('Periodic Accrual Accounting'), breadcrumb: 'Execute Periodic Accrual Accounting',routePermission:'EXECUTE_PERIODICACCRUALACCOUNTING' }
        },
        {
          ...
          children: [
            ...
            },
            {
              ...
              data: { title: extract('Create Provisioning Entry'), breadcrumb: 'Create',routePermission:'CREATE_PROVISIONENTRIES' }
            },
            {
              path: 'view/:id',
            ...
            {
              path: 'journal-entries',
              data: { breadcrumb: 'Journal Entries', addBreadcrumbLink: false,routePermission:'READ_JOURNALENTRY' },
              children: [
                {
                  path: 'view/:id',
