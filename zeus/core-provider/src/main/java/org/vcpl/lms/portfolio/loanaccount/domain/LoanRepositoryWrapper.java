...
public class LoanRepositoryWrapper {
    ...
    public boolean isExternalExistForPartner(final String externalId, final Long partnerId){
        return this.repository.getByExternalIdAndPartnerId(externalId,partnerId).isPresent();
    }
}
