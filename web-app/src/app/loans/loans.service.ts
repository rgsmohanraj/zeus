...
export class LoansService {
  ...
  let httpParams = new HttpParams().set('loanId', loanId)
    return this.http.get(`/loans/${loanId}`);
  }

  initiatepennyDrop(loanId:string): Observable<any>{
    return this.http.post(`/loans/initiatepennydrop/${loanId}`,{});
  }

  initiateDisbursement(loanId:string): Observable<any>{
     return this.http.post(`/loans/initiatedisbursement/${loanId}`,{});
  }
   ...
   * @param {any} data Data
   */
  loanForeclosureData(loanId: any, data: any, command: any) {
  ...
  getLoanDocuments(loanId: any): Observable<any> {
   ...
   getBankTransaction(loanId:string):Observable<any>
    {
    return this.http.get(`/loans/${loanId}/pennydropanddisbursement`);
    }
  ...
  downloadLoanDocument(loanId: string, documentId: string) {
          return this.http.get(`/loans/${loanId}/documents/${documentId}/attachment`, { responseType: 'blob' });
        }
