...
import org.vcpl.lms.portfolio.loanproduct.domain.LoanProductValueConditionType;
...
public final class LoanAccountData {
    ...
    private final BigDecimal netSelfDisbursalAmount;
    private final BigDecimal netPartnerDisbursalAmount;
    ...
    private final Collection<ColendingChargeData> foreClosureCharge;
    ...
    private final Collection<ColendingChargeData> chargeOption;


    @Transient
    private final BigDecimal feeChargesAtDisbursementCharged;
    private final BigDecimal selfFeeChargesAtDisbursementCharged;
    private final BigDecimal partnerFeeChargesAtDisbursementCharged;
...
//    private final Integer maxAge;
    ...
    private final BigDecimal brokenInterestDerived;
    private final BigDecimal selfPrincipalAmount;

    private  final BigDecimal brokenInterestPaid;
    private final BigDecimal partnerPrincipalAmount;
    private final Collection<DisbursementSummary> disbursementSummaries;
    private final BigDecimal totalGstAmount;
    private final BigDecimal xirrValue;
    private final LoanProductData loanProductData;

    private final List<LoanAccrualData> loanAccruals;
   private final BankTranscationData bankTranscationData;

   private final Collection<LoanProductFeesChargesData> loanProductFeesChargesData;

   private final ServicerFeeData servicerFeeData;

    private BigDecimal vclHurdleRate;

    private final Collection<ColendingChargeData> bounceCharge;
    ...
    public static LoanAccountData importInstanceIndividual(EnumOptionData loanTypeEnumOption, Long clientId, Long productId,
            ...
            String linkAccountId, String locale, String dateFormat, List<LoanCollateralManagementData> loanCollateralManagementData,BigDecimal brokenInterestDerived,BigDecimal brokenInterestPaid) {
        ...
        return new LoanAccountData(loanTypeEnumOption, clientId, productId, loanOfficerId, submittedOnDate, fundId, principal,
                ...
                null, charges, linkAccountId, locale, dateFormat, loanCollateralManagementData,brokenInterestPaid,brokenInterestDerived, null);
    }
    ...
    public static LoanAccountData importInstanceGroup(EnumOptionData loanTypeEnumOption, Long groupIdforGroupLoan, Long productId,
            ...
            String externalId, String linkAccountId, String locale, String dateFormat,BigDecimal brokenInterestPaid,BigDecimal brokenInterestDerived) {
        ...
        return new LoanAccountData(loanTypeEnumOption, groupIdforGroupLoan, productId, loanOfficerId, submittedOnDate, fundId, principal,
                ...
                null,brokenInterestPaid,brokenInterestDerived, null);
    }
    ...
    private LoanAccountData(EnumOptionData loanType, Long clientId, Long productId, Long loanOfficerId, LocalDate submittedOnDate,
                            ...
                            Collection<LoanCollateralManagementData> loanCollateralManagementData, BigDecimal brokenInterestDerived, BigDecimal brokenInterestPaid, List<LoanAccrualData> loanAccruals) {


        this.brokenInterestDerived=brokenInterestDerived;
        this.brokenInterestPaid=brokenInterestPaid;
        ...
        this.loanAccruals = loanAccruals;
        this.rates = null;
        this.id = null;
        this.accountNo = null;
        ...
        this.netSelfDisbursalAmount=null;
        this.netPartnerDisbursalAmount=null;
        ...
        this.foreClosureCharge=null;
        this.chargeOption=null;
        this.loanCollateralOptions = null;
        this.calendarOptions = null;
        this.feeChargesAtDisbursementCharged = null;
        this.selfFeeChargesAtDisbursementCharged =null;
        this.partnerFeeChargesAtDisbursementCharged = null;
...
//        this.maxAge = null;
        ...
        this.disbursementSummaries=null;
        this.totalGstAmount=null;
        this.xirrValue=null;
        this.loanProductData=null;
        this.bankTranscationData = null;
        this.partner = null;
        this.loanProductFeesChargesData = null;
        this.servicerFeeData = null;
        this.bounceCharge = null;
    }
    ...
    public static LoanAccountData collateralTemplate(final Collection<CodeValueData> loanCollateralOptions) {
        ...
        final BigDecimal netSelfDisbursalAmount =null;
        final BigDecimal netPartnerDisbursalAmount=null;
        final BigDecimal SelfPrincipaAmount = null;
        final BigDecimal selfDisbursedAmount = null;
        final BigDecimal partnerDisbursedAmount = null;
        ...
        final BigDecimal selfFeeChargesDueAtDisbursementCharged = null;
        final BigDecimal partnerFeeChargesDueAtDisbursementCharged = null;
        ...
        final Collection<ColendingChargeData> foreClosureCharge = null;
        ...
        final Boolean allowAgeLimits = Boolean.FALSE;
...
//        final Integer maxAge = null;
        ...
        final BigDecimal brokenInterestPaid=null;
        final BigDecimal brokenInterestDerived=null;
		final BigDecimal selfPrincipalAmount=null;
        final BigDecimal partnerPrincipalAmount=null;
        final Collection<ColendingChargeData> chargeOption = null;
        final Collection<DisbursementSummary> disbursementSummaries=null;
        final BigDecimal toalGstAmount =null;
        final BigDecimal xirrValue = null;
        final LoanProductData loanProductData=null;

        final BankTranscationData bankTranscationData = null;
        final Collection <LoanProductFeesChargesData> loanProductFeesChargesData = null;
        final ServicerFeeData servicerFeeData = null;

        final PartnerData partnerData = null;

        final Collection<ColendingChargeData> bounceCharge = null;
        ...
        return new LoanAccountData(id, accountNo, status, externalId, clientId, clientAccountNo, clientName, clientOfficeId, group,
                ...
                isVariableInstallmentsAllowed, minimumGap, maximumGap, allowAgeLimits, subStatus, canUseForTopup, clientActiveLoanOptions, isTopup,
                closureLoanId, closureLoanAccountNo, topupAmount, isEqualAmortization, rates, isRatesEnabled,
                fixedPrincipalPercentagePerInstallment, delinquent,brokenInterestPaid
                ,brokenInterestDerived,selfPrincipalAmount,partnerPrincipalAmount,chargeOption,netSelfDisbursalAmount,
                netPartnerDisbursalAmount,disbursementSummaries,toalGstAmount,loanProductData,xirrValue,foreClosureCharge,
                selfFeeChargesDueAtDisbursementCharged,partnerFeeChargesDueAtDisbursementCharged, null,partnerData,bankTranscationData,loanProductFeesChargesData,servicerFeeData,null,
                bounceCharge);
    }
...
//        final Integer maxAge = null;
        ...
        final Collection<ColendingChargeData> chargeOption = null;
        final Collection<DisbursementSummary> disbursementSummaries=null;
        final BigDecimal totalGstAmount=null;
        final BigDecimal xirrValue =null;
        final LoanProductData loanProductData=null;
        final BankTranscationData bankTranscationData = null;
        final Collection<VpayTransactionDetailsData> vpayTransactionDetailsData = null;
        final PartnerData partnerData = null;
        final Collection<LoanProductFeesChargesData> loanProductFeesChargesData = null;
        final ServicerFeeData servicerFeeData=null;
        final Collection<ColendingChargeData> bounceCharge = null;
        ...
        return new LoanAccountData(id, accountNo, status, externalId, clientId, clientAccountNo, clientName, clientOfficeId, group,
                ...
                isVariableInstallmentsAllowed, minimumGap, maximumGap, allowAgeLimits,

                subStatus, canUseForTopup, clientActiveLoanOptions, isTopup,
                closureLoanId, closureLoanAccountNo, topupAmount, isEqualAmortization, rates, isRatesEnabled,
                fixedPrincipalPercentagePerInstallment, delinquent,brokenInterestPaid,brokenInterestDerived,
                selfPrincipalAmount,partnerPrincipalAmount,chargeOption,netSelfDisbursalAmount,netPartnerDisbursalAmount,
                disbursementSummaries,totalGstAmount,loanProductData,xirrValue,foreClosureCharge, selfFeeChargesDueAtDisbursementCharged,
                partnerFeeChargesDueAtDisbursementCharged, null,partnerData,bankTranscationData,loanProductFeesChargesData,servicerFeeData,null,
                bounceCharge);
    }
    ...
    public static LoanAccountData populateClientDefaults(final LoanAccountData acc, final LoanAccountData clientAcc) {
        ...
        return new LoanAccountData(acc.id, acc.accountNo, acc.status, acc.externalId, clientAcc.clientId, clientAcc.clientAccountNo,
                ...
                acc.minimumGap, acc.maximumGap,  acc.allowAgeLimits,
                acc.subStatus, acc.canUseForTopup, acc.clientActiveLoanOptions, acc.isTopup,
                acc.closureLoanId, acc.closureLoanAccountNo, acc.topupAmount, acc.isEqualAmortization, acc.rates, acc.isRatesEnabled,
                acc.fixedPrincipalPercentagePerInstallment, acc.delinquent,acc.brokenInterestPaid,acc.brokenInterestDerived,
                acc.selfPrincipalAmount,acc.partnerPrincipalAmount,acc.chargeOption,acc.netSelfDisbursalAmount,acc.netPartnerDisbursalAmount,
                acc.disbursementSummaries,acc.totalGstAmount,acc.loanProductData,acc.xirrValue,acc.foreClosureCharge,
                acc.selfFeeChargesAtDisbursementCharged,acc.partnerFeeChargesAtDisbursementCharged,acc.loanAccruals,acc.partner,acc.bankTranscationData,acc.loanProductFeesChargesData,acc.servicerFeeData,
                acc.vclHurdleRate, acc.bounceCharge);
    ...
    public static LoanAccountData groupDefaults(final GroupGeneralData group, final LocalDate expectedDisbursementDate) {
        ...
        final BigDecimal principal = null;
        final BigDecimal netDisbursalAmount = null;
        final BigDecimal netSelfDisbursedAmount = null;
        final BigDecimal netPartnerDisbursedAmount = null;
        final BigDecimal totalOverpaid = null;
        final BigDecimal inArrearsTolerance = null;
        final Integer termFrequency = null;
        final EnumOptionData termPeriodFrequencyType = null;
...
//        final Integer maxAge = null;
        ...
        return new LoanAccountData(id, accountNo, status, externalId, clientId, clientAccountNo, clientName, clientOfficeId, group,
                ...
                closureLoanId, closureLoanAccountNo, topupAmount, isEqualAmortization, rates, isRatesEnabled,
                fixedPrincipalPercentagePerInstallment, delinquent,brokenInterestPaid,brokenInterestDerived,
                selfPrincipalAmount,partnerPrincipalAmount,chargeOption,netSelfDisbursedAmount,netPartnerDisbursedAmount,
                disbursementSummaries,totalGstAmount,loanProductData,xirrValue,foreClosureCharge,selfFeeChargesDueAtDisbursementCharged,
                partnerFeeChargesDueAtDisbursementCharged,null,partnerData,bankTranscationData,loanProductFeesChargesData,servicerFeeData,null,
                bounceCharge);
    }
    ...
    public static LoanAccountData populateGroupDefaults(final LoanAccountData acc, final LoanAccountData groupAcc) {
        ...
        return new LoanAccountData(acc.id, acc.accountNo, acc.status, acc.externalId, acc.clientId, acc.clientAccountNo, acc.clientName,
                ...
                acc.subStatus, acc.canUseForTopup, acc.clientActiveLoanOptions, acc.isTopup,
                acc.closureLoanId, acc.closureLoanAccountNo, acc.topupAmount, acc.isEqualAmortization, acc.rates, acc.isRatesEnabled,
                acc.fixedPrincipalPercentagePerInstallment, acc.delinquent,acc.brokenInterestPaid,acc.brokenInterestDerived,acc.selfPrincipalAmount,
                acc.partnerPrincipalAmount,acc.chargeOption,acc.netSelfDisbursalAmount,acc.netPartnerDisbursalAmount,
                acc.disbursementSummaries,acc.totalGstAmount,acc.loanProductData,acc.xirrValue,acc.foreClosureCharge,acc.selfFeeChargesAtDisbursementCharged,
                acc.partnerFeeChargesAtDisbursementCharged,acc.loanAccruals,acc.partner,acc.bankTranscationData,acc.loanProductFeesChargesData,acc.servicerFeeData,
                acc.vclHurdleRate, acc.bounceCharge);
    }
    ...
    public static LoanAccountData loanProductWithTemplateDefaults(final LoanProductData product,
                                                                  ...
                                                                  final Collection<ColendingChargeData> chargeOption,Collection<ColendingChargeData> foreClosureCharge,
                                                                  final Collection<ColendingChargeData> bounceCharge) {
        ...
        BigDecimal netSelfDisbursalAmount = null;
        BigDecimal netPartnerDisbursalAmount = null;
...
//        final Integer maxAge = null;
        ...
        return new LoanAccountData(id, accountNo, status, externalId, clientId, clientAccountNo, clientName, clientOfficeId, group,
                ...
                product.getMaximumGapBetweenInstallments(), product.allowAgeLimits(),
                ...
                product.getFixedPrincipalPercentagePerInstallment(), delinquent,brokenInterestPaid,
                brokenInterestDerived,selfPrincipalAmount,partnerPrincipalAmount,chargeOption,netSelfDisbursalAmount,
                netPartnerDisbursalAmount,disbursementSummaries,totalGstAmount,loanProductData,xirrValue,foreClosureCharge,
                selfFeeChargesDueAtDisbursementCharged,partnerFeeChargesDueAtDisbursementCharged,null,partnerData,bankTranscationData,loanProductFeesChargesData,servicerFeeData,null, bounceCharge);
    }
    ...
    public static LoanAccountData populateLoanProductDefaults(final LoanAccountData acc, final LoanProductData product) {
        ...
        return new LoanAccountData(acc.id, acc.accountNo, acc.status, acc.externalId, acc.clientId, acc.clientAccountNo, acc.clientName,
                ...
                product.getFixedPrincipalPercentagePerInstallment(), delinquent,acc.brokenInterestPaid,acc.brokenInterestPaid,
                acc.selfPrincipalAmount,acc.partnerPrincipalAmount,acc.chargeOption,acc.netSelfDisbursalAmount,acc.netPartnerDisbursalAmount,
                disbursementSummaries,totalGstAmount,loanProductData,xirrValue,foreClosureCharge,
                acc.selfFeeChargesAtDisbursementCharged,acc.partnerFeeChargesAtDisbursementCharged, acc.loanAccruals,partnerData,bankTranscationData,loanProductFeesChargesData,servicerFeeData,acc.vclHurdleRate,
                bounceCharge);
    }
    ...
    public static LoanAccountData basicLoanDetails(final Long id, final String accountNo, final LoanStatusEnumData status,
            ...
            final boolean allowAgeLimits, final EnumOptionData subStatus,final boolean canUseForTopup, final boolean isTopup, final Long closureLoanId, final String closureLoanAccountNo,
            final BigDecimal topupAmount, final boolean isEqualAmortization, final BigDecimal fixedPrincipalPercentagePerInstallment,
                                                   final BigDecimal brokenInterestDerived,final BigDecimal brokenInterestPaid, final BigDecimal selfPrincipalAmount,
                                                   final BigDecimal partnerPrincipalAmount,final BigDecimal netSelfDisbursalAmount,final BigDecimal netPartnerDisbursalAmount,
                                                   final BigDecimal xirrValue,final BigDecimal selfFeeChargesDueAtDisbursementCharged,final BigDecimal partnerFeeChargesDueAtDisbursementCharged,final BigDecimal vclHurdleRate ) {
        ...
        return new LoanAccountData(id, accountNo, status, externalId, clientId, clientAccountNo, clientName, clientOfficeId, group,
                ...
                maximumGap,  allowAgeLimits,
                subStatus, canUseForTopup, clientActiveLoanOptions, isTopup, closureLoanId, closureLoanAccountNo, topupAmount,
                isEqualAmortization, rates, isRatesEnabled, fixedPrincipalPercentagePerInstallment, delinquent,brokenInterestDerived ,
                brokenInterestPaid,selfPrincipalAmount,partnerPrincipalAmount,chargeOption,netSelfDisbursalAmount,netPartnerDisbursalAmount,
                disbursementSummaries,totalGstAmount,loanProductData,xirrValue,foreClosureCharge,selfFeeChargesDueAtDisbursementCharged,
                partnerFeeChargesDueAtDisbursementCharged,null,partnerData,bankTranscationData,loanProductFeesChargesData,servicerFeeData,vclHurdleRate, bounceCharge);
    }
    ...
    public static LoanAccountData associationsAndTemplate(final LoanAccountData acc, final LoanScheduleData repaymentSchedule,
                                                          ...
                                                          final CollectionData delinquent, final Collection<DisbursementSummary> disbursementSummaries, final BigDecimal total, final LoanProductData loanProductData,
                                                          final Collection<ColendingChargeData> foreClosureCharge, final List<LoanAccrualData> loanAccruals, final PartnerData partnerData, final BankTranscationData bankTranscationData, Collection<LoanProductFeesChargesData> OverDueAndForclosueCharge, final ServicerFeeData servicerFeeData,
                                                          final Collection<ColendingChargeData> bounceCharge) {
        ...
        return new LoanAccountData(acc.id, acc.accountNo, acc.status, acc.externalId, acc.clientId, acc.clientAccountNo, acc.clientName,
                ...
                acc.fixedPrincipalPercentagePerInstallment, delinquent,acc.brokenInterestPaid,acc.brokenInterestDerived,
                acc.selfPrincipalAmount,acc.partnerPrincipalAmount,acc.chargeOption,acc.netSelfDisbursalAmount,acc.netPartnerDisbursalAmount,
                disbursementSummaries,total,loanProductData,acc.xirrValue,foreClosureCharge,acc.selfFeeChargesAtDisbursementCharged,acc.partnerFeeChargesAtDisbursementCharged,
                loanAccruals,partnerData,bankTranscationData,OverDueAndForclosueCharge,servicerFeeData,acc.vclHurdleRate, bounceCharge);
    }
    ...
    public static LoanAccountData associationsAndTemplate(final LoanAccountData acc, final Collection<LoanProductData> productOptions,
        ...
        return associationsAndTemplate(acc, acc.repaymentSchedule, acc.transactions, acc.charges, acc.collateral, acc.guarantors,
                ...
                acc.interestRatesPeriods, acc.clientActiveLoanOptions, acc.rates, isRatesEnabled, acc.delinquent,acc.disbursementSummaries,
                acc.totalGstAmount,acc.loanProductData,acc.foreClosureCharge,acc.loanAccruals,acc.partner,acc.bankTranscationData,acc.loanProductFeesChargesData,acc.servicerFeeData,
                acc.bounceCharge);
    }
    ...
    public static LoanAccountData associateGroup(final LoanAccountData acc, final GroupGeneralData group) {
        ...
        return new LoanAccountData(acc.id, acc.accountNo, acc.status, acc.externalId, acc.clientId, acc.clientAccountNo, acc.clientName,
                ...
                acc.closureLoanId, acc.closureLoanAccountNo, acc.topupAmount, acc.isEqualAmortization, acc.rates, acc.isRatesEnabled,
                acc.fixedPrincipalPercentagePerInstallment, acc.delinquent,acc.brokenInterestPaid,acc.brokenInterestDerived,
                acc.selfPrincipalAmount,acc.partnerPrincipalAmount,acc.chargeOption,acc.netSelfDisbursalAmount,
                acc.netPartnerDisbursalAmount,acc.disbursementSummaries,acc.totalGstAmount,acc.loanProductData,acc.xirrValue,acc.foreClosureCharge,
                acc.selfFeeChargesAtDisbursementCharged,acc.partnerFeeChargesAtDisbursementCharged, acc.loanAccruals,acc.partner,acc.bankTranscationData,acc.loanProductFeesChargesData,acc.servicerFeeData,
                acc.vclHurdleRate, acc.bounceCharge);
    }
    ...
    public static LoanAccountData withLoanCalendarData(final LoanAccountData acc, final CalendarData calendarData) {
        return new LoanAccountData(acc.id, acc.accountNo, acc.status, acc.externalId, acc.clientId, acc.clientAccountNo, acc.clientName,
                ...
                acc.minimumGap, acc.maximumGap,  acc.allowAgeLimits,
                 acc.subStatus, acc.canUseForTopup, acc.clientActiveLoanOptions, acc.isTopup,
                acc.closureLoanId, acc.closureLoanAccountNo, acc.topupAmount, acc.isEqualAmortization, acc.rates, acc.isRatesEnabled,
                acc.fixedPrincipalPercentagePerInstallment, acc.delinquent,acc.brokenInterestPaid,
                acc.brokenInterestDerived,acc.selfPrincipalAmount,acc.partnerPrincipalAmount,acc.chargeOption,
                acc.netSelfDisbursalAmount,acc.netPartnerDisbursalAmount,acc.disbursementSummaries,acc.totalGstAmount,
                acc.loanProductData,acc.xirrValue,acc.foreClosureCharge,acc.selfFeeChargesAtDisbursementCharged,acc.partnerFeeChargesAtDisbursementCharged,acc.loanAccruals,
                acc.partner,acc.bankTranscationData,acc.loanProductFeesChargesData,acc.servicerFeeData,acc.vclHurdleRate, acc.bounceCharge);
    }
    ...
    private LoanAccountData(final Long id, //
            ...
            final Integer minimumGap, final Integer maximumGap,  final Boolean allowAgeLimits, final EnumOptionData subStatus, final Boolean canUseForTopup,
            ...
            final Boolean isRatesEnabled, final BigDecimal fixedPrincipalPercentagePerInstallment, final CollectionData delinquent, final  BigDecimal brokenInterestPaid,
                            final BigDecimal brokenInterestDerived,final BigDecimal selfPrincipalAmount,final BigDecimal partnerPrincipalAmount,
                            final Collection<ColendingChargeData> chargeOption,final BigDecimal netSelfDisbursalAmount,
                            final BigDecimal netPartnerDisbursalAmount,final Collection<DisbursementSummary> disbursementSummaries ,
                            final BigDecimal total,final LoanProductData loanProductData,final BigDecimal xirrValue, final Collection<ColendingChargeData> foreClosureCharge,
                            final  BigDecimal selfFeeChargesDueAtDisbursementCharged,final BigDecimal partnerFeeChargesAtDisbursementCharged,
                            final List<LoanAccrualData> loanAccruals,final PartnerData partnerData,final BankTranscationData bankTranscationData,
                            final Collection<LoanProductFeesChargesData> loanProductFeesChargesData,final ServicerFeeData servicerFeeData,final BigDecimal vclHurdleRate,
                            final Collection<ColendingChargeData> bounceCharge) {
        ...
        this.netSelfDisbursalAmount=netSelfDisbursalAmount;
        this.netPartnerDisbursalAmount=netPartnerDisbursalAmount;
        ...
        this.selfFeeChargesAtDisbursementCharged=selfFeeChargesDueAtDisbursementCharged;
        this.partnerFeeChargesAtDisbursementCharged = partnerFeeChargesAtDisbursementCharged;
        ...
        if (CollectionUtils.isEmpty(chargeOption)) {
            this.chargeOption = null;
        } else {
...
//        this.maxAge = maxAge;
        ...
        this.disbursementSummaries=disbursementSummaries;
        this.totalGstAmount=total;
        this.xirrValue=xirrValue;
        this.foreClosureCharge=foreClosureCharge;
        this.bankTranscationData = bankTranscationData;
        this.partner = partnerData;
        this.loanProductFeesChargesData =loanProductFeesChargesData;
        this.servicerFeeData = servicerFeeData;
       // this.loanProductData=loanProductData;
    ...
    public RepaymentScheduleRelatedLoanData repaymentScheduleRelatedData() {
        return this.timeline.repaymentScheduleRelatedData(this.currency, this.principal, this.approvedPrincipal, this.inArrearsTolerance,
                this.feeChargesAtDisbursementCharged,this.selfPrincipalAmount,this.partnerPrincipalAmount,this.selfFeeChargesAtDisbursementCharged,this.partnerFeeChargesAtDisbursementCharged);
    }
