...
public class LoanChargeData {
    ...
    private Integer gstEnum;
    private BigDecimal selfShareAmount;
	
	private final BigDecimal partnerShareAmount;
    ...
    @Getter
    @Setter
    private BigDecimal totalWaivedOff;
    @Getter
    @Setter
    ...
    public static LoanChargeData newLoanChargeDetails(final Long chargeId, final String name, final CurrencyData currency,
        ...
        final BigDecimal selfShareAmount=null;
        final BigDecimal partnerShareAmount=null;
        return new LoanChargeData(null, chargeId, name, currency, amount, percentage, chargeTimeType, chargeCalculationType, null, penalty,
                chargePaymentMode, false, false, null, minCap, maxCap, null, null,null,null);
    }
    ...
    public LoanChargeData(final Long id, final Long chargeId, final String name, final CurrencyData currency, final BigDecimal amount,
            ...
            Collection<LoanInstallmentChargeData> installmentChargeData, final String externalId,final Boolean enableGst,final Integer gstEnum,final BigDecimal selfShareAmount,final BigDecimal partnerShareAmount,final BigDecimal cgstAmount,final BigDecimal sgstAmount,
                          final BigDecimal igstAmount,final String feesChargeTypes ,final BigDecimal selfSharePercentage,final BigDecimal partnerSharePercentage,final BigDecimal selfGst,final BigDecimal partnerGst, final BigDecimal totalgst,final boolean isBounce,final BigDecimal totalPaid,BigDecimal totalOutstanding,BigDecimal totalWaivedOff,BigDecimal selfGstPaid,BigDecimal partnerGstPaid,BigDecimal selfShareAmountRepaid,BigDecimal partnerShareAmountRepaid) {
        this.id = id;
        ...
        this.gstEnum=gstEnum;
        this.selfShareAmount=selfShareAmount;
        this.partnerShareAmount=partnerShareAmount;
        this.cgstAmount=cgstAmount;
        this.sgstAmount=sgstAmount;
        this.igstAmount=igstAmount;
        this.feesChargeTypes = feesChargeTypes;
        this.selfShare = selfSharePercentage;
        this.partnerShare = partnerSharePercentage;
        ...
        this.totalWaivedOff =totalWaivedOff;
        this.selfGstPaid=Objects.nonNull(selfGstPaid)?selfGstPaid:BigDecimal.ZERO;
        this.partnerGstPaid=Objects.nonNull(partnerGstPaid)?partnerGstPaid:BigDecimal.ZERO;
        this.selfShareAmountRepaid= Objects.nonNull(selfShareAmountRepaid)?selfShareAmountRepaid:BigDecimal.ZERO;
        this.partnerShareAmountRepaid=Objects.nonNull(partnerShareAmountRepaid)?partnerShareAmountRepaid:BigDecimal.ZERO;
            }
    ...
    private LoanChargeData(final Long id, final Long chargeId, final String name, final CurrencyData currency, final BigDecimal amount,
            ...
            Collection<LoanInstallmentChargeData> installmentChargeData,final BigDecimal selfShareAmount, final BigDecimal partnerShareAmount) {
        this.id = id;
        this.chargeId = chargeId;
        this.name = name;
        this.currency = currency;
    ...
    public LoanChargeData(final Long id, final LocalDate dueAsOfDate, final BigDecimal amountOutstanding, EnumOptionData chargeTimeType,
        ...
        this.currency = null;
        this.amount = null;
        this.selfShareAmount=null;
        this.partnerShareAmount=null;
    ...
    public LoanChargeData(final BigDecimal amountUnrecognized, final LoanChargeData chargeData) {
        ...
        this.selfShareAmount=chargeData.selfShareAmount;
        this.partnerShareAmount=chargeData.partnerShareAmount;
