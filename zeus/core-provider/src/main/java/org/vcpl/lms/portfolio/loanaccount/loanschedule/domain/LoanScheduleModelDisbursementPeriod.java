...
public final class LoanScheduleModelDisbursementPeriod implements LoanScheduleModelPeriod {
    ...
    private final BigDecimal selfDisbursedAmount;
    private final BigDecimal partnerDisbursedAmount;
    private final BigDecimal selfChargesDueAtTimeOfDisbursement;
    private final BigDecimal partnerChargesDueAtTimeOfDisbursement;

    public static LoanScheduleModelDisbursementPeriod disbursement(final LoanApplicationTerms loanApplicationTerms,
                                                                   final BigDecimal chargesDueAtTimeOfDisbursement,final BigDecimal selfDisbursedAmount,
                                                                   final BigDecimal partnerDisbursedAmount,final BigDecimal selfChargesDueAtTimeOfDisbursement,final BigDecimal partnerChargesDueAtTimeOfDisbursement) {
        ...
        return new LoanScheduleModelDisbursementPeriod(periodNumber, loanApplicationTerms.getExpectedDisbursementDate(),
                loanApplicationTerms.getPrincipal(), chargesDueAtTimeOfDisbursement,selfDisbursedAmount,partnerDisbursedAmount,selfChargesDueAtTimeOfDisbursement,partnerChargesDueAtTimeOfDisbursement);
    }
    ...
    public static LoanScheduleModelDisbursementPeriod disbursement(final LocalDate disbursementDate, final Money principalDisbursed,
        ...
        return new LoanScheduleModelDisbursementPeriod(null, disbursementDate, principalDisbursed, chargesDueAtTimeOfDisbursement,selfDisbursedAmount,partnerDisbursedAmount,selfChargesDueAtTimeOfDisbursement,partnerChargesDueAtTimeOfDisbursement);
    }

    private LoanScheduleModelDisbursementPeriod(final Integer periodNumber, final LocalDate disbursementDate,
                                                final Money principalDisbursed, final BigDecimal chargesDueAtTimeOfDisbursement,final BigDecimal selfDisbursedAmount,
                                                final BigDecimal partnerDisbursedAmount,final BigDecimal selfChargesDueAtTimeOfDisbursement,final BigDecimal partnerChargesDueAtTimeOfDisbursement) {
        this.periodNumber = periodNumber;
        this.disbursementDate = disbursementDate;
        this.principalDisbursed = principalDisbursed;
        this.chargesDueAtTimeOfDisbursement = chargesDueAtTimeOfDisbursement;
        this.selfChargesDueAtTimeOfDisbursement =selfChargesDueAtTimeOfDisbursement;
        this.partnerChargesDueAtTimeOfDisbursement = partnerChargesDueAtTimeOfDisbursement;

        this.selfDisbursedAmount=selfDisbursedAmount;
        this.partnerDisbursedAmount=partnerDisbursedAmount;
    ...
    public LoanSchedulePeriodData toData() {
        return LoanSchedulePeriodData.disbursementOnlyPeriod(this.disbursementDate, this.principalDisbursed.getAmount(),
                this.chargesDueAtTimeOfDisbursement, false,this.selfDisbursedAmount,this.partnerDisbursedAmount, null,this.selfChargesDueAtTimeOfDisbursement,this.partnerChargesDueAtTimeOfDisbursement);
    }
    ...
    @Override
    public void addSelfPrincipal(Money selfPrincipal) {

    }

    @Override
    public void addPartnerPrincipal(Money partnerPrincipal) {
