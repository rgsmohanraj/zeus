 ...
 * under the License.
 */
package org.vcpl.lms.portfolio.account.service;

import static org.vcpl.lms.portfolio.account.AccountDetailConstants.fromAccountIdParamName;
import static org.vcpl.lms.portfolio.account.AccountDetailConstants.fromAccountTypeParamName;
import static org.vcpl.lms.portfolio.account.AccountDetailConstants.toAccountIdParamName;
import static org.vcpl.lms.portfolio.account.AccountDetailConstants.toAccountTypeParamName;
import static org.vcpl.lms.portfolio.account.api.AccountTransfersApiConstants.*;
...
import org.vcpl.lms.portfolio.account.data.AccountTransfersDataValidator;
import org.vcpl.lms.portfolio.account.domain.AccountTransferAssembler;
...
import org.vcpl.lms.portfolio.loanaccount.domain.LoanAccountDomainService;
...
import org.vcpl.lms.portfolio.loanaccount.exception.InvalidPaidInAdvanceAmountException;
...
import org.vcpl.lms.portfolio.savings.service.SavingsAccountWritePlatformService;
...
public class AccountTransfersWritePlatformServiceImpl implements AccountTransfersWritePlatformService {
    ...
    public AccountTransfersWritePlatformServiceImpl(final AccountTransfersDataValidator accountTransfersDataValidator,
                                                    ...
                                                    final GSIMRepositoy gsimRepository, ConfigurationDomainService configurationDomainService, LoanHistoryRepo loanHistoryRepo) {
        ...
        if (isSavingsToLoanAccountTransfer(accountTransferDTO.getFromAccountType(), accountTransferDTO.getToAccountType())) {
            ...
            if (AccountTransferType.fromInt(accountTransferDTO.getTransferType()).isChargePayment()) {
                ...
                loanTransaction = this.loanAccountDomainService.makeRepayment(LoanTransactionType.REPAYMENT, toLoanAccount,
                        ...
                        isAccountTransfer, holidayDetailDto, isHolidayValidationDone,selfDue,partnerDue,0,null,null,null,null,null,loanHistoryRepo);
            }
    ...
    public AccountTransferDetails repayLoanWithTopup(AccountTransferDTO accountTransferDTO) {
        ...
        LoanTransaction repayTransaction = this.loanAccountDomainService.makeRepayment(LoanTransactionType.REPAYMENT, toLoanAccount,
                ...
                accountTransferDTO.getPaymentDetail(), null, null, false, isAccountTransfer, null, false,selfDue,partnerDue,0,null,null,null,null,null,loanHistoryRepo);
