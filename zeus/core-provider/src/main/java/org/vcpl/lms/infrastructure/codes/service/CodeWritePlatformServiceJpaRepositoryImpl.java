 ...
 * under the License.
 */
package org.vcpl.lms.infrastructure.codes.service;

import java.util.Map;
import jakarta.persistence.PersistenceException;
import org.apache.commons.lang3.exception.ExceptionUtils;
import org.vcpl.lms.infrastructure.codes.domain.Code;
import org.vcpl.lms.infrastructure.codes.domain.CodeRepository;
import org.vcpl.lms.infrastructure.codes.exception.CodeNotFoundException;
import org.vcpl.lms.infrastructure.codes.exception.SystemDefinedCodeCannotBeChangedException;
import org.vcpl.lms.infrastructure.codes.serialization.CodeCommandFromApiJsonDeserializer;
...
public class CodeWritePlatformServiceJpaRepositoryImpl implements CodeWritePlatformService {
    ...
    @Transactional
    @Override
    @CacheEvict(value = "codes", key = "T(org.vcpl.lms.infrastructure.core.service.ThreadLocalContextUtil).getTenant().getTenantIdentifier().concat('cv')")
