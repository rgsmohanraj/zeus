 ...
 * under the License.
 */
package org.vcpl.lms.infrastructure.campaigns.email.service;
...
import org.vcpl.lms.infrastructure.campaigns.email.data.EmailCampaignValidator;
...
import org.vcpl.lms.infrastructure.campaigns.email.domain.EmailCampaign;
import org.vcpl.lms.infrastructure.campaigns.email.domain.EmailCampaignRepository;
import org.vcpl.lms.infrastructure.campaigns.email.domain.EmailMessage;
import org.vcpl.lms.infrastructure.campaigns.email.domain.EmailMessageRepository;
import org.vcpl.lms.infrastructure.campaigns.email.domain.EmailMessageStatusType;
import org.vcpl.lms.infrastructure.campaigns.email.domain.ScheduledEmailAttachmentFileFormat;
import org.vcpl.lms.infrastructure.campaigns.email.exception.EmailCampaignMustBeClosedToBeDeletedException;
import org.vcpl.lms.infrastructure.campaigns.email.exception.EmailCampaignMustBeClosedToEditException;
import org.vcpl.lms.infrastructure.campaigns.email.exception.EmailCampaignNotFound;
...
import org.vcpl.lms.infrastructure.dataqueries.domain.Report;
import org.vcpl.lms.infrastructure.dataqueries.domain.ReportParameterUsage;
import org.vcpl.lms.infrastructure.dataqueries.domain.ReportRepository;
import org.vcpl.lms.infrastructure.dataqueries.exception.ReportNotFoundException;
import org.vcpl.lms.infrastructure.dataqueries.service.GenericDataService;
...
import org.vcpl.lms.infrastructure.reportmailingjob.helper.IPv4Helper;
...
public class EmailCampaignWritePlatformCommandHandlerImpl implements EmailCampaignWritePlatformService {
    ...
    public EmailCampaignWritePlatformCommandHandlerImpl(final PlatformSecurityContext context,
                                                        ...
                                                        final SavingsAccountRepository savingsAccountRepository, final EmailMessageJobEmailService emailMessageJobEmailService, ExternalServicesPropertiesReadPlatformService externalServicesReadPlatformService) {
            ...
            for (final EmailMessage emailMessage : emailMessages) {
                ...
                if (isValidEmail(emailMessage.getEmailAddress())) {
                    ...
                    final EmailMessageWithAttachmentData emailMessageWithAttachmentData = EmailMessageWithAttachmentData.createNew(
                            emailMessage.getEmailAddress(), emailMessage.getMessage(), emailMessage.getEmailSubject(), attachmentList,false);
                    try {
                        final SMTPCredentialsData smtpCredentialsData = this.externalServicesReadPlatformService.getSMTPCredentials();

                        this.emailMessageJobEmailService.sendEmailWithAttachment(emailMessageWithAttachmentData,smtpCredentialsData);
