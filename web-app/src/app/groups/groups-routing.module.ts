  ...
  Route.withShell([
    {
      ...
      children: [
        ...
        },
        {
          ...
          data: { title: extract('Create Group'), breadcrumb: 'Create', routeParamBreadcrumb: false,routePermission:'CREATE_GROUP' },
          resolve: {
        ...
        },
        {
          ...
          children: [
            ...
            },
            {
              ...
              data: { title: extract('Edit Group'), breadcrumb: 'Edit', routeParamBreadcrumb: false,routePermission:'UPDATE_GROUP' },
              resolve: {
