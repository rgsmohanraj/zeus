 ...
 * under the License.
 */
package org.vcpl.lms.infrastructure.core.boot;
...
@EnableWebSecurity
@EnableConfigurationProperties({ LMSProperties.class, LiquibaseProperties.class })
@ComponentScan(basePackages = "org.vcpl.lms.**")
