...
import org.vcpl.lms.useradministration.data.PasswordValidationPolicyData;
import org.vcpl.lms.useradministration.service.PasswordValidationPolicyReadPlatformService;
...
@Tag(name = "Password preferences", description = "This API enables management of password policy for user administration.\n" + "\n"
        + "There is no Zeus functionality for creating a validation policy. The validation policies come pre-installed.\n" + "\n"
