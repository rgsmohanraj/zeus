...
import org.vcpl.lms.portfolio.loanaccount.loanschedule.domain.RecalculationDetail;
...
public final class LoanScheduleParams {
    ...
    private Money totalSelfRepaymentExpected;
    private Money totalPartnerRepaymentExpected;

    private Money totalOutstandingInterestPaymentDueToGrace;
    private Money totalCumulativeSelfPrincipal;
    private Money totalCumulativePartnerPrincipal;
    private Money totalCumulativeSelfInterestCharged;
    private Money totalCumulativePartnerInterestCharged;
    ...
    private LoanScheduleParams(final int periodNumber, final int instalmentNumber, int loanTermInDays, LocalDate periodStartDate,
                               ...
                               final boolean partialUpdate, final MonetaryCurrency currency, final boolean applyInterestRecalculation,final Money totalSelfRepaymentExpected,final Money totalPartnerRepaymentExpected) {
        ...
        this.totalCumulativeSelfPrincipal = totalCumulativeSelfPrincipal;
        this.totalCumulativePartnerPrincipal = totalCumulativePartnerPrincipal;
        this.totalCumulativeSelfInterestCharged = totalCumulativeSelfInterestCharged;
        this.totalCumulativePartnerInterestCharged = totalCumulativePartnerInterestCharged;
    ...
    public static LoanScheduleParams createLoanScheduleParamsForPartialUpdate(final int periodNumber, final int instalmentNumber,
                                                                              ...
                                                                              final LoanRepaymentScheduleTransactionProcessor loanRepaymentScheduleTransactionProcessor, final LocalDate scheduleTillDate,
                                                                              final MonetaryCurrency currency, final boolean applyInterestRecalculation,final Money totalSelfRepaymentExpected,final Money totalPartnerRepaymentExpected) {
        ...
        return new LoanScheduleParams(periodNumber, instalmentNumber, loanTermInDays, periodStartDate, actualRepaymentDate,
                ...
                scheduleTillDate, partialUpdate, currency, applyInterestRecalculation,totalSelfRepaymentExpected,totalPartnerRepaymentExpected);
    }
    ...
    public static LoanScheduleParams createLoanScheduleParamsForCompleteUpdate(final Collection<RecalculationDetail> recalculationDetails,
        ...
        final Money totalSelfRepaymentExpected = null;
        final Money totalPartnerRepaymentExpected = null;
        ...
        final BigDecimal outstandingselfPrinciple=null;
        final BigDecimal outstandingPartnerPrinciple=null;
    ...
    public static LoanScheduleParams createLoanScheduleParams(final MonetaryCurrency currency, final Money chargesDueAtTimeOfDisbursement,
        ...
        final Money totalSelfRepaymentExpected = chargesDueAtTimeOfDisbursement;
        final Money totalPartnerRepaymentExpected = chargesDueAtTimeOfDisbursement;
    ...
    public Money getTotalCumulativeSelfPrincipal() {
        return this.totalCumulativeSelfPrincipal;
    }
    public Money getTotalCumulativePartnerPrincipal() {
        return this.totalCumulativePartnerPrincipal;
    }
    public Money getTotalCumulativeSelfInterestCharged() {
        return this.totalCumulativeSelfInterestCharged;
    }
    public Money getTotalCumulativePartnerInterestCharged() {
        return this.totalCumulativePartnerInterestCharged;
    }
    ...
    public void addTotalCumulativeSelfPrincipal(final Money totalCumulativeSelfPrincipal) {
        this.totalCumulativeSelfPrincipal = this.totalCumulativeSelfPrincipal.plus(totalCumulativeSelfPrincipal);
    }

    public void addTotalCumulativePartnerPrincipal(final Money totalCumulativePartnerPrincipal) {
        this.totalCumulativePartnerPrincipal = this.totalCumulativePartnerPrincipal.plus(totalCumulativePartnerPrincipal);
    }

    public void addTotalCumulativeSelfInterestCharged(final Money totalCumulativeSelfInterestCharged) {
        this.totalCumulativeSelfInterestCharged = this.totalCumulativeSelfInterestCharged.plus(totalCumulativeSelfInterestCharged);
    }

    public void addTotalCumulativePartnerInterestCharged(final Money totalCumulativePartnerInterestCharged) {
        this.totalCumulativePartnerInterestCharged = this.totalCumulativePartnerInterestCharged.plus(totalCumulativePartnerInterestCharged);
    }
    ...
    public Money getTotalSelfRepaymentExpected() {
        return this.totalSelfRepaymentExpected;
    }
    public Money getTotalPartnerRepaymentExpected() {
        return this.totalPartnerRepaymentExpected;
    }
    ...
    public void addTotalSelfRepaymentExpected(final Money totalSelfRepaymentExpected) {
        this.totalSelfRepaymentExpected = this.totalSelfRepaymentExpected.plus(totalSelfRepaymentExpected);
    }

    public void addTotalPartnerRepaymentExpected(final Money totalPartnerRepaymentExpected) {
        this.totalPartnerRepaymentExpected = this.totalPartnerRepaymentExpected.plus(totalPartnerRepaymentExpected);
    }
