...
import { AadharUpdateDialogComponent } from './clients-view/custom-dialogs/aadhar-update-dialog/aadhar-update-dialog.component';
import { CreateClientComponent } from './create-client/create-client.component';
import { ClientDetailsTabComponent } from './clients-view/client-details-tab/client-details-tab.component';
/** Custom Resolvers */
...
import { ClientDetailsResolver } from './common-resolvers/client-details.resolver';
import { AuthRouterGuard } from 'app/core/authentication/auth-router-guard';

const routes: Routes = [
  Route.withShell([{
    path: 'clients',
    data: { title: extract('Clients'), breadcrumb: 'Clients', routeParamBreadcrumb: false,routePermission:'READ_CLIENT' },
    children: [
      {
        path: '',
      ...
      {
        path: 'create',
        data: { title: extract('Create Client'), breadcrumb: 'Create Client', routeParamBreadcrumb: false,routePermission: 'CREATE_CLIENT' },
      ...
      },
      {
        ...
        children: [
          ...
          },
          {
            ...
            data: { title: extract('Identities'), breadcrumb: 'Identities', routeParamBreadcrumb: false,routePermission: 'READ_CLIENTIDENTIFIER' },
            resolve: {
          ...
          },
          {
            ...
            data: { title: extract('Documents'), breadcrumb: 'Documents', routeParamBreadcrumb: false,routePermission: 'READ_DOCUMENT' },
            resolve: {
          ...
          },
          {
            ...
            data: { title: extract('Notes'), breadcrumb: 'Notes', routeParamBreadcrumb: false,routePermission: 'READ_CLIENTNOTE'},
            resolve: {
          ...
          {
            path: 'clientDetails',
            component: ClientDetailsTabComponent,
            data: { title: extract('ClientDetails'), breadcrumb: 'ClientDetails', routeParamBreadcrumb: false,routePermission: 'READ_CLIENTDETAILS' },
            resolve: {
...

          {
            ...
            children: [{
              ...
              data: { title: extract('Data Table View'), routeParamBreadcrumb: 'datatableName',routePermission:'READ_DATATABLE' },
              resolve: {
    ...
    children: [
      {
        ...
        children: [
          {
            path: 'edit',
            data: { title: extract('Edit Client'), breadcrumb: 'Edit', routeParamBreadcrumb: false,routePermission: 'UPDATE_CLIENT' },
           ...
           {
            path: 'updateAadhaar',
            data: { title: extract('Update Aadhar'), breadcrumb: 'Update', routeParamBreadcrumb: false },
            component: AadharUpdateDialogComponent,
            resolve: {
              clientDataAndTemplate: ClientDataAndTemplateResolver
            }
          },
