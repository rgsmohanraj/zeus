...
import org.vcpl.lms.portfolio.collection.service.CollectionWritePlatformServiceImpl;
...
public class LoanRepaymentCommandHandler implements NewCommandSourceHandler {
    ...
    private final CollectionWritePlatformServiceImpl collectionWritePlatformService;
    @Transactional
    @Override
    public CommandProcessingResult processCommand(final JsonCommand command) {
        boolean isRecoveryRepayment = false;
        return this.collectionWritePlatformService.makeLoanRepayment(LoanTransactionType.REPAYMENT, command.getLoanId(), command,
                isRecoveryRepayment);
    }
}
