...
public interface ChargeDropdownReadPlatformService {
    ...
    List<EnumOptionData> retrieveChargesType();
    List<EnumOptionData> retrieveGst();

    List<EnumOptionData> retrieveGstSlabLimitApplyFor();
    List<EnumOptionData> retrieveGstSlabLimitOperator();
    List<EnumOptionData> retrievePenaltyInterstDaysInYearOptions();
