...
import org.vcpl.lms.infrastructure.hooks.data.Event;
import org.vcpl.lms.infrastructure.hooks.data.EventResultSetExtractor;
import org.vcpl.lms.infrastructure.hooks.data.Field;
import org.vcpl.lms.infrastructure.hooks.data.Grouping;
import org.vcpl.lms.infrastructure.hooks.data.HookData;
import org.vcpl.lms.infrastructure.hooks.data.HookTemplateData;
...
public class HookReadPlatformServiceImpl implements HookReadPlatformService {
    ...
    @Override
    @Cacheable(value = "hooks", key = "T(org.vcpl.lms.infrastructure.core.service.ThreadLocalContextUtil).getTenant().getTenantIdentifier().concat('HK')")
