...
public class OverdueLoanScheduleData {
    ...
    private final BigDecimal selfPrincipalOverdue;
    private final BigDecimal partnerPrincipalOverdue;
    private final Integer graceOnArrearAgeing;
    ...
    public OverdueLoanScheduleData(final Long loanId, final Long chargeId, final String dueDate, final BigDecimal amount,
                                   ...
                                   final Integer periodNumber, final BigDecimal selfPrincipalOverdue, final BigDecimal partnerPrincipalOverdue,
        ...
        this.selfPrincipalOverdue = selfPrincipalOverdue;
        this.partnerPrincipalOverdue = partnerPrincipalOverdue;
        this.graceOnArrearAgeing = Objects.isNull(graceOnArrearAgeing) ? 0 : graceOnArrearAgeing;
    }
    ...
    public Integer getGraceOnArrearAgeing() { return this.graceOnArrearAgeing; }
    ...
    public String toString() {
        return "{" + "chargeId:" + this.chargeId + ", locale:'" + this.locale + '\'' + ", amount:" + this.amount + ", dateFormat:'"
                ...
                + ", interest:'" + this.interestOverdue + '\'' + ", graceOnArrearAgeing:'" + this.graceOnArrearAgeing + '\''+'}';
    }
