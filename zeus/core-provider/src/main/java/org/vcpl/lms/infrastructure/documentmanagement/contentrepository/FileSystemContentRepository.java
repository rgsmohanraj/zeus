 ...
 * under the License.
 */
package org.vcpl.lms.infrastructure.documentmanagement.contentrepository;
...
import org.vcpl.lms.infrastructure.documentmanagement.data.ImageData;
...
public class FileSystemContentRepository implements ContentRepository {
    ...
    public static final String FINERACT_BASE_DIR = System.getProperty("user.home") + File.separator + ".zeus";
    ...
    public String saveFile(final InputStream uploadedInputStream, final DocumentCommand documentCommand) {
        ...
        final String fileLocation = Objects.isNull(documentCommand.getLocation())
                ? generateFileParentDirectory(documentCommand.getParentEntityType(), documentCommand.getParentEntityId())
                    + File.separator + fileName
                : documentCommand.getLocation() + File.separator + fileName;
