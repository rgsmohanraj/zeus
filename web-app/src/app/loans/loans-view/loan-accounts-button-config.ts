...
export class LoansAccountButtonConfiguration {
    ...
    constructor(status: string, isPennyDropEnabled: boolean, isBankDisbursementEnabled: boolean) {
        this.setOptions(status);
        this.setButtons(status, isPennyDropEnabled, isBankDisbursementEnabled);
    }
    ...
    setButtons(status: string, isPennyDropEnabled: boolean, isBankDisbursementEnabled: boolean) {
        switch (status) {
            case 'Active':
                this.buttonsArray = [
                    {
            ...
            case 'Approved':
                this.buttonsArray = [];
                if(isPennyDropEnabled) {
                    this.buttonsArray.push({ name: 'Initiate Penny Drop', icon: 'fa fa-money', taskPermissionName: 'INITIATE_PENNYDROP',});
                }
                if(isBankDisbursementEnabled) {
                    this.buttonsArray.push({ name: 'Initiate Disbursement', icon: 'fa fa-money', taskPermissionName: 'INITIATE_DISBURSEMENT',});
                }
                this.buttonsArray.push({ name: 'Disburse', icon: 'fa fa-flag', taskPermissionName: 'DISBURSE_LOAN',});
                this.buttonsArray.push({ name: 'Undo Approval', icon: 'fa fa-undo',taskPermissionName: 'APPROVALUNDO_LOAN',});
