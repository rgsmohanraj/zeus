...
const routes: Routes = [
  Route.withShell([
    {
      path: 'templates',
      data: { title: extract('Templates'), breadcrumb: 'Templates',routePermission:'READ_TEMPLATE' },
      children: [
        {
          path: '',
        ...
        {
          path: 'create',
          data: { title: extract('Create Template'), breadcrumb: 'Create Template',routePermission:'CREATE_TEMPLATE' },
        ...
        },
        {
          ...
          children: [
            ...
            },
            {
              ...
              data: { title: extract('Edit Template'), breadcrumb: 'Edit', routeParamBreadcrumb: false,routePermission:'UPDATE_TEMPLATE' },
              resolve: {
