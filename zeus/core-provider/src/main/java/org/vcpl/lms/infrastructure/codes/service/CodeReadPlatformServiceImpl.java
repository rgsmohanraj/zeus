...
import org.vcpl.lms.infrastructure.codes.data.CodeData;
...
public class CodeReadPlatformServiceImpl implements CodeReadPlatformService {
    ...
    @Override
    @Cacheable(value = "codes", key = "T(org.vcpl.lms.infrastructure.core.service.ThreadLocalContextUtil).getTenant().getTenantIdentifier().concat('CD')")
