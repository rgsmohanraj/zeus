...
INSERT INTO `c_configuration` (`id`, `name`, `value`, `date_value`, `enabled`, `is_trap_door`, `description`) VALUES
    ...
    (10, 'penalty-wait-period', 2, NULL, 0, 0, NULL),
    ...
    (33, 'enable_business_date', NULL, NULL, 0, 0, NULL);
...
INSERT INTO `m_appuser` (`id`, `is_deleted`, `office_id`, `staff_id`, `username`, `firstname`, `lastname`, `password`, `email`, `firsttime_login_remaining`, `nonexpired`, `nonlocked`, `nonexpired_credentials`, `enabled`, `last_time_password_updated`, `password_never_expires`, `is_self_service_user`) VALUES
    (1, 0, 1, NULL, 'admin', 'App', 'Administrator', '5787039480429368bf94732aacc771cd0a3ea02bcf504ffe1185ab94213bc63a', 'IT.Development@vivriticapital.com', b'0', b'1', b'1', b'1', b'1', '2015-06-03', 0, b'0'),
    (2, 0, 1, NULL, 'system', 'system', 'system', '5787039480429368bf94732aacc771cd0a3ea02bcf504ffe1185ab94213bc63a', 'IT.Development@vivriticapital.com', b'0', b'1', b'1', b'1', b'1', '2014-03-07', 0, b'0');
...
CREATE TABLE IF NOT EXISTS `m_charge` (
  ...
  `min_charge_amount` decimal(19,6) DEFAULT NULL,
  `max_charge_amount` decimal(19,6) DEFAULT NULL,
  `gst_enabled` bit(1) DEFAULT NULL,
  `gst_enum` smallint(10) DEFAULT NULL,
  `type_cv_id` int(10) DEFAULT NULL,
  `fees_type` varchar(30) DEFAULT NULL,
  `fees_charge_type_cv_id` int(20) DEFAULT NULL,
  `penalty_interest_days_in_year` int(20) DEFAULT NULL,
  `createdon_date` datetime DEFAULT NULL,
  `createdon_userid` smallint(10) DEFAULT NULL,
  `modifiedon_date` datetime DEFAULT NULL,
  `modifiedon_userid` smallint(10) DEFAULT NULL,
  PRIMARY KEY (`id`),
  UNIQUE KEY `name` (`name`),
...
CREATE TABLE IF NOT EXISTS `m_client` (
  ...
  `beneficiary_account_number` varchar(40) DEFAULT NULL,
    `ifsc_code` varchar(11) DEFAULT NULL,
    `micr_code` bigint(9) DEFAULT NULL,
    `swift_code` varchar(11) DEFAULT NULL,
    `branch` varchar(50) DEFAULT NULL,
  `gender_cv_id` INT DEFAULT NULL,
  `state_cv_id` INT DEFAULT NULL,
  ...
  `pan` varchar(60) DEFAULT NULL,
  `aadhaar` varchar(60) DEFAULT NULL,
  `account_type_cv_id` INT DEFAULT NULL,
  `address` varchar(250) DEFAULT NULL,
  `voter_id` varchar(10) DEFAULT NULL,
  `passport_number` varchar(12) DEFAULT NULL,
  `driving_license` varchar(18) DEFAULT NULL,
   `pincode` BIGINT(6) DEFAULT NULL,
   `ration_card_number`varchar(30)DEFAULT NULL,
  PRIMARY KEY (`id`),
...
INSERT INTO `m_code` (`id`, `code_name`, `is_system_defined`) VALUES
    ...
    (42, 'Sector', 1),
    (43, 'SubSector', 1),
    (44, 'GstRegistration', 1),
    (45, 'PartnerType', 1),
    (46, 'UnderlyingAssets', 1),
    (47, 'Security', 1),
    (48, 'FldgCalculationOn', 1),
    (49, 'LoanProductType', 1),
    (50, 'LoanProductClass', 1),
    (51, 'InsuranceApplicability', 1),
    (52, 'FldgLogic', 1),
    (53, 'Framework', 1),
    (54, 'LoanType', 1),
    (55, 'AssetClass', 1),
    ...
    (57, 'FeesType', 1);
    (58,'PenalInvoice',1);
    (59,'MultipleDisbursement',1);
    (60,'TrancheClubbing',1);
    (61,'RepaymentScheduleUpdateAllowed',1);
    (62,'RepaymentMode',1);
    (63,'TransactionTypePreference',1);
...
INSERT INTO `m_code_value` (`id`, `code_id`, `code_value`, `code_description`, `order_position`, `code_score`, `is_active`, `is_mandatory`) VALUES
    ...
    (14, 56, 'Charge', NULL, 1, NULL, 1, 0),
    (15, 56, 'Fees', NULL, 2, NULL, 1, 0),
    (16, 57, 'ProcessingFee', NULL, 1, NULL, 1, 0),
    (17, 57, 'Document Charges', NULL, 2, NULL, 1, 0),
    (18, 57, 'InsuranceCharges', NULL, 3, NULL, 1, 0),
    (19, 57, 'Other Charges', NULL, 4, NULL, 1, 0);
...
INSERT INTO `m_currency` (`id`, `code`, `decimal_places`, `currency_multiplesof`, `display_symbol`, `name`, `internationalized_name_code`) VALUES
    ...
    (64, 'INR', 2, NULL, NULL, 'Indian Rupee', 'currency.INR'),
    ...
    (116, 'PYG', 0, NULL, NULL, 'Paraguayan Guarani', 'currency.PYG'),
...
CREATE TABLE IF NOT EXISTS `m_loan` (
  ...
  `self_fee_charges_charged_derived` decimal(19,6) NOT NULL DEFAULT '0.000000',
  `partner_fee_charges_charged_derived` decimal(19,6) NOT NULL DEFAULT '0.000000',
  ...
  `self_penalty_charges_charged_derived` decimal(19,6) NULL DEFAULT '0.000000',
  `self_penalty_charges_outstanding_derived` decimal(19,6) NULL DEFAULT '0.000000',
  `self_penalty_charges_repaid_derived` decimal(19,6) NULL DEFAULT '0.000000',
  `self_penalty_charges_waived_derived` decimal(19,6) NULL DEFAULT '0.000000',
  `self_penalty_charges_writtenoff_derived` decimal(19,6) NULL DEFAULT '0.000000',
  `partner_penalty_charges_charged_derived` decimal(19,6) NULL DEFAULT '0.000000',
  `partner_penalty_charges_outstanding_derived` decimal(19,6) NULL DEFAULT '0.000000',
  `partner_penalty_charges_repaid_derived` decimal(19,6) NULL DEFAULT '0.000000',
  `partner_penalty_charges_waived_derived` decimal(19,6) NULL DEFAULT '0.000000',
  `partner_penalty_charges_writtenoff_derived` decimal(19,6) NULL DEFAULT '0.000000',
  ...
  `repayment_strategy_for_npa` bit(1) DEFAULT NULL,
  `broken_interest_derived` decimal(19,6) DEFAULT NULL,
  `broken_interest_repaid` decimal(19,6) DEFAULT NULL,
  `partner_id` BIGINT DEFAULT NULL,
  `broken_strategy` varchar(30) DEFAULT NULL,
  `self_principal_amount` decimal(19,6) DEFAULT NULL,
  `partner_principal_amount` decimal(19,6) DEFAULT NULL,
  `self_interest_charged_derived` decimal(19,6) DEFAULT NULL,
  `partner_interest_charged_derived` decimal(19,6) DEFAULT NULL,
  `self_principal_repaid_derived` decimal(19,6) DEFAULT NULL,
  `partner_principal_repaid_derived` decimal(19,6) DEFAULT NULL,
  `self_principal_outstanding_derived` decimal(19,6) DEFAULT NULL,
  `partner_principal_outstanding_derived` decimal(19,6) DEFAULT NULL,
  `self_interest_outstanding_derived` decimal(19,6) DEFAULT NULL,
  `partner_interest_outstanding_derived` decimal(19,6) DEFAULT NULL,
  `total_self_outstanding_derived` decimal(19,6) DEFAULT NULL,
  `total_partner_outstanding_derived` decimal(19,6) DEFAULT NULL,
  `self_interest_repaid_derived` decimal(19,6) DEFAULT NULL,
  `partner_interest_repaid_derived` decimal(19,6) DEFAULT NULL,
  `total_self_repayment_derived` decimal(19,6) DEFAULT NULL,
  `total_partner_repayment_derived` decimal(19,6) DEFAULT NULL,
  `self_principal_writtenoff_derived` decimal(19,6) DEFAULT NULL,
  `partner_principal_writtenoff_derived` decimal(19,6) DEFAULT NULL,
  `self_fee_charges_waived_derived` decimal(19,6) DEFAULT NULL,
  `partner_fee_charges_waived_derived` decimal(19,6) DEFAULT NULL,
  `self_fee_charges_writtenoff_derived` decimal(19,6) DEFAULT NULL,
  `partner_fee_charges_writtenoff_derived` decimal(19,6) DEFAULT NULL,
  `self_interest_waived_derived` decimal(19,6) DEFAULT NULL,
  `partner_interest_waived_derived` decimal(19,6) DEFAULT NULL,
  `broken_strategy_enum` SMALLINT DEFAULT NULL,
  `disbursement_enum` SMALLINT DEFAULT NULL,
  `collection_enum` SMALLINT DEFAULT NULL,
  `self_net_disbursal_amount` decimal(19,6) DEFAULT NULL,
  `partner_net_disbursal_amount` decimal(19,6) DEFAULT NULL,
  `broken_interest_days_in_years` int(10) DEFAULT NULL,
  `broken_interest_days_in_month` int(10) DEFAULT NULL,
  `xirr_value` decimal(19,2) DEFAULT NULL,
  `advance_amount` decimal(19,6) DEFAULT NULL,
  `total_self_charges_due_at_disbursement_derived` decimal(19,6) DEFAULT NULL,
  `total_partner_charges_due_at_disbursement_derived` decimal(19,6) DEFAULT NULL,
  `total_gst_derived` decimal(19,6) DEFAULT NULL,
  `total_gst_paid` decimal(19,6) DEFAULT NULL,
  `total_gst_outstanding` decimal(19,6) DEFAULT NULL,
  `total_self_gst_derived` decimal(19,6) DEFAULT NULL,
  `total_self_gst_paid` decimal(19,6) DEFAULT NULL,
  `total_self_gst_outstanding` decimal(19,6) DEFAULT NULL,
  `total_partner_gst_derived` decimal(19,6) DEFAULT NULL,
  `total_partner_gst_paid` decimal(19,6) DEFAULT NULL,
  `total_partner_gst_outstanding` decimal(19,6) DEFAULT NULL,
  `total_gst_due_at_disbursement_derived` decimal(19,6) DEFAULT NULL,
  `total_self_gst_due_at_disbursement_derived` decimal(19,2) DEFAULT NULL,
  `total_partner_gst_due_at_disbursement_derived` decimal(19,2) DEFAULT NULL,
  `transaction_type_preference_enum` smallint(10) DEFAULT NULL,
  `self_annual_nominal_interest_rate` decimal(19,6) DEFAULT NULL,
  `partner_annual_nominal_interest_rate` decimal(19,6) DEFAULT NULL,
  PRIMARY KEY (`id`),
...
CREATE TABLE IF NOT EXISTS `m_loan_charge` (
  ...
  `max_cap` decimal(19,6) DEFAULT NULL,
  `is_active` tinyint NOT NULL DEFAULT '1',
  `igst_amount` decimal(19,6) DEFAULT NULL,
  `sgst_amount` decimal(19,6) DEFAULT NULL,
  `cgst_amount` decimal(19,6) DEFAULT NULL,
  `gst_enum` int(10) DEFAULT NULL,
  `gst_enabled` bit(1) DEFAULT NULL,
  `self_share_amount_derived` decimal(19,6) DEFAULT NULL,
  `partner_share_amount_derived` decimal(19,6) DEFAULT NULL,
  `self_share_percentage` decimal(19,6) DEFAULT NULL,
  `partner_share_percentage` decimal(19,6) DEFAULT NULL,
  `self_amount_outstanding` decimal(19,6) DEFAULT NULL,
  `partner_amount_outstanding` decimal(19,6) DEFAULT NULL,
  `self_amount_waived_derived` decimal(19,6) DEFAULT NULL,
  `partner_amount_waived_derived` decimal(19,6) DEFAULT NULL,
  `self_amount_writtenoff_derived` decimal(19,6) DEFAULT NULL,
  `parter_amount_writtenoff_derived` decimal(19,6) DEFAULT NULL,
  `total_gst` decimal(19,6) DEFAULT NULL,
  `fees_type` int(10) DEFAULT NULL,
  `self_gst_derived` decimal(19,6) DEFAULT NULL,
  `partner_gst_derived` decimal(19,6) DEFAULT NULL,
  `self_gst_paid` decimal(19,6) DEFAULT NULL,
  `partner_gst_paid` decimal(19,6) DEFAULT NULL,
  `self_gst_outstanding` decimal(19,6) DEFAULT NULL,
  `partner_gst_outstanding` decimal(19,6) DEFAULT NULL,
  `self_share_amount_repaid` decimal(19,6) DEFAULT NULL,
  `partner_share_amount_repaid` decimal(19,6) DEFAULT NULL,
  `self_gst_percentage` decimal(19,6) DEFAULT NULL,
  `partner_gst_percentage` decimal(19,6) DEFAULT NULL,
  `createdon_date` datetime DEFAULT NULL,
  `createdon_userid` smallint(10) DEFAULT NULL,
  `modifiedon_date` datetime DEFAULT NULL,
  `modifiedon_userid` smallint(10) DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `m_loan_repayment_schedule` (
  ...
  `self_principal_amount` decimal(19,6) DEFAULT NULL,
  `self_interest_amount` decimal(19,6) DEFAULT NULL,
  `self_principal_completed_derived` decimal(19,6) DEFAULT NULL,
  `self_principal_writtenoff_derived` decimal(19,6) DEFAULT NULL,
  `self_interest_completed_derived` decimal(19,6) DEFAULT NULL,
  `self_interest_waived_derived` decimal(19,6) DEFAULT NULL,
  `self_interest_writtenoff_derived` decimal(19,6) DEFAULT NULL,
  `self_accrual_interest_derived` decimal(19,6) DEFAULT NULL,
  `self_reschedule_interest_portion` decimal(19,6) DEFAULT NULL,
  `self_fee_charges_amount` decimal(19,6) DEFAULT NULL,
  `self_fee_charges_completed_derived` decimal(19,6) DEFAULT NULL,
  `self_fee_charges_writtenoff_derived` decimal(19,6) DEFAULT NULL,
  `self_fee_charges_waived_derived` decimal(19,6) DEFAULT NULL,
  `self_accrual_fee_charges_derived` decimal(19,6) DEFAULT NULL,
  `self_penalty_charges_amount` decimal(19,6) DEFAULT NULL,
  `self_penalty_charges_completed_derived` decimal(19,6) DEFAULT NULL,
  `self_penalty_charges_writtenoff_derived` decimal(19,6) DEFAULT NULL,
  `self_penalty_charges_waived_derived` decimal(19,6) DEFAULT NULL,
  `self_accrual_penalty_charges_derived` decimal(19,6) DEFAULT NULL,
  `self_total_paid_late_derived` decimal(19,6) DEFAULT NULL,
  `self_due` decimal(19,6) DEFAULT NULL,
  `partner_principal_amount` decimal(19,6) DEFAULT NULL,
  `partner_interest_amount` decimal(19,6) DEFAULT NULL,
  `partner_principal_completed_derived` decimal(19,6) DEFAULT NULL,
  `partner_principal_writtenoff_derived` decimal(19,6) DEFAULT NULL,
  `partner_interest_completed_derived` decimal(19,6) DEFAULT NULL,
  `partner_interest_waived_derived` decimal(19,6) DEFAULT NULL,
  `partner_interest_writtenoff_derived` decimal(19,6) DEFAULT NULL,
  `partner_accrual_interest_derived` decimal(19,6) DEFAULT NULL,
  `partner_reschedule_interest_portion` decimal(19,6) DEFAULT NULL,
  `partner_fee_charges_amount` decimal(19,6) DEFAULT NULL,
  `partner_fee_charges_completed_derived` decimal(19,6) DEFAULT NULL,
  `partner_fee_charges_writtenoff_derived` decimal(19,6) DEFAULT NULL,
  `partner_fee_charges_waived_derived` decimal(19,6) DEFAULT NULL,
  `partner_accrual_fee_charges_derived` decimal(19,6) DEFAULT NULL,
  `partner_penalty_charges_amount` decimal(19,6) DEFAULT NULL,
  `partner_penalty_charges_completed_derived` decimal(19,6) DEFAULT NULL,
  `partner_penalty_charges_writtenoff_derived` decimal(19,6) DEFAULT NULL,
  `partner_penalty_charges_waived_derived` decimal(19,6) DEFAULT NULL,
  `partner_accrual_penalty_charges_derived` decimal(19,6) DEFAULT NULL,
  `partner_total_paid_late_derived` decimal(19,6) DEFAULT NULL,
  `partner_due` decimal(19,6) DEFAULT NULL,
  `dpd` INT DEFAULT NULL,
  `advance_amount` decimal(19,6) DEFAULT NULL,
  PRIMARY KEY (`id`),
...
CREATE TABLE IF NOT EXISTS `m_loan_transaction` (
  ...
  `createdon_date` datetime DEFAULT NULL,
  `createdon_userid` BIGINT DEFAULT NULL,
  ...
  `receipt_reference_number` varchar(40) NOT NULL,
  `partner_transfer_utr` varchar(40) DEFAULT NULL,
  `partner_transfer_date` date DEFAULT NULL,
  `repayment_mode_cv_id` bigint(10) DEFAULT NULL,
  `advance_amount` decimal(19,6) DEFAULT NULL,
  `modifiedon_date` datetime DEFAULT NULL,
  `modifiedon_userid` smallint(10) DEFAULT NULL,
  PRIMARY KEY (`id`),
...
-- Dumping structure for table fineract_default.m_partner
DROP TABLE IF EXISTS `m_partner`;
CREATE TABLE IF NOT EXISTS `m_partner` (
  `id` BIGINT NOT NULL AUTO_INCREMENT,
  `partner_name` varchar(75) NOT NULL,
  `partner_company_registration_date` date DEFAULT NULL,
  `source_cv_id` INT DEFAULT NULL,
  ...
  `state_cv_id` INT DEFAULT NULL,
  `pincode` bigint(6) DEFAULT NULL,
  `country_cv_id` INT DEFAULT NULL,
  `constitution_cv_id` INT DEFAULT NULL,
  `key_persons` varchar(30) DEFAULT NULL,
  `industry_cv_id` INT DEFAULT NULL,
  `sector_cv_id` INT DEFAULT NULL,
  `sub_sector_cv_id` INT DEFAULT NULL,
  `gst_number` varchar(15) DEFAULT NULL,
  `gst_registration_cv_id` INT DEFAULT NULL,
  `partner_type_cv_id` INT DEFAULT NULL,
  `beneficiary_name` varchar(75) DEFAULT NULL,
  `beneficiary_account_number` varchar(40) DEFAULT NULL,
  `ifsccode` varchar(11) DEFAULT NULL,
  `micrcode` bigint(9) DEFAULT NULL,
  `swiftcode` varchar(11) DEFAULT NULL,
  `branch` varchar(50) DEFAULT NULL,
  `model_limit` decimal(19,6) DEFAULT NULL,
  `approved_limit` decimal(19,6) DEFAULT NULL,
  `pilot_limit` decimal(19,6) DEFAULT NULL,
  `partner_float_limit` decimal(19,6) DEFAULT NULL,
  `balance_limit` decimal(19,6) DEFAULT NULL,
  `agreement_start_date` date DEFAULT NULL,
  `agreement_expiry_date` date DEFAULT NULL,
  `underlying_assets_cv_id` INT DEFAULT NULL,
  `security_cv_id` INT DEFAULT NULL,
  `fldg_calculation_on_cv_id` INT DEFAULT NULL,
  PRIMARY KEY (`id`),
  UNIQUE KEY `name_org` (`partner_name`),
  KEY `FK_m_partner_source_m_code_value` (`source_cv_id`),
--  KEY `FK_m_partner_city_m_code_value` (`city_cv_id`),
  KEY `FK_m_partner_state_m_code_value` (`state_cv_id`),
  KEY `FK_m_partner_country_m_code_value` (`country_cv_id`),
  KEY `FK_m_partner_constitution_m_code_value` (`constitution_cv_id`),
  KEY `FK_m_partner_industry_m_code_value` (`industry_cv_id`),
  KEY `FK_m_partner_sector_m_code_value` (`sector_cv_id`),
  KEY `FK_m_partner_sub_sector_m_code_value` (`sub_sector_cv_id`),
  KEY `FK_m_partner_gst_registration_m_code_value` (`gst_registration_cv_id`),
  KEY `FK_m_partner_partner_type_m_code_value` (`partner_type_cv_id`),
  KEY `FK_m_partner_underlying_assets_m_code_value` (`underlying_assets_cv_id`),
  KEY `FK_m_partner_security_m_code_value` (`security_cv_id`),
  KEY `FK_m_partner_fldg_calculation_on_m_code_value` (`fldg_calculation_on_cv_id`),
  CONSTRAINT `FK_m_partner_source_m_code_value` FOREIGN KEY (`source_cv_id`) REFERENCES `m_code_value` (`id`),
--  CONSTRAINT `FK_m_partner_city_m_code_value` FOREIGN KEY (`city_cv_id`) REFERENCES `m_code_value` (`id`),
  CONSTRAINT `FK_m_partner_state_m_code_value` FOREIGN KEY (`state_cv_id`) REFERENCES `m_code_value` (`id`),
  CONSTRAINT `FK_m_partner_country_m_code_value` FOREIGN KEY (`country_cv_id`) REFERENCES `m_code_value` (`id`),
  CONSTRAINT `FK_m_partner_constitution_m_code_value` FOREIGN KEY (`constitution_cv_id`) REFERENCES `m_code_value` (`id`),
  CONSTRAINT `FK_m_partner_industry_m_code_value` FOREIGN KEY (`industry_cv_id`) REFERENCES `m_code_value` (`id`),
  CONSTRAINT `FK_m_partner_sector_m_code_value` FOREIGN KEY (`sector_cv_id`) REFERENCES `m_code_value` (`id`),
  CONSTRAINT `FK_m_partner_sub_sector_m_code_value` FOREIGN KEY (`sub_sector_cv_id`) REFERENCES `m_code_value` (`id`),
  CONSTRAINT `FK_m_partner_gst_registration_m_code_value` FOREIGN KEY (`gst_registration_cv_id`) REFERENCES `m_code_value` (`id`),
  CONSTRAINT `FK_m_partner_partner_type_m_code_value` FOREIGN KEY (`partner_type_cv_id`) REFERENCES `m_code_value` (`id`),
  CONSTRAINT `FK_m_partner_underlying_assets_m_code_value` FOREIGN KEY (`underlying_assets_cv_id`) REFERENCES `m_code_value` (`id`),
  CONSTRAINT `FK_m_partner_security_m_code_value` FOREIGN KEY (`security_cv_id`) REFERENCES `m_code_value` (`id`),
  CONSTRAINT `FK_m_partner_fldg_calculation_on_m_code_value` FOREIGN KEY (`fldg_calculation_on_cv_id`) REFERENCES `m_code_value` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=UTF8MB4;

-- Dumping data for table fineract_default.m_partner: ~0 rows (approximately)
...
INSERT INTO `m_permission` (`id`, `grouping`, `code`, `entity_name`, `action_name`, `can_maker_checker`) VALUES
    ...
    (767, 'portfolio', 'READ_PARTNER', 'PARTNER', 'READ', 0),
    (768, 'portfolio', 'CREATE_PARTNER', 'PARTNER', 'CREATE', 0),
    (769, 'portfolio', 'CREATE_PARTNER_CHECKER', 'PARTNER', 'CREATE_CHECKER', 0),
    (770, 'portfolio', 'UPDATE_PARTNER', 'PARTNER', 'UPDATE', 0),
    (771, 'portfolio', 'UPDATE_PARTNER_CHECKER', 'PARTNER', 'UPDATE_CHECKER', 0);
...
CREATE TABLE IF NOT EXISTS `m_product_loan` (
  ...
  `sync_expected_with_disbursement_date` TINYINT DEFAULT '0',
   `broken_interest_calculation_Period` varchar(10) DEFAULT NULL,
      `repayment_strategy_for_npa_id` varchar(20) DEFAULT NULL,
      `loan_foreclosure_strategy` varchar(20) DEFAULT NULL,
      `broken_interest_days_in_years` varchar(20) DEFAULT NULL,
      `broken_interest_days_in_month` varchar(20) DEFAULT NULL,
      `broken_interest_strategy` varchar(20) DEFAULT NULL,
      `class_id` bigint(10) DEFAULT NULL,
      `type_id` bigint(10) DEFAULT NULL
      `allow_approval_over_amount_applied` bit(1) DEFAULT NULL,
      `over_amount_details` bit(1) DEFAULT NULL,
      `enable_colending_loan` bit(1) DEFAULT NULL,
      `by_percentage_split` bit(1) DEFAULT NULL,
      `self_principal_share` int(10) DEFAULT NULL,
      `self_fee_share` int(10) DEFAULT NULL,
      `self_penalty_share` int(10) DEFAULT NULL,
      `self_overpaid_shares` int(10) DEFAULT NULL,
      `self_interest_rate` decimal(19,6) DEFAULT NULL,
      `principal_share` int(10) DEFAULT NULL,
      `fee_share` int(10) DEFAULT NULL,
      `penalty_share` int(10) DEFAULT NULL,
      `overpaid_share` int(10) DEFAULT NULL,
      `interest_rate` decimal(19,6) DEFAULT NULL,
      `partner_principal_share` int(10) DEFAULT NULL,
      `partner_fee_share` int(10) DEFAULT NULL,
      `partner_penalty_share` int(10) DEFAULT NULL,
      `partner_overpaid_share` int(10) DEFAULT NULL,
      `partner_interest_rate` decimal(19,6) DEFAULT NULL,
      `partner_id` BIGINT(10) DEFAULT NULL,
      `enable_charge_wise_bifacation` bit(1) DEFAULT NULL,
      `select_charge` varchar(20) DEFAULT NULL,
      `select_accepted_dates` bit(1) DEFAULT NULL,
      `accepted_date_type` varchar(10) DEFAULT NULL,
      `accepted_start_date` int(10) DEFAULT NULL,
      `accepted_end_date` int(10) DEFAULT NULL,
      `accepted_date` int(10) DEFAULT NULL,
      `apply_prepaid_locking_period` bit(1) DEFAULT NULL,
      `prepay_locking_period` int(10) DEFAULT NULL,
      `apply_foreclosure_locking_period` bit(1) DEFAULT NULL,
      `foreclosure_locking_period` int(10) DEFAULT NULL,
      `allow_age_limits` bit(1) DEFAULT NULL,
      `divide_by_thirty_for_partial_period` bit(1) DEFAULT NULL,
      `use_days_in_month_for_loan_provisioning` bit(1) DEFAULT NULL,
      `repayment_strategy_for_npa` bit(1) DEFAULT NULL,
      `aum_slab_rate` decimal(19,6) DEFAULT NULL,
      `gst_liability_by_vcpl` decimal(19,6) DEFAULT NULL,
      `gst_liability_by_partner` decimal(19,6) DEFAULT NULL,
      `disbursement_account_number` bigint(20) DEFAULT NULL,
      `collection_account_number` bigint(20) DEFAULT NULL,
      `vcpl_share_in_broken_interest` decimal(19,6) DEFAULT NULL,
      `partner_share_in_broken_interest` decimal(19,6) DEFAULT NULL,
      `monitoring_trigger_par_30` int(10) DEFAULT NULL,
      `monitoring_trigger_par_90` int(10) DEFAULT NULL,
      `loantype_cv_id` bigint(10) DEFAULT NULL,
      `framework_cv_id` bigint(10) DEFAULT NULL,
      `collection_mode_cv_id` bigint(10) DEFAULT NULL,
      `disbursement_mode_cv_id` bigint(10) DEFAULT NULL,
      `fldg_logic_cv_id` bigint(10) DEFAULT NULL,
      `penal_invoice_cv_id` bigint(10) DEFAULT NULL,
      `multiple_disbursement_cv_id` bigint(10) DEFAULT NULL,
      `tranche_clubbing_cv_id` bigint(10) DEFAULT NULL,
      `repayment_schedule_update_allowed_cv_id` bigint(10) DEFAULT NULL,
      `insurance_applicability_cv_id` bigint(10) DEFAULT NULL,
      `asset_class_cv_id` bigint(10) DEFAULT NULL,
      `class_cv_id` bigint(10) DEFAULT NULL,
      `type_cv_id` bigint(10) DEFAULT NULL,
      `enable_fees_wise_bifacation` bit(1) DEFAULT NULL,
      `broken_strategy_enum` smallint(10) DEFAULT NULL,
      `disbursement_enum` smallint(10) DEFAULT NULL,
      `collection_enum` smallint(10) DEFAULT NULL,
      `transaction_type_preference_enum` smallint(10) DEFAULT NULL,
      `rounding_mode`  varchar(10) DEFAULT NULL,
      `penny_drop_enabled` bit(1) DEFAULT NULL,
      `bank_disbursement_enabled` bit(1) DEFAULT NULL,
      `vcpl_hurdle_rate` decimal(19,6) DEFAULT NULL,
      `loan_acc_no_preference`  varchar(10) DEFAULT NULL,
      `createdon_date` datetime DEFAULT NULL,
      `createdon_userid` smallint(10) DEFAULT NULL,
      `modifiedon_date` datetime DEFAULT NULL,
      `modifiedon_userid` smallint(10) DEFAULT NULL,
  ...
  KEY `m_partner_id_ibfk_3` (`partner_id`),
  ...
  CONSTRAINT `FK_ltp_strategy` FOREIGN KEY (`loan_transaction_strategy_id`) REFERENCES `ref_loan_transaction_processing_strategy` (`id`),
   CONSTRAINT `m_product_loan_ibfk_1` FOREIGN KEY (`class_id`) REFERENCES `m_loan_product_class` (`id`),
      CONSTRAINT `m_product_loan_ibfk_2` FOREIGN KEY (`type_id`) REFERENCES `m_loan_product_type` (`id`),
      CONSTRAINT `m_partner_id_ibfk_3` FOREIGN KEY (`partner_id`) REFERENCES `m_partner` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=UTF8MB4;
...
INSERT INTO `stretchy_parameter` (`id`, `parameter_name`, `parameter_variable`, `parameter_label`, `parameter_displayType`, `parameter_FormatType`, `parameter_default`, `special`, `selectOne`, `selectAll`, `parameter_sql`, `parent_id`) VALUES
    ...
    (1023, 'partnerIdSelectOne', 'partnerId', 'Partner', 'select', 'number', '0', NULL, 'Y', NULL, 'select id, partner_name as name from m_partner order by partner_name', NULL);
...
-- Dumping structure for table fineract_default.m_product_loan_age_limits_config
DROP TABLE IF EXISTS `m_product_loan_age_limits_config`;
CREATE TABLE IF NOT EXISTS `m_product_loan_age_limits_config` (
 `id` bigint(20) NOT NULL AUTO_INCREMENT,
   `product_loan_id` bigint(20) DEFAULT NULL,
   `min_age` int(25) DEFAULT NULL,
   `max_age` int(25) DEFAULT NULL,
   PRIMARY KEY (`id`),
   KEY `product_loan_id` (`product_loan_id`),
   CONSTRAINT `m_product_loan_age_limits_config_ibfk_1` FOREIGN KEY (`product_loan_id`) REFERENCES `m_product_loan` (`id`)
 ) ENGINE=InnoDB AUTO_INCREMENT=39 DEFAULT CHARSET=utf8mb4;

-- Dumping data for table fineract_default.m_product_loan_age_limits_config: ~0 rows (approximately)
/*!40000 ALTER TABLE `m_product_loan_age_limits_config` DISABLE KEYS */;
/*!40000 ALTER TABLE `m_product_loan_age_limits_config` ENABLE KEYS */;

-- Dumping structure for table fineract_default.m_colending_charge
DROP TABLE IF EXISTS `m_colending_charge`;
CREATE TABLE IF NOT EXISTS `m_colending_charge` (
 `id` bigint(20) NOT NULL AUTO_INCREMENT,
   `product_loan_id` bigint(20) DEFAULT NULL,
   `partner_charge` int(20) DEFAULT NULL,
   `self_charge` int(20) DEFAULT NULL,
   `colending_charge` int(20) DEFAULT NULL,
   PRIMARY KEY (`id`),
   KEY `product_loan_id` (`product_loan_id`),
   CONSTRAINT `m_colending_charge_ibfk_1` FOREIGN KEY (`product_loan_id`) REFERENCES `m_product_loan` (`id`)
 ) ENGINE=InnoDB AUTO_INCREMENT=27 DEFAULT CHARSET=utf8mb4;

-- Dumping data for table fineract_default.m_colending_charge: ~0 rows (approximately)
/*!40000 ALTER TABLE `m_colending_charge` DISABLE KEYS */;
/*!40000 ALTER TABLE `m_colending_charge` ENABLE KEYS */;

-- Dumping structure for table fineract_default.m_colending_accepted_dates
DROP TABLE IF EXISTS `m_colending_accepted_dates`;
CREATE TABLE IF NOT EXISTS `m_colending_accepted_dates` (
 `id` bigint(20) NOT NULL AUTO_INCREMENT,
   `product_loan_id` bigint(20) DEFAULT NULL,
   `accepted_date` int(20) DEFAULT NULL,
   PRIMARY KEY (`id`),
   KEY `product_loan_id` (`product_loan_id`),
   CONSTRAINT `m_colending_accepted_dates_ibfk_1` FOREIGN KEY (`product_loan_id`) REFERENCES `m_product_loan` (`id`)
 ) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;

-- Dumping data for table fineract_default.m_colending_accepted_dates: ~0 rows (approximately)
/*!40000 ALTER TABLE `m_colending_accepted_dates` DISABLE KEYS */;
/*!40000 ALTER TABLE `m_colending_accepted_dates` ENABLE KEYS */;

-- Dumping structure for table fineract_default.m_product_loan_fees_charges
DROP TABLE IF EXISTS `m_product_loan_fees_charges`;
CREATE TABLE IF NOT EXISTS `m_product_loan_fees_charges` (
 `id` bigint(20) NOT NULL AUTO_INCREMENT,
   `product_loan_id` bigint(20) DEFAULT NULL,
   `charge_id` bigint(20) DEFAULT NULL,
   `self_share` decimal(19,6) DEFAULT NULL,
   `partner_share` decimal(19,6) DEFAULT NULL,
   `charge_type` varchar(20) DEFAULT NULL,
   PRIMARY KEY (`id`,`product_loan_id`,`charge_id`),
   KEY `product_loan_id` (`product_loan_id`),
   KEY `charge_id` (`charge_id`),
   CONSTRAINT `m_product_loan_fees_ibfk_1` FOREIGN KEY (`product_loan_id`) REFERENCES `m_product_loan` (`id`),
   CONSTRAINT `m_product_loan_charges_ibfk_2` FOREIGN KEY (`charge_id`) REFERENCES `m_charge` (`id`)
 ) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;

-- Dumping data for table fineract_default.m_product_loan_fees_charges: ~0 rows (approximately)
/*!40000 ALTER TABLE `m_product_loan_fees_charges` DISABLE KEYS */;
/*!40000 ALTER TABLE `m_product_loan_fees_charges` ENABLE KEYS */;

-- Dumping structure for table fineract_default.m_office_gst_details
DROP TABLE IF EXISTS `m_office_gst_details`;
CREATE TABLE IF NOT EXISTS `m_office_gst_details` (
  `id` bigint(20) NOT NULL AUTO_INCREMENT,
  `office_id` bigint(20) DEFAULT NULL,
  `gst_number` varchar(20) DEFAULT NULL,
  `state_cv_id` int(20) DEFAULT NULL,
  `cgst` decimal(19,6) DEFAULT NULL,
  `sgst` decimal(19,6) DEFAULT NULL,
  `igst` decimal(19,6) DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `m_office_gst_ibfk_1` (`office_id`),
  KEY `FK_m_office_gst_details_state_m_code_value` (`state_cv_id`),
  CONSTRAINT `FK_m_office_gst_details_state_m_code_value` FOREIGN KEY (`state_cv_id`) REFERENCES `m_code_value` (`id`),
  CONSTRAINT `m_office_gst_ibfk_1` FOREIGN KEY (`office_id`) REFERENCES `m_office` (`id`)
 ) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;

-- Dumping data for table fineract_default.m_office_gst_details: ~0 rows (approximately)
/*!40000 ALTER TABLE `m_office_gst_details` DISABLE KEYS */;
/*!40000 ALTER TABLE `m_office_gst_details` ENABLE KEYS */;

-- Dumping structure for table fineract_default.`m_loan_xirr_history_details`
DROP TABLE IF EXISTS `m_loan_xirr_history_details`;
CREATE TABLE IF NOT EXISTS `m_loan_xirr_history_details` (
  `id` bigint(20) NOT NULL AUTO_INCREMENT,
  `loan_id` bigint(20) DEFAULT NULL,
  `created_date` date DEFAULT NULL,
  `loan_event` int(10) DEFAULT NULL,
  `xirr_value` decimal(19,2) DEFAULT NULL,
  `amount` decimal(19,6) DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `m_loan_xirr_history_details_ibfk_1` (`loan_id`),
  CONSTRAINT `m_loan_xirr_history_details_ibfk_1` FOREIGN KEY (`loan_id`) REFERENCES `m_loan` (`id`)
 ) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;

-- Dumping data for table fineract_default.m_loan_xirr_history_details: ~0 rows (approximately)
/*!40000 ALTER TABLE `m_loan_xirr_history_details` DISABLE KEYS */;
/*!40000 ALTER TABLE `m_loan_xirr_history_details` ENABLE KEYS */;


-- Dumping structure for table fineract_default.`m_loan_penal_foreclosure_charge`
DROP TABLE IF EXISTS `m_loan_penal_foreclosure_charge`;
CREATE TABLE IF NOT EXISTS `m_loan_penal_foreclosure_charge` (
  `id` bigint(20) NOT NULL AUTO_INCREMENT,
  `loan_id` bigint(20) DEFAULT NULL,
  `product_id` bigint(20) NOT NULL,
  `charge_id` bigint(20) NOT NULL,
  `amount_or_percentage` decimal(19,6) DEFAULT NULL,
  `self_share_percentage` decimal(19,6) DEFAULT NULL,
  `partner_share_percentage` decimal(19,6) DEFAULT NULL,
  PRIMARY KEY (`id`,`loan_id`,`product_id`,`charge_id`),
  KEY `loan_foreign_id` (`loan_id`),
  KEY `product_foreign_id` (`product_id`),
  KEY `charge_foreign_id` (`charge_id`),
  CONSTRAINT `loan_foreign_id` FOREIGN KEY (`loan_id`) REFERENCES `m_loan` (`id`),
  CONSTRAINT `product_foreign_id` FOREIGN KEY (`product_id`) REFERENCES `m_product_loan` (`id`),
  CONSTRAINT `charge_foreign_id` FOREIGN KEY (`charge_id`) REFERENCES `m_charge` (`id`)
 ) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;

-- Dumping data for table fineract_default.m_loan_penal_foreclosure_charge: ~0 rows (approximately)
/*!40000 ALTER TABLE `m_loan_penal_foreclosure_charge` DISABLE KEYS */;
/*!40000 ALTER TABLE `m_loan_penal_foreclosure_charge` ENABLE KEYS */;
