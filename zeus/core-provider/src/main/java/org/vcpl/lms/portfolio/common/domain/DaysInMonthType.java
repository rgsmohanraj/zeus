...
public enum DaysInMonthType {
    ...
    public static DaysInMonthType fromInt(final Integer type) {
        ...
        if (type != null) {
            switch (type) {
                ...
                break;
                case 31:
                    repaymentFrequencyType = DaysInMonthType.DAYS_31;
                    break;
                    case 0:
                    repaymentFrequencyType = DaysInMonthType.INVALID;
                    break;
            }
        }
    ...
    public boolean isDaysInMonth_31() {
        return DaysInMonthType.DAYS_31.getValue().equals(this.value);
    }

    public boolean isActual() {
        return DaysInMonthType.ACTUAL.getValue().equals(this.value);
    }
