 ...
 * under the License.
 */
package org.vcpl.lms.portfolio.self.registration.service;
...
import org.vcpl.lms.infrastructure.campaigns.sms.data.SmsProviderData;
import org.vcpl.lms.infrastructure.campaigns.sms.domain.SmsCampaign;
import org.vcpl.lms.infrastructure.campaigns.sms.service.SmsCampaignDropdownReadPlatformService;
...
import org.vcpl.lms.infrastructure.core.domain.EmailDetail;
...
import org.vcpl.lms.infrastructure.core.service.GmailBackedPlatformEmailService;
...
import org.vcpl.lms.portfolio.self.registration.domain.SelfServiceRegistration;
import org.vcpl.lms.portfolio.self.registration.domain.SelfServiceRegistrationRepository;
import org.vcpl.lms.portfolio.self.registration.exception.SelfServiceRegistrationNotFoundException;
import org.vcpl.lms.useradministration.domain.AppUser;
import org.vcpl.lms.useradministration.domain.PasswordValidationPolicy;
import org.vcpl.lms.useradministration.domain.PasswordValidationPolicyRepository;
import org.vcpl.lms.useradministration.domain.Role;
import org.vcpl.lms.useradministration.domain.RoleRepository;
import org.vcpl.lms.useradministration.domain.UserDomainService;
import org.vcpl.lms.useradministration.exception.RoleNotFoundException;
import org.vcpl.lms.useradministration.service.AppUserReadPlatformService;
