...
import org.vcpl.lms.portfolio.loanaccount.domain.LoanAccrual;
import org.vcpl.lms.portfolio.loanaccount.domain.LoanTransactionType;
import org.vcpl.lms.portfolio.loanaccount.domain.MonthEndAccrual;
...
public interface LoanReadPlatformService {
    ...
    LoanScheduleData retrieveRepaymentSchedule(Long loanId,
                                               RepaymentScheduleRelatedLoanData repaymentScheduleRelatedLoanData, Collection<DisbursementData> disbursementData,
                                               boolean isInterestRecalculationEnabled, BigDecimal totalPaidFeeCharges, BigDecimal selfPrincipal, BigDecimal partnerPrincipal, BigDecimal selfInterestCharged, BigDecimal partnerInterestCharged);
    ...
    LoanTransactionData retrieveLoanForeclosureTemplate(LoanTransactionType loanTransactionType,Long loanId, LocalDate transactionDate);
    ...
    Collection retrieveColendingCharge(Collection<LoanProductFeesChargesData> colendingCharge);

    Collection<XIRRTransactionUpdateRecord> getUnpaidDuesForXIRR();

    List<MonthlyAccrualLoanDTO> retrieveLoansDisbursedBetweenDates(String from, String to);

    List<MonthlyAccrualLoanDTO> retrieveLoansDueForCurrentMonth();

    List<PartnerandProductData> findAllProducts();

    List<LoanFilterData> retrievePaginatedLoans(Long partnerId, Long productId, String fromDate, String toDate, PaginationParameters parameters);

    List<LoanAccrual> retrieveLoanAccruals(Long loanId);

    BigDecimal getNetDisbursementAmountByLoanId(Long loanId);

    String getExceptedDisbursementDateByLoanId(Long loanId);

    BigDecimal getPrincipleAmountForLoanId(Long loanId);

//    List<VpayTransactionDetailsData> retrievePennydropandDisbursement(Long loanId);

    Collection<VpayTransactionDetailsData> retrievePennyDrop(Long loanId);
    ...
    TransactionTypePreference getTransactionTypePreferenceByLoanId(Long loanId);

    BankTranscationData retrieveBankTransaction(Long loanId);

    List<ImportDocumentData> retriveBulkReportsData(String fromDate, String toDate, String type) throws ParseException;
}
