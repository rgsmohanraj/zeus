...
public class LoanProductsApiResource {
    ...
    private final Set<String> loanProductDataParameters = new HashSet<>(Arrays.asList("id", "name", "shortName", "description", "fundId",
            ...
            "externalId", "accountingMappings", "paymentChannelToFundSourceMappings", "fundOptions","classOptions","typeOptions","paymentTypeOptions",
            ...
            LoanApiConstants.fixedPrincipalPercentagePerInstallmentParamName, "classId", "typeId"));
    ...
    private final LoanProductClassReadPlatformService loanProductClassReadPlatformService;
    private final LoanProductTypeReadPlatformService loanProductTypeReadPlatformService;
    ...
    public LoanProductsApiResource(final PlatformSecurityContext context, final LoanProductReadPlatformService readPlatformService,
            ...
            final FundReadPlatformService fundReadPlatformService,final LoanProductClassReadPlatformService loanProductClassReadPlatformService,final LoanProductTypeReadPlatformService loanProductTypeReadPlatformService, final LoanDropdownReadPlatformService dropdownReadPlatformService,
        ...
        this.loanProductClassReadPlatformService=loanProductClassReadPlatformService;
        this.loanProductTypeReadPlatformService=loanProductTypeReadPlatformService;
    }
    ...
    @Operation(summary = "Create a Loan Product", description = "Depending of the Accounting Rule (accountingRule) selected, additional fields with details of the appropriate Ledger Account identifiers would need to be passed in.\n"
            ...
            "interestRate,selectPartner,enableChargeWiseBifacation,selectCharge,colendingCharge,selfCharge,partnerCharge,selectAcceptedDates" +
    ...
    private LoanProductData handleTemplate(final LoanProductData productData) {
        ...
        Collection<LoanProductClassData> classOptions = this.loanProductClassReadPlatformService.retrieveAllClasses();
        if (classOptions.isEmpty()) {
            classOptions = null;
        }

        Collection<LoanProductTypeData> typeOptions = this.loanProductTypeReadPlatformService.retrieveAllTypes();
        ...
        return new LoanProductData(productData, chargeOptions, penaltyOptions, paymentTypeOptions, currencyOptions, amortizationTypeOptions,
                ...
                fundOptions,classOptions,typeOptions, transactionProcessingStrategyOptions, rateOptions, accountOptions, accountingRuleTypeOptions,
