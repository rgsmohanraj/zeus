...
export const environment = {
  ...
  baseApiUrls: 'https://zeus.vivriticapital.com',
  // For connecting to server running elsewhere set the base API URL
  //baseApiUrl: window['env']['fineractApiUrl'] || 'https://demo.fineract.dev',
  baseApiUrl: 'https://zeus.vivriticapital.com',
...
console.log("Loading environment.prod.ts - server URL: ", environment.serverUrl);
