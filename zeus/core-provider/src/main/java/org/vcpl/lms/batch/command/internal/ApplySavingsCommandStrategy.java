...
/**
 * Implements {@link org.vcpl.lms.batch.command.CommandStrategy} and applies a new savings on an existing client.
 * It passes the contents of the body from the BatchRequest to
 * {@link org.vcpl.lms.portfolio.savings.api.SavingsAccountsApiResource} and gets back the response. This class
 * will also catch any errors raised by {@link org.vcpl.lms.portfolio.savings.api.SavingsAccountsApiResource} and
