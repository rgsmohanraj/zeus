...
export class ExportTransactionsComponent implements OnInit {
  ...
  generate() {
    ...
    this.reportsService.getPentahoRunReportData('Client Saving Transactions', data, environment.zeusPlatformTenantId, this.settingsService.language.code, this.settingsService.dateFormat)
      .subscribe( (res: any) => {
