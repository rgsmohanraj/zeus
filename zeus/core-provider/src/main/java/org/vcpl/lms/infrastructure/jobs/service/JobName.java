...
public enum JobName {
    ...
    XIRR_CALCULATION("XIRR Calculation"),
    MONTHLY_ACCRUAL_TRANSACTION("Monthly Accrual Transaction"),
    DPD_CALCULATION_FOR_LOANS_WITH_NO_OVERDUE_CHARGE("DPD Calculation For Loans when no Overdue Charge"),
    ADVANCE_AMOUNT_APPROPRIATION_ON_DUE_DATE("Advance Amount Appropriation on Due Date"),
    APPLY_BOUNCE_CHARGE_TO_OVERDUE_LOANS("Apply Bounce Charge To Overdue Loans"),
    VPAY_TRANSACTION_ENQUIRY("Vpay transaction Enquiry"),
    SYNC_KEYCLOAK_USER("Sync Keycloak User");
