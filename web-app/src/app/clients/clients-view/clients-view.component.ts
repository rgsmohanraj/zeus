...
import { AadharUpdateDialogComponent } from './custom-dialogs/aadhar-update-dialog/aadhar-update-dialog.component';
...
export class ClientsViewComponent implements OnInit {
  ...
  /**
       * Update aadhaar
       *//*
      private updateAadhaar() {
        const updateAadhaarDialogRef = this.dialog.open(AadharUpdateDialogComponent);
        updateAadhaarDialogRef.afterClosed().subscribe((response: { confirm: any }) => {
          if (response.confirm) {
            this.clientsService.updateAadhaar(this.clientViewData.id, data )
              .subscribe(() => {
                this.reload();
              });
          }
