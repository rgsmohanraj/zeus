...
public interface LoanSchedularService {
    ...
    void calculateXIRR() throws JobExecutionException;

    void calculateDPDForLoansWithNoOverdueCharge() throws JobExecutionException;

    void appropriateAdvanceAmountOnDueDate() throws JobExecutionException;

    void syncKeycloakUser() throws JobExecutionException, URISyntaxException;
