...
public class LoanProductConfigurableAttributes extends AbstractPersistableCustom implements Serializable {
    ...
    @Column(name = "repayment_strategy_for_npa", nullable = true)
    ...
    private static final String[] supportedloanConfigurableAttributes = { LoanProductConstants.amortizationTypeParamName,
            ...
            LoanProductConstants.interestCalculationPeriodTypeParamName, LoanProductConstants.repaymentStrategyForNpaParamName,
    ...
    public static LoanProductConfigurableAttributes createFrom(JsonCommand command) {
        ...
        final boolean repaymentStrategyForNpa = command.parsedJson().getAsJsonObject()
                .getAsJsonObject(LoanProductConstants.allowAttributeOverridesParamName)
        ...
        return new LoanProductConfigurableAttributes(amortization, interestMethod, transactionProcessingStrategy, interestCalcPeriod,repaymentStrategyForNpa,
    ...
    public static LoanProductConfigurableAttributes populateDefaultsForConfigurableAttributes() {
        ...
        final boolean repaymentStrategyForNpa = true;
    ...
    public LoanProductConfigurableAttributes(Boolean amortization, Boolean interestMethod, Boolean transactionProcessingStrategy,
            Boolean interestCalcPeriod, boolean repaymentStrategyForNpa,Boolean arrearsTolerance, Boolean repaymentEvery, Boolean graceOnPrincipalAndInterestPayment,
    ...
    public boolean getRepaymentStrategyForNpa() {
        return repaymentStrategyForNpa;
    }
    ...
    public void setRepaymentStrategyForNpa(Boolean repaymentStrategyForNpa) {
        this.repaymentStrategyForNpa = repaymentStrategyForNpa;
    }
    ...
    public boolean equals(Object o) {
        ...
        return Objects.equals(loanProduct, that.loanProduct) && Objects.equals(amortizationType, that.amortizationType)
                ...
                && Objects.equals(repaymentStrategyForNpa, that.repaymentStrategyForNpa)
    ...
    public int hashCode() {
        return Objects.hash(loanProduct, amortizationType, interestType, transactionProcessingStrategyId, interestCalculationPeriodType,
                repaymentStrategyForNpa,inArrearsTolerance, repaymentEvery, graceOnPrincipalAndInterestPayment, graceOnArrearsAgeing);
    }
}
