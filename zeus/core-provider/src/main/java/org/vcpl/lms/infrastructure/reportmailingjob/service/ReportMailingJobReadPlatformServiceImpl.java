...
import org.vcpl.lms.infrastructure.reportmailingjob.data.ReportMailingJobData;
...
import org.vcpl.lms.infrastructure.reportmailingjob.data.ReportMailingJobTimelineData;
import org.vcpl.lms.infrastructure.reportmailingjob.exception.ReportMailingJobNotFoundException;
    ...
    private static final class ReportMailingJobMapper implements RowMapper<ReportMailingJobData> {
        ...
        public String reportMailingJobSchema() {
            return "rmj.id, rmj.name, rmj.description, rmj.start_datetime as startDateTime, rmj.recurrence, rmj.created_date as createdOnDate, "
                    ...
                    + "sr.core_report as coreReport, sr.use_report as useReport,sr.jasper_report_template_path as jasperReportTemplate" + "from m_report_mailing_job rmj "
        ...
        public ReportMailingJobData mapRow(ResultSet rs, int rowNum) throws SQLException {
            ...
            final ReportData stretchyReport = new ReportData(reportId, reportName, reportType, reportSubType, reportCategory,
                    reportDescription, reportSql, coreReport, useReport,jasperReportTemplate, null);
