...
/**
 * Implements {@link org.vcpl.lms.batch.command.CommandStrategy} and applies a new loan on an existing client. It
 * passes the contents of the body from the BatchRequest to
 * {@link org.vcpl.lms.portfolio.loanaccount.api.LoansApiResource} and gets back the response. This class will
 * also catch any errors raised by {@link org.vcpl.lms.portfolio.loanaccount.api.LoansApiResource} and map those
