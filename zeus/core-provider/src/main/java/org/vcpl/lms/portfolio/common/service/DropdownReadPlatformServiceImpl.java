...
import static org.vcpl.lms.portfolio.common.service.CommonEnumerations.conditionType;
import static org.vcpl.lms.portfolio.common.service.CommonEnumerations.daysInMonthType;
import static org.vcpl.lms.portfolio.common.service.CommonEnumerations.daysInYearType;
import static org.vcpl.lms.portfolio.common.service.CommonEnumerations.termFrequencyType;
...
public class DropdownReadPlatformServiceImpl implements DropdownReadPlatformService {
    ...
    public List<EnumOptionData> retrieveDaysInMonthTypeOptions() {
        ...
        final List<EnumOptionData> daysInMonthTypeOptions = Arrays.asList(daysInMonthType(DaysInMonthType.ACTUAL),
                daysInMonthType(DaysInMonthType.DAYS_30),daysInMonthType(DaysInMonthType.DAYS_31));
    ...
    public List<RoundingMode> retrieveRoundingMode() {
        ...
        //while adding or updating the Rounding modes, also change in method isRoundingModesExist() of DataValidatorBuilder class
