...
export const BulkImports = [
    ...
    // },
    {
      ...
      entityType: 'loans',
      urlSuffix: '/loans',
      permission: 'BULK_LOAN_CREATION',
      formFields: 2
    },

    {
      name: 'Uploaded File Status Download',
      entityType: 'loans',
      urlSuffix: '/bulkReports',
      permission: 'VIEW_BULK_IMPORT',
      formFields: 4
    },

    {
          ...
          entityType: 'loans',
          urlSuffix: '/repayment',
          permission: 'BULK_COLLECTION',
          formFields: 3
        },

     {
      name: 'Loan Charge Collection',
      entityType: 'loans',
      urlSuffix: '/charges',
      permission: 'BULK_COLLECTION',
//      formFields: 2
