...
public class ClientApiCollectionConstants extends ClientApiConstants {
    ...
    protected static final Set<String> CLIENT_CREATE_REQUEST_DATA_PARAMETERS = new HashSet<>(Arrays.asList(familyMembers, address,
            localeParamName, dateFormatParamName, groupIdParamName, accountNoParamName, externalIdParamName, mobileNoParamName,ageParamName,
            emailAddressParamName, firstnameParamName, middlenameParamName, lastnameParamName,beneficiaryNameParamName,cityParamName,beneficiaryAccountNumberParamName,ifscCodeParamName,micrCodeParamName,swiftCodeParamName,branchParamName, fullnameParamName, officeIdParamName,
            activeParamName, activationDateParamName, staffIdParamName, submittedOnDateParamName, savingsProductIdParamName,
            dateOfBirthParamName, genderIdParamName,stateIdParamName,clientTypeIdParamName, clientClassificationIdParamName,
            clientNonPersonDetailsParamName, displaynameParamName, legalFormIdParamName, datatables, isStaffParamName,panParamName,aadhaarParamName, accountTypeIdParamName, addressParamName,voterIdParamName,passportNumberParamName,drivingLicenseParamName,pincodeParamName,rationCardNumberParamName));
    ...
    protected static final Set<String> CLIENT_UPDATE_REQUEST_DATA_PARAMETERS = new HashSet<>(Arrays.asList(localeParamName,
            dateFormatParamName, accountNoParamName, externalIdParamName, mobileNoParamName,ageParamName, emailAddressParamName, firstnameParamName,
            middlenameParamName,

            lastnameParamName,beneficiaryNameParamName,cityParamName,beneficiaryAccountNumberParamName,ifscCodeParamName,micrCodeParamName,swiftCodeParamName,branchParamName, fullnameParamName, activeParamName, activationDateParamName, staffIdParamName, savingsProductIdParamName,
            dateOfBirthParamName, genderIdParamName,stateIdParamName, clientTypeIdParamName, clientClassificationIdParamName, submittedOnDateParamName,
            clientNonPersonDetailsParamName, displaynameParamName, legalFormIdParamName, isStaffParamName,panParamName,aadhaarParamName,accountTypeIdParamName, addressParamName,voterIdParamName,passportNumberParamName,drivingLicenseParamName,pincodeParamName,rationCardNumberParamName));
