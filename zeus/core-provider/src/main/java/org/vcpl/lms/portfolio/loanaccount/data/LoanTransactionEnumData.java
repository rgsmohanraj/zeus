...
public class LoanTransactionEnumData {
    ...
    private final boolean foreclosure;

    private final boolean coolingOff;
    ...
    public LoanTransactionEnumData(final Long id, final String code, final String value) {
        ...
        this.foreclosure = Long.valueOf(11).equals(this.id);
        this.coolingOff = Long.valueOf(26).equals(this.id);
