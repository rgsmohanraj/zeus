...
import org.vcpl.lms.portfolio.loanaccount.data.LoanTermVariationsDataWrapper;
import org.vcpl.lms.portfolio.loanaccount.domain.Loan;
import org.vcpl.lms.portfolio.loanaccount.domain.LoanInterestRecalculationDetails;
import org.slf4j.Logger;
import org.slf4j.LoggerFactory;
import org.vcpl.lms.portfolio.loanaccount.loanschedule.exception.BrokenCalculationException;
...
public final class LoanApplicationTerms {
    ...
    private BigDecimal firstBroken;
    private BigDecimal lastBroken;

    private LocalDate firstDisbursementDate;

    private BrokenStrategy brokenStrategy;
    private BrokenStrategyDayInYear brokenStrategyDayInYear;
    private BrokenStrategyDaysInMonth brokenStrategyDaysInMonth;

    public BrokenStrategy getBrokenStrategy() {
    ...
    public void setFirstDisbursementDate(LocalDate firstDisbursementDate) {
        this.firstDisbursementDate = firstDisbursementDate;
    }

    public BigDecimal getFirstBroken() {
        return firstBroken;
    }

    public void setFirstBroken(BigDecimal firstBroken) {
        this.firstBroken = firstBroken;
    }

    public BigDecimal getLastBroken() {
        return lastBroken;
    }

    public void setLastBroken(BigDecimal lastBroken) {
        this.lastBroken = lastBroken;
    }
    ...
    private BigDecimal brokenDisbursement;

    public void setBrokenDisbursement(BigDecimal brokenDisbursement) {
        this.brokenDisbursement = brokenDisbursement;
    }

    private LoanProduct loanProduct;


    public BigDecimal getBrokenDisbursement() {
        return brokenDisbursement;
    }
    ...
    public static LoanApplicationTerms assembleFrom(final ApplicationCurrency currency, final Integer loanTermFrequency,
                                                    ...
                                                    final BigDecimal fixedPrincipalPercentagePerInstallment, final boolean isPrincipalCompoundingDisabledForOverdueLoans, final BigDecimal selfPrincipal,
                                                    final BigDecimal partnerPrincipal, final BigDecimal selfInterestCharged, final BigDecimal partnerInterestCharged,
                                                    final LoanProduct loanProduct, final BigDecimal selfDue, final BigDecimal partnerDue,final BrokenStrategy brokenStrategy,final BrokenStrategyDayInYear brokenStrategyDayInYear,final BrokenStrategyDaysInMonth brokenStrategyDaysInMonth) {
        ...
        return new LoanApplicationTerms(currency, loanTermFrequency, loanTermPeriodFrequencyType, numberOfRepayments, repaymentEvery,
                ...
                isPrincipalCompoundingDisabledForOverdueLoans,selfPrincipal,partnerPrincipal,selfInterestCharged,partnerInterestCharged,
                loanProduct,selfDue,partnerDue,brokenStrategy,brokenStrategyDayInYear,brokenStrategyDaysInMonth);
    ...
    public static LoanApplicationTerms assembleFrom(final ApplicationCurrency applicationCurrency, final Integer loanTermFrequency,
                                                    ...
                                                    final Calendar loanCalendar, final HolidayDetailDTO holidayDetailDTO, final boolean allowCompoundingOnEod,final BigDecimal selfPrincipal,
                                                    final BigDecimal partnerPrincipal,final BigDecimal selfInterestCharged,final BigDecimal partnerInterestCharged,
                                                    final LoanProduct loanProduct,final BigDecimal selfDue,final BigDecimal partnerDue,final BrokenStrategy brokenStrategy,
                                                    final BrokenStrategyDayInYear brokenStrategyDayInYear,final BrokenStrategyDaysInMonth brokenStrategyDaysInMonth) {
        final CalendarHistoryDataWrapper calendarHistoryDataWrapper = null;
        ...
        return assembleFrom(applicationCurrency, loanTermFrequency, loanTermPeriodFrequencyType, nthDay, dayOfWeek,
                ...
                false, null, false,selfPrincipal,partnerPrincipal,selfInterestCharged,partnerInterestCharged,loanProduct,selfDue,partnerDue,brokenStrategy,brokenStrategyDayInYear,brokenStrategyDaysInMonth);
    }
    ...
    public static LoanApplicationTerms assembleFrom(final ApplicationCurrency applicationCurrency, final Integer loanTermFrequency,
                                                    ...
                                                    final BigDecimal selfPrincipal,final BigDecimal partnerPrincipal,final BigDecimal selfInterestCharged,
                                                    final BigDecimal partnerInterestCharged,final LoanProduct loanProduct,final BigDecimal selfDue,
                                                    final BigDecimal partnerDue,final BrokenStrategy brokenStrategy,
                                                    final BrokenStrategyDayInYear brokenStrategyDayInYear,final BrokenStrategyDaysInMonth brokenStrategyDaysInMonth) {
    ...
    public static LoanApplicationTerms assembleFrom(final ApplicationCurrency applicationCurrency, final Integer loanTermFrequency,
                                                    ...
                                                    final boolean allowCompoundingOnEod, final BigDecimal selfPrincipal,
                                                    final BigDecimal partnerPrincipal, final BigDecimal selfInterestCharged,
                                                    final BigDecimal partnerInterestCharged, final LoanProduct loanProduct,final BigDecimal selfDue,
                                                    final BigDecimal partnerDue,final BrokenStrategy brokenStrategy,final BrokenStrategyDayInYear brokenStrategyDayInYear,final BrokenStrategyDaysInMonth brokenStrategyDaysInMonth) {
        ...
        return new LoanApplicationTerms(applicationCurrency, loanTermFrequency, loanTermPeriodFrequencyType, numberOfRepayments,
                ...
                false, false, null,
                false,selfPrincipal,partnerPrincipal,selfInterestCharged,partnerInterestCharged,
                loanProduct,selfDue,partnerDue,brokenStrategy,brokenStrategyDayInYear,brokenStrategyDaysInMonth);
    ...
    public static LoanApplicationTerms assembleFrom(final LoanApplicationTerms applicationTerms,
        ...
        return new LoanApplicationTerms(applicationTerms.currency, applicationTerms.loanTermFrequency,
                ...
                applicationTerms.selfPrincipal,applicationTerms.partnerPrincipal,applicationTerms.selfInterestCharged,applicationTerms.partnerInterestCharged,
                applicationTerms.loanProduct,applicationTerms.selfDue,applicationTerms.partnerDue, applicationTerms.brokenStrategy,applicationTerms.brokenStrategyDayInYear,applicationTerms.brokenStrategyDaysInMonth);
    }
    ...
    private LoanApplicationTerms(final ApplicationCurrency currency, final Integer loanTermFrequency,
                                 ...
                                 final boolean isPrincipalCompoundingDisabledForOverdueLoans,final BigDecimal selfPrincipal,final BigDecimal partnerPrincipal,
                                 final BigDecimal selfInterestCharged,final BigDecimal partnerInterestCharged, final LoanProduct loanProduct,
                                 final BigDecimal selfDue,final BigDecimal partnerDue,final BrokenStrategy brokenStrategy,final BrokenStrategyDayInYear brokenStrategyDayInYear,final BrokenStrategyDaysInMonth brokenStrategyDaysInMonth) {
        ...
        this.brokenStrategyDayInYear=brokenStrategyDayInYear;
        this.brokenStrategyDaysInMonth=brokenStrategyDaysInMonth;
    ...
    public Money calculateTotalInterestCharged(final PaymentPeriodsInOneYearCalculator calculator, final MathContext mc) {
        ...
        switch (this.interestMethod) {
            case FLAT:
                ...
                final Money totalGraceOnInterestCharged = totalInterestPerInstallment.multiplyRetainScale(BigDecimal.valueOf(getInterestChargingGrace()),
                        mc.getRoundingMode(),this.getLoanProduct());
    ...
    public Money pmtForInstallment(final PaymentPeriodsInOneYearCalculator calculator, final Money outstandingBalance,
        ...
        // equal installment
/**
 *Alter this method for Daily emi correcrion
 */
        final BigDecimal DailyPeriodicInterestRate = periodicInterestRateForDaily(calculator, mc, DaysInMonthType.DAYS_30,
               DaysInYearType.DAYS_365, periodStartDate, periodEndDate,periodNumber);
//        final BigDecimal periodicInterestRateForRepaymentPeriod = periodicInterestRate(calculator, mc, DaysInMonthType.DAYS_30,
//                DaysInYearType.DAYS_365, periodStartDate, periodEndDate,periodNumber);

        Money totalPmtForThisInstallment = calculateTotalDueForEqualInstallmentRepaymentPeriod(DailyPeriodicInterestRate,
                outstandingBalance, periodsElapsed);
        return totalPmtForThisInstallment;
    }

    private BigDecimal periodicInterestRateForDaily(PaymentPeriodsInOneYearCalculator calculator, MathContext mc, DaysInMonthType days30, DaysInYearType days365, LocalDate periodStartDate, LocalDate periodEndDate, int periodNumber) {

            return periodicInterestRateForDaily(calculator, mc, daysInMonthType, daysInYearType, periodStartDate, periodEndDate, false,periodNumber);
    }

    private BigDecimal periodicInterestRateForDaily(PaymentPeriodsInOneYearCalculator calculator, MathContext mc, DaysInMonthType daysInMonthType, DaysInYearType daysInYearType, LocalDate periodStartDate, LocalDate periodEndDate, boolean isForPMT, int periodNumber) {
        ...
        if (isForPMT) {
            ...
            loanTermFrequencyBigDecimal = calculateLoanTermFrequency(periodStartDate, periodEndDate,periodNumber,daysInMonthType);
        }
        switch (this.interestCalculationPeriodMethod) {
            ...
            case DAILY:
                ...
                Double pmtMonthlyInterestRateConversion = Double.valueOf(loanProduct.getEmiDaysInMonth())/Double.valueOf(loanProduct.getEmiDaysInYear());
                if( !PmtCalcEnum.getInt(loanProduct.getEmiCalcLogic()).isYearly()){
                    pmtMonthlyInterestRateConversion = DaysInYearType.fromInt(loanProduct.getEmiDaysInMonth()).isActual()
                            ? (double) periodStartDate.lengthOfMonth() / periodStartDate.lengthOfYear()
                            : Double.valueOf(loanProduct.getEmiDaysInMonth())/Double.valueOf(loanProduct.getEmiDaysInYear());

                }
                BigDecimal numberOfDaysInPeriod = BigDecimal.valueOf(Math.toIntExact(ChronoUnit.DAYS.between(periodStartDate, periodEndDate)));

                final BigDecimal oneDayOfYearInterestRate  =   PmtCalcEnum.getInt(loanProduct.getEmiCalcLogic()).isYearly()
                        ? BigDecimal.valueOf(this.annualNominalInterestRate.doubleValue() /divisor.doubleValue()/BigDecimal.valueOf(12).doubleValue())
                        : BigDecimal.valueOf(this.annualNominalInterestRate.doubleValue() /divisor.doubleValue() * pmtMonthlyInterestRateConversion);
...
//                        .multiply(loanTermFrequencyBigDecimal);
                periodicInterestRate = BigDecimal.valueOf(this.annualNominalInterestRate.doubleValue()/loanTermPeriodsInYearBigDecimal.doubleValue()/ divisor.doubleValue() * loanTermFrequencyBigDecimal.doubleValue());
                break;
        }
    ...
    public PrincipalInterest calculateTotalInterestForPeriod(final PaymentPeriodsInOneYearCalculator calculator,
                                                             ...
                                                             final LocalDate periodEndDate,final Money principaltobeScheduled,final int numberOfRepayments,final int periodNumbers,final LoanApplicationTerms loanApplicationTerms) {
        ...
        //To find the last repayment date
        final Boolean isLastDueDate = isLastRepaymentPeriod( numberOfRepayments, periodNumbers);
        ...
        switch (interestMethod) {
            ...
            case DECLINING_BALANCE:
                ...
                final Money interestForThisInstallmentBeforeGrace = calculateDecliningInterestDueForInstallmentBeforeApplyingGrace(
                        calculator, mc, outstandingBalance, periodStartDate, periodEndDate, periodNumber, principaltobeScheduled,isLastDueDate,loanApplicationTerms);
                ...
                final Money interestForThisInstallmentAfterGrace = calculateDecliningInterestDueForInstallmentAfterApplyingGrace(calculator,
                        ...
                        periodEndDate,principaltobeScheduled,isLastDueDate,loanApplicationTerms);
        ...
        switch (this.interestMethod) {
            case FLAT:
                ...
                totalInterestDue = this.principal.minus(totalPrincipalAccountedForInterestCalcualtion)
                        .multiplyRetainScale(interestRateForLoanTerm, mc.getRoundingMode(),this.getLoanProduct());
        ...
        switch (this.interestCalculationPeriodMethod) {
            ...
            case SAME_AS_REPAYMENT_PERIOD:
                if (this.allowPartialPeriodInterestCalcualtion) {
                    ...
                    periodsInLoanTerm = calculatePeriodsBetweenDates(startDate, this.loanEndDate,0,null);
                }
                break;
        }
    ...
    public BigDecimal calculatePeriodsBetweenDates(final LocalDate startDate, final LocalDate endDate,int periodNumber, DaysInMonthType daysInMonthType) {
    ...
    private BigDecimal periodicInterestRate(final PaymentPeriodsInOneYearCalculator calculator, final MathContext mc,
                                            ...
                                            LocalDate periodEndDate,int periodNumber) {
        return periodicInterestRate(calculator, mc, daysInMonthType, daysInYearType, periodStartDate, periodEndDate, false,periodNumber);
    }
    ...
    private BigDecimal periodicInterestRate(final PaymentPeriodsInOneYearCalculator calculator, final MathContext mc,
                                            ...
                                            boolean isForPMT,int periodNumber) {

         long loanTermPeriodsInOneYear = calculatePeriodsInOneYear(calculator);

        if(this.daysInYearType.isActual() &&  this.interestCalculationPeriodMethod.isDaily()){
            Integer numberOfDays = periodEndDate.lengthOfYear();
            loanTermPeriodsInOneYear = Long.valueOf(numberOfDays);
        }
...
//                        .divide(divisor, mc);
                ...
                final BigDecimal oneDayOfYearInterestRate = BigDecimal.valueOf(this.annualNominalInterestRate.doubleValue() /(loanTermPeriodsInYearBigDecimal.doubleValue())/(divisor.doubleValue()));
                ...
                switch (this.repaymentPeriodFrequencyType) {
                    ...
                    case MONTHS:
                        if (daysInMonthType.isDaysInMonth_30()) {
                           // numberOfDaysInPeriod = loanTermFrequencyBigDecimal.multiply(BigDecimal.valueOf(30), mc);
                            numberOfDaysInPeriod =BigDecimal.valueOf(loanTermFrequencyBigDecimal.doubleValue() *(BigDecimal.valueOf(30).doubleValue()));
                        }
//                        periodicInterestRate = oneDayOfYearInterestRate.multiply(numberOfDaysInPeriod, mc);
                        periodicInterestRate = BigDecimal.valueOf(oneDayOfYearInterestRate.doubleValue()*numberOfDaysInPeriod.doubleValue());
                        break;
                    case YEARS:
                        switch (daysInYearType) {
                            case DAYS_360:
...
//                        .multiply(loanTermFrequencyBigDecimal);
    ...
    private BigDecimal calculateLoanTermFrequency(final LocalDate periodStartDate, final LocalDate periodEndDate,int periodNumber, DaysInMonthType daysInMonthType) {
        BigDecimal loanTermFrequencyBigDecimal = BigDecimal.valueOf(this.repaymentEvery);
        if (this.isInterestChargedFromDateSameAsDisbursalDateEnabled && interestMethod.isDecliningBalnce()) {
            loanTermFrequencyBigDecimal = calculatePeriodsBetweenDates(periodStartDate, periodEndDate,periodNumber,daysInMonthType);
        }
    ...
    private double paymentPerPeriod(final BigDecimal periodicInterestRate, final Money balance, final int periodsElapsed) {
        ...
        if (getFixedEmiAmount() == null) {
            ...
            double installmentAmount = PmtFormula.pmtWithMonthlyYearlyInterest(periodicInterestRate.doubleValue(), periodsRemaining.doubleValue(),
    ...
    private Money calculateDecliningInterestDueForInstallmentBeforeApplyingGrace(final PaymentPeriodsInOneYearCalculator calculator,
                                                                                 final MathContext mc, final Money outstandingBalance, LocalDate periodStartDate, LocalDate periodEndDate, final int periodNumber, final Money principaltobeScheduled,final boolean isLastDueDate,final LoanApplicationTerms loanApplicationTerms) {

        Money interestDue = Money.zero(outstandingBalance.getCurrency());
        LocalDate interestChargedDate=loanApplicationTerms.getInterestChargedFromLocalDate();
        LocalDate repaymentStartDate=loanApplicationTerms.getFirstDisbursementDate();

        //to get the brokenStrategy from product level
       final String brokenStrategy= String.valueOf(loanApplicationTerms.getBrokenStrategy());
//        final BigDecimal selfPrincipal=loanApplicationTerms.getSelfPrincipal();
//        final BigDecimal partnerPrincipal=loanApplicationTerms.getPartnerPrincipal();
//        final BigDecimal selfInterestCharged=loanApplicationTerms.getSelfInterestCharged();
//        final BigDecimal partnerInterestCharged=loanApplicationTerms.getPartnerInterestCharged();


        final BigDecimal periodicInterestRate = periodicInterestRate(calculator, mc, this.daysInMonthType, this.daysInYearType,
                periodStartDate, periodEndDate,periodNumber);// 0.021232877 ob:14911.64
     //   interestDue = outstandingBalance.multiplyRetainScale(periodicInterestRate, mc.getRoundingMode());


        final String brokenFirst="FIRSTREPAYMENT";
        final String brokenLast="LASTREPAYMENT";
        final String brokenDisbursemnet="DISBURSEMENT";

        if(brokenStrategy.equals(brokenFirst) && periodNumber==1) {
            final BigDecimal firstBrokenInterest = firstBrokenInterest(calculator, mc, this.daysInMonthType, this.daysInYearType,
                    periodStartDate, periodEndDate, periodNumber, outstandingBalance, principaltobeScheduled);

            loanApplicationTerms.setFirstBroken(firstBrokenInterest);

            //interestDue = outstandingBalance.multiplyRetainScale(periodicInterestRate, mc.getRoundingMode()).add(firstBrokenInterest);
            interestDue = outstandingBalance.multiplyRetainScale(periodicInterestRate, this.getLoanProduct().getRoundingMode(),this.getLoanProduct()).add(firstBrokenInterest);
            if(this.interestCalculationPeriodMethod.isDaily() && daysInMonthType.isActual()){

//                interestDue = outstandingBalance.multiplyRetainScale(periodicInterestRate, mc.getRoundingMode()).minus(firstBrokenInterest);
                interestDue = outstandingBalance.multiplyRetainScale(periodicInterestRate, this.getLoanProduct().getRoundingMode(),this.getLoanProduct()).minus(firstBrokenInterest);
            }
            return interestDue;
        }
        else if (brokenStrategy.equals(brokenDisbursemnet) && periodNumber==1 )
        {
            final BigDecimal BrokenAtDisbursement = lastBrokenInterest(calculator, mc, this.daysInMonthType, this.daysInYearType,
                    periodStartDate, periodEndDate, periodNumber, outstandingBalance, principaltobeScheduled,interestChargedDate,repaymentStartDate);
            int val =1;
            if(val==1) {

                loanApplicationTerms.setBrokenDisbursement(BrokenAtDisbursement);
                val--;
            }
            interestDue = outstandingBalance.multiplyRetainScale(periodicInterestRate, mc.getRoundingMode(),this.getLoanProduct());
            if(this.interestCalculationPeriodMethod.isDaily() && daysInMonthType.isActual()){
//                interestDue = outstandingBalance.multiplyRetainScale(periodicInterestRate, mc.getRoundingMode()).minus(BrokenAtDisbursement);
                interestDue = outstandingBalance.multiplyRetainScale(periodicInterestRate, this.getLoanProduct().getInterestRoundingMode(),this.getLoanProduct()).minus(BrokenAtDisbursement);
            }
           // BigDecimal roundedTotal = interestDue.setScale(2, RoundingMode.HALF_EVEN);
            return interestDue;

        }
        else if(brokenStrategy.equals(brokenLast) && isLastDueDate==true){

            final BigDecimal lastBrokenInterest = lastBrokenInterest(calculator, mc, this.daysInMonthType, this.daysInYearType,
                    periodStartDate, periodEndDate, periodNumber, outstandingBalance, principaltobeScheduled,interestChargedDate,repaymentStartDate);
            loanApplicationTerms.setLastBroken(lastBrokenInterest);

//            interestDue = outstandingBalance.multiplyRetainScale(periodicInterestRate, mc.getRoundingMode()).add(lastBrokenInterest);
            interestDue = outstandingBalance.multiplyRetainScale(periodicInterestRate, this.getLoanProduct().getRoundingMode(),this.getLoanProduct()).add(lastBrokenInterest);
            return interestDue;}
        else if(brokenStrategy.equals(brokenLast) && periodNumber==1 && daysInMonthType.isActual()){
            final BigDecimal lastBrokenInterest = lastBrokenInterest(calculator, mc, this.daysInMonthType, this.daysInYearType,
                    periodStartDate, periodEndDate, periodNumber, outstandingBalance, principaltobeScheduled,interestChargedDate,repaymentStartDate);
            loanApplicationTerms.setLastBroken(lastBrokenInterest);

//            interestDue = outstandingBalance.multiplyRetainScale(periodicInterestRate, mc.getRoundingMode()).minus(lastBrokenInterest);
            interestDue = outstandingBalance.multiplyRetainScale(periodicInterestRate, this.getLoanProduct().getRoundingMode(),this.getLoanProduct()).minus(lastBrokenInterest);
            return interestDue;

        }
        else {
//            interestDue = outstandingBalance.multiplyRetainScale(periodicInterestRate, mc.getRoundingMode());
            interestDue = outstandingBalance.multiplyRetainScale(periodicInterestRate, this.getLoanProduct().getRoundingMode(),this.getLoanProduct());

            return interestDue;
        }
    }

    private BigDecimal lastBrokenInterest(PaymentPeriodsInOneYearCalculator calculator, MathContext mc, DaysInMonthType daysInMonthType, DaysInYearType daysInYearType, LocalDate periodStartDate, LocalDate periodEndDate, int periodNumber, Money outstandingBalance, Money principaltobeScheduled, LocalDate interestChargedDate, LocalDate repaymentStartDate) {

        return lastBrokenPeriodicInterestRate(calculator, mc, daysInMonthType, daysInYearType, periodStartDate, periodEndDate,false,periodNumber, outstandingBalance, principaltobeScheduled,interestChargedFromDate,repaymentStartDate);



    }

    private BigDecimal lastBrokenPeriodicInterestRate(PaymentPeriodsInOneYearCalculator calculator, MathContext mc, DaysInMonthType daysInMonthType, DaysInYearType daysInYearType, LocalDate periodStartDate, LocalDate periodEndDate, boolean isForPMT, int periodNumber, Money outstandingBalance, Money principaltobeScheduled, LocalDate interestChargedFromDate, LocalDate repaymentsStartingFromDate) {
        ...
        if (isForPMT) {
            ...
            loanTermFrequencyBigDecimal = calculatelastBrokenLoanTermFrequency(periodStartDate, periodEndDate,periodNumber,daysInMonthType,interestChargedFromDate,repaymentsStartingFromDate);
        }
        final BigDecimal firstBroken=this.annualNominalInterestRate.divide(divisor, mc).multiply(loanTermFrequencyBigDecimal);

        //final BigDecimal Amount =outstandingBalance.getAmount();

        final BigDecimal Amount = principaltobeScheduled.getAmount();
                ...
                switch (this.repaymentPeriodFrequencyType) {
                    ...
                    case MONTHS:
                        if (daysInMonthType.isDaysInMonth_30()) {
                            ...
                            numberOfDaysInPeriod = firstBroken.multiply(Amount);


                            //numberOfDaysInPeriod = loanTermFrequencyBigDecimal.multiply(BigDecimal.valueOf(30), mc);
                        }
                        else if(daysInMonthType.isDaysInMonth_31()){
//                            //numberOfDaysInPeriod = loanTermFrequencyBigDecimal.multiply(BigDecimal.valueOf(31), mc);
//
                            numberOfDaysInPeriod = firstBroken.multiply(Amount);
                        }
                        else{
                        ...
                        periodicInterestRate=numberOfDaysInPeriod;
...
//                        .multiply(loanTermFrequencyBigDecimal);
    ...
    private BigDecimal calculatelastBrokenLoanTermFrequency(LocalDate periodStartDate, LocalDate periodEndDate, int periodNumber, DaysInMonthType daysInMonthType, LocalDate interestChargedFromDate, LocalDate repaymentsStartingFromDate) {
        BigDecimal loanTermFrequencyBigDecimal = BigDecimal.valueOf(this.repaymentEvery);
        if ( this.isInterestChargedFromDateSameAsDisbursalDateEnabled && interestMethod.isDecliningBalnce() ) {
            loanTermFrequencyBigDecimal = calculatePeriodsBetweenDates(periodStartDate, periodEndDate,periodNumber,daysInMonthType );
        }

        else if(this.interestCalculationPeriodMethod.isDaily()){
            loanTermFrequencyBigDecimal = calculateDaysLastBrokenBetweenDates(periodStartDate, periodEndDate,periodNumber,daysInMonthType,interestChargedFromDate,repaymentsStartingFromDate);
        }

        else if(this.interestCalculationPeriodMethod.isSameAsRepaymentPeriod())
        {
            loanTermFrequencyBigDecimal = calculateDaysPeriodiclastBrokenBetweenDates(periodStartDate, periodEndDate,periodNumber,daysInMonthType,interestChargedFromDate,repaymentsStartingFromDate);
    ...
    private BigDecimal calculateDaysLastBrokenBetweenDates(LocalDate startDate, LocalDate endDate, int periodNumber, DaysInMonthType daysInMonthType, LocalDate interestChargedFromDate, LocalDate repaymentsStartingFromDate) {
        ...
        switch (this.repaymentPeriodFrequencyType) {
            ...
            case MONTHS:
                ...
                final int days =numberOfDaysofDaysBetweenTwoDates(interestChargedFromDate,repaymentsStartingFromDate);


                if (repaymentPeriodFrequencyType.isMonthly()) {

                    if (brokenStrategyDayInYear.is365()) {

                        numberOfPeriods = BigDecimal.valueOf((double) days / brokenStrategyDayInYear.getValue());
                    } else if (brokenStrategyDayInYear.is360()) {

                        numberOfPeriods = BigDecimal.valueOf((double) days / brokenStrategyDayInYear.getValue());
                    } else {
                         int numberOfYear = LocalDate.now().lengthOfYear();
                        numberOfPeriods = BigDecimal.valueOf((double) days / numberOfYear);
...
//                                .add(BigDecimal.valueOf((double) daysLeftAfterMonths / daysInPeriodAfterMonths));
    ...
    private BigDecimal calculateDaysPeriodiclastBrokenBetweenDates(LocalDate periodStartDate, LocalDate periodEndDate, int periodNumber, DaysInMonthType daysInMonthType, LocalDate startDate, LocalDate endDate) {
        ...
        switch (this.repaymentPeriodFrequencyType) {
            ...
            case MONTHS:
                ...
                final int days =numberOfDaysofDaysBetweenTwoDates(startDate,endDate);
                ...
                if (repaymentPeriodFrequencyType.isMonthly()) {
                    ...
                    if (brokenStrategyDayInYear.is365()) {
                        ...
                        int numberOfDays = LocalDate.now().lengthOfYear();
                        numberOfPeriods = BigDecimal.valueOf((double) days / numberOfDays);
//                        numberOfPeriods = numberOfPeriods.add(BigDecimal.valueOf(numberOfMonths))
//                                .add(BigDecimal.valueOf((double) daysLeftAfterMonths / daysInPeriodAfterMonths));
                    }
                }
    ...
    private int numberOfDaysofDaysBetweenTwoDates( LocalDate startDate,LocalDate endDate) {
        int diff = 0;

        //int numberOfMonths = Math.toIntExact(ChronoUnit.MONTHS.between(startDate, endDate));

        LocalDate monthStartDate = endDate.minusMonths(1);

        int numberOfDaysExpectedMonth = Math.toIntExact(ChronoUnit.DAYS.between(monthStartDate, endDate));

        int numberOfDaysActualMonth = Math.toIntExact(ChronoUnit.DAYS.between(startDate, endDate));
        if(numberOfDaysActualMonth > 30){

         return  diff = numberOfDaysActualMonth - numberOfDaysExpectedMonth;
        }
        else {
            return diff;
        }
    ...
    private BigDecimal firstBrokenInterest(PaymentPeriodsInOneYearCalculator calculator, MathContext mc, DaysInMonthType daysInMonthType, DaysInYearType daysInYearType, LocalDate periodStartDate, LocalDate periodEndDate, int periodNumber, Money outstandingBalance, Money principaltobeScheduled) {
        return firstBrokenPeriodicInterestRate(calculator, mc, daysInMonthType, daysInYearType, periodStartDate, periodEndDate,false,periodNumber, outstandingBalance, principaltobeScheduled);


    }

    private BigDecimal firstBrokenPeriodicInterestRate(PaymentPeriodsInOneYearCalculator calculator, MathContext mc, DaysInMonthType daysInMonthType, DaysInYearType daysInYearType, LocalDate periodStartDate, LocalDate periodEndDate, boolean isForPMT, int periodNumber, Money outstandingBalance, Money principaltobeScheduled) {
        ...
        if (isForPMT) {
            ...
            loanTermFrequencyBigDecimal = calculateFirstBrokenLoanTermFrequency(periodStartDate, periodEndDate, periodNumber, daysInMonthType);
        }
        final BigDecimal firstBroken = this.annualNominalInterestRate.divide(divisor, mc).multiply(loanTermFrequencyBigDecimal);
...
//                        .multiply(loanTermFrequencyBigDecimal);
    ...
    private BigDecimal calculateFirstBrokenLoanTermFrequency(LocalDate periodStartDate, LocalDate periodEndDate, int periodNumber, DaysInMonthType daysInMonthType) {
        ...
        if ( this.isInterestChargedFromDateSameAsDisbursalDateEnabled && interestMethod.isDecliningBalnce() ) {
            ...
            loanTermFrequencyBigDecimal = calculateDaysFirstBrokenBetweenDates(periodStartDate, periodEndDate,periodNumber,daysInMonthType);

        }

        else if(this.interestCalculationPeriodMethod.isSameAsRepaymentPeriod())
        {
            loanTermFrequencyBigDecimal = calculateDaysPeriodicFirstBrokenBetweenDates(periodStartDate, periodEndDate,periodNumber,daysInMonthType);
    ...
    private BigDecimal calculateDaysPeriodicFirstBrokenBetweenDates(LocalDate startDate, LocalDate endDate, int periodNumber, DaysInMonthType daysInMonthType) {
...
//                                .add(BigDecimal.valueOf((double) daysLeftAfterMonths / daysInPeriodAfterMonths));
    ...
    private BigDecimal calculateDaysFirstBrokenBetweenDates(LocalDate startDate, LocalDate endDate, int periodNumber, DaysInMonthType daysInMonthType) {
...
//
//
//                    int numberofdaysinmonth = 365;
//
//                    numberOfPeriods = BigDecimal.valueOf((double) daysLeftAfterMonths / numberofdaysinmonth);
//                }
//
//                else{
//                    numberOfPeriods = numberOfPeriods.add(BigDecimal.valueOf(numberOfMonths))
//                            .add(BigDecimal.valueOf((double) daysLeftAfterMonths / daysInPeriodAfterMonths));}
    ...
    private Money calculateDecliningInterestDueForInstallmentAfterApplyingGrace(final PaymentPeriodsInOneYearCalculator calculator,
                                                                                ...
                                                                                final int periodNumber, LocalDate periodStartDate, LocalDate periodEndDate, final Money principaltobeScheduled,final boolean isLastDueDate,final LoanApplicationTerms loanApplicationTerms) {
        ...
        Money interest = calculateDecliningInterestDueForInstallmentBeforeApplyingGrace(calculator, mc, outstandingBalance, periodStartDate,
                periodEndDate, periodNumber,principaltobeScheduled,isLastDueDate,loanApplicationTerms);
    ...
    private Money calculateTotalDueForEqualInstallmentRepaymentPeriod(final BigDecimal periodicInterestRate, final Money balance,
        ...
        //BigDecimal.valueOf(paymentPerRepaymentPeriod).setScale(Integer.valueOf(0),this.loanProduct.getRoundingMode());
        // return Money.of(balance.getCurrency(), BigDecimal.valueOf(paymentPerRepaymentPeriod));
//        double totalPmtForThisInstallment = RoundingLogicCalculation.roundingLogicForEmiAmount(paymentPerRepaymentPeriod, this.getLoanProduct());

        return Money.emiRound(balance.getCurrency(),BigDecimal.valueOf(Objects.nonNull(this.getLoanProduct().getEmiDecimalRegex()) ? RoundingLogicCalculation.decimalRoundingRegex(paymentPerRepaymentPeriod,this.getLoanProduct().getEmiDecimalRegex()):paymentPerRepaymentPeriod),
                this.getCurrency().getDigitsAfterDecimal(),RoundingMode.valueOf(this.getLoanProduct().getEmiroundingMode()),this.getLoanProduct().getEmiMultiples());

//        return Money.roundingOff(balance.getCurrency(), BigDecimal.valueOf(paymentPerRepaymentPeriod),this.getLoanProduct().getRoundingMode());
    }
    ...
    public LoanProductRelatedDetail toLoanProductRelatedDetail() {
        ...
        return LoanProductRelatedDetail.createFrom(currency, this.principal.getAmount(), this.interestRatePerPeriod,
                ...
                this.interestRecalculationEnabled, this.isEqualAmortization,this.brokenStrategy.getValue(),this.brokenStrategyDayInYear.getValue(),this.brokenStrategyDaysInMonth.getValue());
    }
