 ...
 * under the License.
 */
package org.vcpl.lms.portfolio.charge.api;
...
@Tag(name = "Charges", description = "Its typical for MFIs to add extra costs for their financial products. These are typically Fees or Penalties.\n"
        + "\n" + "A Charge on LMS platform is what we use to model both Fees and Penalties.\n" + "\n"
...
public class ChargesApiResource {
    ...
    private final Set<String> chargesDataParameters = new HashSet<>(Arrays.asList("id", "name", "amount", "currency", "penalty", "active",
            ...
            "clientChargeTimeTypeOptions","enableGstCharges","gstOption","chargeDecimal","chargeRoundingMode","chargeDecimalRegex","gstDecimal","gstRoundingMode","gstDecimalRegex","gstSlabLimitValue","isGstSlabEnabled","gstSlabLimitApplyFor","gstSlabLimitOperator","isGstSlabEnabledSelected","gstSlabLimitApplyForOption","gstSlabLimitOperatorOption"));
    ...
    +"Mandatory Fields: chargeAppliesTo,name,currencyCode,chargeTimeType,chargeCalculationType,amount,active,chargeType,feesType,minAmount,maxAmount,chargePaymentMode")
