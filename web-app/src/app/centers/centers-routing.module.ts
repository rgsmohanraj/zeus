...

    {
      ...
      children: [
        ...
        },
        {
          ...
          data: { title: extract('Create Center'), breadcrumb: 'Create',routePermission:'CREATE_CENTER' },
          resolve: {
        ...
        },
        {
          ...
          children: [
            ...
            },
            {
              ...
              data: { title: extract('Edit Center'), breadcrumb: 'Edit', routeParamBreadcrumb: 'Edit',routePermission:'UPDATE_CENTER' },
              resolve: {
