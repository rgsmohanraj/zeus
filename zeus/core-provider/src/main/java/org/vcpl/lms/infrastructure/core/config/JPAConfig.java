...
import org.vcpl.lms.infrastructure.core.domain.AuditorAwareImpl;
import org.vcpl.lms.infrastructure.core.persistence.DatabaseSelectingPersistenceUnitPostProcessor;
import org.vcpl.lms.infrastructure.core.persistence.ExtendedJpaTransactionManager;
import org.vcpl.lms.infrastructure.core.service.RoutingDataSource;
...
@Configuration
@EnableJpaAuditing
@EnableJpaRepositories(basePackages = "org.vcpl.lms.**.domain")
...
public class JPAConfig extends JpaBaseConfiguration {
    ...
    public LocalContainerEntityManagerFactoryBean entityManagerFactory(EntityManagerFactoryBuilder factoryBuilder) {
        ...
        return factoryBuilder.dataSource(getDataSource()).properties(vendorProperties).persistenceUnit("jpa-pu")
                .packages("org.vcpl.lms").jta(false).build();
    }
