...
-- Dumping structure for table fineract_default.m_loan_product_class
...
-- Dumping data for table fineract_default.m_loan_product_class: ~0 rows (approximately)
/*!40000 ALTER TABLE `m_loan_product_class` DISABLE KEYS */;
/*!40000 ALTER TABLE `m_loan_product_class` ENABLE KEYS */;

-- Dumping structure for table fineract_default.m_loan_product_type
...
-- Dumping data for table fineract_default.m_loan_product_type: ~0 rows (approximately)
