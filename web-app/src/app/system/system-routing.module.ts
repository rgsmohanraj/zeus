...
const routes: Routes = [
  Route.withShell([
    {
      path: 'system',
      data: { title: extract('System'), breadcrumb: 'System',routePermission:'READ_SYSTEM' },
      children: [
        {
          path: '',
        ...
        {
          path: 'codes',
          data: { title: extract('View Codes'), breadcrumb: 'Codes',routePermission:'READ_CODE' },
          children: [
            {
              path: '',
            ...
            },
            {
              ...
              data: { title: extract('Create Code'), breadcrumb: 'Create',routePermission:'CREATE_CODE' }
            },
            {
              path: ':id',
              ...
              children: [
                ...
                },
                {
                  ...
                  data: { title: extract('Edit Code'), breadcrumb: 'Edit', routeParamBreadcrumb: false,routePermission:'UPDATE_CODE' },
                  resolve: {
                    code: CodeResolver
                  }
                }
        ...
        },
        {
          ...
          data: { title: extract('Entity to Entity Mapping'), breadcrumb: 'Entity to Entity Mapping',routePermission:'CREATE_ENTITYMAPPING' },
          resolve: {
        ...
        {
          path: 'data-tables',
          data: { title: extract('Manage Data Tables'), breadcrumb: 'Manage Data Tables',routePermission:'READ_DATATABLE' },
          children: [
            {
              path: '',
            ...
            },
            {
              ...
              data: { title: extract('Create Data Table'), breadcrumb: 'Create',routePermission:'CREATE_DATATABLE' },
              resolve: {
            ...
            },
            {
              ...
              children: [
                ...
                },
                {
                  ...
                  data: { title: extract('Edit Data table'), breadcrumb: 'Edit', routeParamBreadcrumb: false,routePermission:'UPDATE_DATATABLE' },
                  resolve: {
                    dataTable: DataTableResolver,
                    columnCodes: CodesResolver
                  }
        ...
        {
          path: 'hooks',
          data: { title: extract('Manage Hooks'), breadcrumb: 'Manage Hooks',routePermission:'READ_HOOK'},
          children: [
            {
              path: '',
            ...
            },
            {
              ...
              data: { title: extract('Create Hook'), breadcrumb: 'Create',routePermission:'CREATE_HOOK' },
              resolve: {
            ...
            },
            {
              ...
              children: [
                ...
                },
                {
                  ...
                  data: { title: extract('Edit Hook'), breadcrumb: 'Edit', routeParamBreadcrumb: false,routePermission:'UPDATE_HOOK' },
                  resolve: {
                    hooksTemplate: HooksTemplateResolver,
                    hook: HookResolver
                  }
        ...
        },
        {
          ...
          data: { title: extract('Roles and Permissions'), breadcrumb: 'Roles and Permissions',routePermission:'PERMISSIONS_ROLE' },
          children: [
            {
              path: '',
            ...
            },
            {
              ...
              data: { title: extract('Add Role'), breadcrumb: 'Add',routePermission:'CREATE_ROLE' }
            },
            {
              path: ':id',
              data: { title: extract('View Role'), routeParamBreadcrumb: 'id',routePermission:'READ_ROLE'},
              ...
              children: [
                ...
                },
                {
                  ...
                  data: { title: extract('Edit Role'), breadcrumb: 'Edit', routeParamBreadcrumb: false,routePermission:'UPDATE_ROLE' },
                  resolve: {
        ...
        },
        {
          ...
          children: [
            ...
            },
            {
              ...
              data: { title: extract('Create Survey'), breadcrumb: 'Create',routePermission:'REGISTER_SURVEY'},
            },
            {
              path: ':id',
        ...
        {
          path: 'scheduler-jobs',
          data: { title: extract('Manage Scheduler Jobs'), breadcrumb: 'Manage Scheduler Jobs',routePermission:'READ_SCHEDULER' },
          children: [
            {
              path: '',
            ...
            },
            {
              ...
              children: [
                ...
                },
                {
                  ...
                  data: { title: extract('Edit Scheduler Job'), routeParamBreadcrumb: false, breadcrumb: 'Edit',routePermission:'UPDATE_SCHEDULER' },
                  resolve: {
        ...
        },
        {
          ...
          data: { title: extract('Configurations'), breadcrumb: 'Configurations',routePermission:'READ_CONFIGURATION' }
        },
        {
          ...
          children: [
            ...
            },
            {
              ...
              data: { title: extract('Create Account Number Preference'), breadcrumb: 'Create',routePermission:'CREATE_ACCOUNTNUMBERFORMAT' },
              resolve: {
            ...
            },
            {
              ...
              children: [
                ...
                },
                {
                  ...
                  data: { title: extract('Edit Account Number Preference'), breadcrumb: 'Edit', routeParamBreadcrumb: false,routePermission:'UPDATE_ACCOUNTNUMBERFORMAT' },
                  resolve: {
                    accountNumberPreference: AccountNumberPreferenceResolver,
                    accountNumberPreferencesTemplate: AccountNumberPreferencesTemplateResolver
                  }
        ...
        {
          path: 'reports',
          data: { title: extract('Manage Reports'), breadcrumb: 'Manage Reports',routePermission:'READ_REPORT' },
          children: [
            {
              path: '',
            ...
            },
            {
              ...
              data: { title: extract('Create Report'), breadcrumb: 'Create',routePermission:'CREATE_REPORT'},
              resolve: {
            ...
            },
            {
              ...
              children: [
                ...
                },
                {
                  ...
                  data: { title: extract('Edit Report'), routeParamBreadcrumb: false, breadcrumb: 'Edit',routePermission:'UPDATE_REPORT' },
                  resolve: {
                    report: ReportResolver,
                    reportTemplate: ReportTemplateResolver
                  }
        ...
        {
          path: 'audit-trails',
          data: { title: extract('Audit Trails'), breadcrumb: 'Audit Trails',routePermission:'READ_AUDIT' },
          children: [
            {
              path: '',
