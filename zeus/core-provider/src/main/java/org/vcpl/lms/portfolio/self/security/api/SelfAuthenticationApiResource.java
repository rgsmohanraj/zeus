...
public class SelfAuthenticationApiResource {
    ...
    @ApiResponses({
            @ApiResponse(responseCode = "200", description = "OK", content = @Content(schema = @Schema(implementation = org.vcpl.lms.portfolio.self.security.api.SelfAuthenticationApiResourceSwagger.PostSelfAuthenticationResponse.class))) })
