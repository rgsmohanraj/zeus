...
CREATE TABLE `m_product_loan` (
  ...
  `broken_interest_calculation_Period` varchar(10) DEFAULT NULL,
          ...
          `coborrower` bit(1) DEFAULT NULL,
          `eod_balance` bit(1) DEFAULT NULL,
          `secured_loan` bit(1) DEFAULT NULL,
          `non_equated_installment` bit(1) DEFAULT NULL,
          `advance_emi` bit(1) DEFAULT NULL,
          `term_based_on_loancycle` bit(1) DEFAULT NULL,
          `is_net_off_applied` bit(1) DEFAULT NULL,
          ...
          `self_interest_rate` int(10) DEFAULT NULL,
          ...
          `partner_interest_rate` int(10) DEFAULT NULL,
          `select_partner` varchar(20) DEFAULT NULL,
...
--
-- Table structure for table `m_loan_product_class`
--

DROP TABLE IF EXISTS `m_loan_product_class`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = UTF8MB4 */;
CREATE TABLE `m_loan_product_class` (
  `id` bigint(20) NOT NULL AUTO_INCREMENT,
       `name` varchar(255) DEFAULT NULL,
       `description` varchar(100) DEFAULT NULL,
       PRIMARY KEY (`id`),
       UNIQUE KEY `loan_product_class_name_org` (`name`)
     ) ENGINE=InnoDB AUTO_INCREMENT=3 DEFAULT CHARSET=utf8mb4;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `m_loan_product_class`
--

LOCK TABLES `m_loan_product_class` WRITE;
/*!40000 ALTER TABLE `m_loan_product_class` DISABLE KEYS */;
/*!40000 ALTER TABLE `m_loan_product_class` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `m_loan_product_type`
--

DROP TABLE IF EXISTS `m_loan_product_type`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = UTF8MB4 */;
CREATE TABLE `m_loan_product_type` (
  `id` bigint(20) NOT NULL AUTO_INCREMENT,
    `class_id` bigint(20) DEFAULT NULL,
    `name` varchar(255) DEFAULT NULL,
    `description` varchar(100) DEFAULT NULL,
    PRIMARY KEY (`id`),
    UNIQUE KEY `loan_product_type_name_org` (`name`),
    KEY `class_id` (`class_id`),
    CONSTRAINT `m_loan_product_type_ibfk_1` FOREIGN KEY (`class_id`) REFERENCES `m_loan_product_class` (`id`)
  ) ENGINE=InnoDB AUTO_INCREMENT=7 DEFAULT CHARSET=utf8mb4;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `m_loan_product_type`
--

LOCK TABLES `m_loan_product_class` WRITE;
/*!40000 ALTER TABLE `m_loan_product_type` DISABLE KEYS */;
/*!40000 ALTER TABLE `m_loan_product_type` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `m_product_loan_age_limits_config`
--

DROP TABLE IF EXISTS `m_product_loan_age_limits_config`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = UTF8MB4 */;
CREATE TABLE `m_product_loan_age_limits_config` (
 `id` bigint(20) NOT NULL AUTO_INCREMENT,
...
--
-- Dumping data for table `m_product_loan_age_limits_config`
--

LOCK TABLES `m_product_loan_age_limits_config` WRITE;
...
--
-- Table structure for table `m_colending_charge`
--

DROP TABLE IF EXISTS `m_colending_charge`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = UTF8MB4 */;
CREATE TABLE `m_colending_charge` (
  `id` bigint(20) NOT NULL AUTO_INCREMENT,
   `product_loan_id` bigint(20) DEFAULT NULL,
...
--
-- Dumping data for table `m_colending_charge`
--

LOCK TABLES `m_colending_charge` WRITE;
/*!40000 ALTER TABLE `m_colending_charge` DISABLE KEYS */;
/*!40000 ALTER TABLE `m_colending_charge` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `m_colending_accepted_dates`
--

DROP TABLE IF EXISTS `m_colending_accepted_dates`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = UTF8MB4 */;
CREATE TABLE `m_colending_accepted_dates` (
  `id` bigint(20) NOT NULL AUTO_INCREMENT,
    `product_loan_id` bigint(20) DEFAULT NULL,
...
--
-- Dumping data for table `m_colending_accepted_dates`
--

LOCK TABLES `m_colending_accepted_dates` WRITE;
