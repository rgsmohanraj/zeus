...
import { ViewBulkChargesComponent } from './bulk-import/view-bulk-import/view-bulk-charges/view-bulk-charges.component';
...
import { OfficeViewResolver } from './offices/common-resolvers/office-view.resolver';
...
import { BulkViewResolver } from './bulk-import/bulk-view.resolver';
...
const routes: Routes = [
  Route.withShell([
    {
      path: 'organization',
      data: { title: extract('Organization'), breadcrumb: 'Organization',routePermission:'READ_ORGANIZATION' },
      children: [
        {
          path: '',
        ...
        },
        {
          ...
          children: [
            ...
            {
              path: 'create',
              data: { title: extract('Create Provisioning Criteria'), breadcrumb: 'Create Provisioning Criteria',routePermission:'CREATE_PROVISIONCRITERIA' },
            ...
            },
            {
              ...
              children: [
                ...
                },
                {
                  ...
                  data: { title: extract('Edit Provisioning Criteria'), breadcrumb: 'Edit', routeParamBreadcrumb: false,routePermission:'UPDATE_PROVISIONCRITERIA' },
                  resolve: {
        ...
        {
          path: 'offices',
          data: { title: extract('Manage Office'), breadcrumb: 'Manage Office',routePermission:'READ_OFFICE' },
          children: [
            {
              path: '',
              component: OfficesComponent,
              resolve: {
              offices: OfficeViewResolver
              }
            },
            {
              path: 'create',
              component: CreateOfficeComponent,
              data: { title: extract('Create Office'), breadcrumb: 'Create Office',routePermission:'CREATE_OFFICE' },
              resolve: {
                officeTemplate: OfficesResolver,
              }
            },
            {

              path: ':id',
              data: { title: extract('View Office'), routeResolveBreadcrumb: ['Partner', 'name'] },
        ...
        {
          path: 'employees',
          data: { title: extract('Relationship Managers'), breadcrumb: 'Relationship Managers',routePermission:'READ_STAFF' },
          children: [
            {
              path: '',
            ...
            },
            {
              ...
              data: { title: extract('Create Employee'), breadcrumb: 'Create Employee',routePermission:'CREATE_STAFF' },
              resolve: {
            ...
            },
            {
              ...
              children: [
                ...
                },
                {
                  ...
                  data: { title: extract('Edit Employee'), breadcrumb: 'Edit', routeParamBreadcrumb: false,routePermission:'UPDATE_STAFF' },
                  resolve: {
        ...
        {
          path: 'currencies',
          data: { title: extract('Currency Configuration'), breadcrumb: 'Currency Configuration',routePermission:'READ_CURRENCY' },
          resolve: {
          ...
          children: [
            ...
            {
              path: 'manage',
              data: { title: extract('Manage Currencies'), breadcrumb: 'Manage Currencies',routePermission:'READ_CURRENCY' },
        ...
        },
        {
          ...
          children: [
            ...
            {
              path: 'create',
              data: { title: extract('Create SMS Campaign'), breadcrumb: 'Create Campaign',routePermission:'CREATE_SMSCAMPAIGN' },
            ...
            },
            {
              ...
              children: [
                ...
                },
                {
                  ...
                  data: { title: extract('Edit SMS Campaign'), breadcrumb: 'Edit', routeResolveBreadcrumb: false,routePermission:'UPDATE_SMSCAMPAIGN'},
                  resolve: {
                    smsCampaignTemplate: SmsCampaignTemplateResolver,
                  }
                }
        ...
        },
        {
          ...
          children: [
            ...
            },
            {
              ...
              data: { title: extract('Create Adhoc Query'), breadcrumb: 'Create',routePermission:'CREATE_ADHOC' },
              resolve: {
            ...
            },
            {
              ...
              children: [
                ...
                },
                {
                  ...
                  data: { title: extract('Edit Adhoc Query'), breadcrumb: 'Edit', routeParamBreadcrumb: false ,routePermission:'UPDATE_ADHOC'},
                  resolve: {
        ...
        },
        {
          ...
          children: [
            ...
            },
            {
              ...
              data: { title: extract('Create Teller'), breadcrumb: 'Create',routePermission:'CREATE_TELLER' },
              resolve: {
                offices: OfficesResolver
              }
            },
            {
              ...
              children: [
                ...
                },
                {
                  ...
                  data: { title: extract('Edit Teller'), breadcrumb: 'Edit', routeParamBreadcrumb: false,routePermission:'UPDATE_TELLER' },
                  resolve: {
                    teller: TellerResolver,
                    offices: OfficesResolver
                  }
        ...
        },
        {
          ...
          children: [
            ...
            },
            {
              ...
              data: { title: extract('Create Payment Type'), breadcrumb: 'Create Payment Type',routePermission:'CREATE_PAYMENTTYPE'}
            },
            {
              path: ':id',
              ...
              children: [
                {
                  ...
                  data: { title: extract('Edit Payment Type'), breadcrumb: 'Edit', routeParamBreadcrumb: false ,routePermission:'UPDATE_PAYMENTTYPE'},
                  resolve: {
        ...
        },
        {
          ...
          data: { title: extract('Working Days'), breadcrumb: 'Working Days' ,routePermission:'READ_WORKINGDAYS'},
          resolve: {
        ...
        },
        {
          ...
          data: { title: extract('Manage Funds Days'), breadcrumb: 'Manage Funds',routePermission:'READ_FUND' },
          resolve: {
        ...
        {
          path: 'bulk-import',
          data: { title: extract('Bulk Import'), breadcrumb: 'Bulk Import',routePermission:'VIEW_BULK_IMPORT' },
          children: [
            {
              path: '',
            ...
            },
            {
                ...
                component: ViewBulkChargesComponent,
                data: { title: extract('View Bulk Charge Import'), routeParamBreadcrumb: 'import-chargeCollection',routePermission: 'BULK_COLLECTION' },
                resolve: {
                  offices: OfficesResolver,
                   officeData: BulkViewResolver
                }
              },
            {
              path: ':import-name',
              component: ViewBulkImportComponent,
              data: { title: extract('View Bulk Import'), routeParamBreadcrumb: 'import-name',routePermission: {"Loan Accounts": "BULK_LOAN_CREATION","Uploaded File Status Download": "VIEW_BULK_IMPORT","chargeCollection":"BULK_COLLECTION"}},
              resolve: {
                offices: OfficesResolver,
        ...
        {
          path: 'holidays',
          data: { title: extract('Manage Holidays'), breadcrumb: 'Manage Holidays',routePermission:'READ_HOLIDAY' },
          children: [
            {
              path: '',
            ...
            },
            {
              ...
              data: { title: extract('Create Holiday'), breadcrumb: 'Create',routePermission:'CREATE_HOLIDAY' },
              resolve: {
                offices: OfficesResolver,
            ...
            },
            {
              ...
              children: [
                ...
                },
                {
                  ...
                  data: { title: extract('Edit Holidays'), breadcrumb: 'Edit', routeParamBreadcrumb: false,routePermission:'UPDATE_HOLIDAY' },
                  resolve: {
