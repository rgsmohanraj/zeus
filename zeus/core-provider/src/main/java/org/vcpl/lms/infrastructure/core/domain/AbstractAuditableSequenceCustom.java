...
/**
 *  During mulitple data insertion the insertion order not get maintained, because id column generation type is Idenitical
 */
@MappedSuperclass
public abstract class AbstractAuditableSequenceCustom extends AbstractPersistableSequenceCustom implements Auditable<AppUser, Long, Instant> {
