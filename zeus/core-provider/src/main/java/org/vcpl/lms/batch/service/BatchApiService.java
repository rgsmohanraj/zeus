...
public interface BatchApiService {
    ...
    /**
     * Returns a list of {@link org.vcpl.lms.batch.domain.BatchResponse}s by getting the appropriate
     * CommandStrategy for every {@link org.vcpl.lms.batch.domain.BatchRequest}. It will be used when the Query
