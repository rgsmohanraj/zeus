...
@Service
@CommandType(entity = "PARTNER", action = "CREATE")
public class CreatePartnerCommandHandler implements NewCommandSourceHandler {
    ...
    @Autowired
    public CreatePartnerCommandHandler(final PartnerWritePlatformService writePlatformService) {
    ...
    public CommandProcessingResult processCommand(final JsonCommand command) {
        ...
        return this.writePlatformService.createPartner(command);
    }
}
