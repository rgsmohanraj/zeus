...
public final class ClientDataValidator {
    ...
    public void validateForCreate(final String json) {
        ...
        if (this.fromApiJsonHelper.parameterExists(ClientApiConstants.accountNoParamName, element)) {
            ...
            final String ifscCode = this.fromApiJsonHelper.extractStringNamed(ClientApiConstants.ifscCodeParamName, element);
            baseDataValidator.reset().parameter(ClientApiConstants.ifscCodeParamName).value(ifscCode).notBlank().notNull()
                    .equalTo(11).isAlphaNumeric();

        if (this.fromApiJsonHelper.parameterExists(ClientApiConstants.micrCodeParamName, element)) {
            final String micrCode = this.fromApiJsonHelper.extractStringNamed(ClientApiConstants.micrCodeParamName, element);
            baseDataValidator.reset().parameter(ClientApiConstants.micrCodeParamName).value(micrCode).ignoreIfNull()
                    .equalTo(9).isNumeric();
        }

        if (this.fromApiJsonHelper.parameterExists(ClientApiConstants.swiftCodeParamName, element)) {
            final String swiftCode = this.fromApiJsonHelper.extractStringNamed(ClientApiConstants.swiftCodeParamName, element);
            baseDataValidator.reset().parameter(ClientApiConstants.swiftCodeParamName).value(swiftCode).ignoreIfNull()
                    .equalTo(11).isAlphaNumeric();
        }
        ...
        if (this.fromApiJsonHelper.parameterExists(ClientApiConstants.emailAddressParamName, element)) {
            ...
            baseDataValidator.reset().parameter(ClientApiConstants.emailAddressParamName).value(emailAddress).ignoreIfNull().isEmailAddress();
        }

            final Integer age = this.fromApiJsonHelper.extractIntegerNamed(ClientApiConstants.ageParamName, element, Locale.getDefault());
            baseDataValidator.reset().parameter(ClientApiConstants.ageParamName).value(age).notNull()
                    .equalTo(2).isNumeric();
        ...
        LocalDate submittedOnDate = null;
            ...
            final Integer stateId = this.fromApiJsonHelper.extractIntegerSansLocaleNamed(ClientApiConstants.stateIdParamName, element);
            baseDataValidator.reset().parameter(ClientApiConstants.stateIdParamName).value(stateId).integerGreaterThanZero().notNull().notBlank();

            final String city = this.fromApiJsonHelper.extractStringNamed(ClientApiConstants.cityParamName, element);
            baseDataValidator.reset().parameter(ClientApiConstants.cityParamName).value(city).notExceedingLengthOf(50).notBlank().notNull().isAlphaWithSpace();

//        if (this.fromApiJsonHelper.parameterExists(ClientApiConstants.repaymentModeIdParamName, element)) {
//            final Integer repaymentModeId = this.fromApiJsonHelper.extractIntegerSansLocaleNamed(ClientApiConstants.repaymentModeIdParamName, element);
//            baseDataValidator.reset().parameter(ClientApiConstants.repaymentModeIdParamName).value(repaymentModeId).integerGreaterThanZero();
//        }

        /*if (this.fromApiJsonHelper.parameterExists(ClientApiConstants.transactionTypePreferenceIdParamName, element)) {
            final Integer transactionTypePreferenceId = this.fromApiJsonHelper.extractIntegerSansLocaleNamed(ClientApiConstants.transactionTypePreferenceIdParamName, element);
            baseDataValidator.reset().parameter(ClientApiConstants.transactionTypePreferenceIdParamName).value(transactionTypePreferenceId).integerGreaterThanZero();
        }*/
        ...
        if (this.fromApiJsonHelper.parameterExists(ClientApiConstants.datatables, element)) {
            ...
            final String benificieryName = this.fromApiJsonHelper.extractStringNamed(ClientApiConstants.beneficiaryNameParamName, element);
            baseDataValidator.reset().parameter(ClientApiConstants.beneficiaryNameParamName).value(benificieryName).notNull().isAlphaNumericWithSpace()
                    .notExceedingLengthOf(40);

        final String branch = this.fromApiJsonHelper.extractStringNamed(ClientApiConstants.branchParamName, element);
        baseDataValidator.reset().parameter(ClientApiConstants.branchParamName).value(branch).ignoreIfNull().isAlphaWithSpace()
                .notExceedingLengthOf(40);


            final String beneficiaryAccountNumber = this.fromApiJsonHelper.extractStringNamed(ClientApiConstants.beneficiaryAccountNumberParamName,element);
            baseDataValidator.reset().parameter(ClientApiConstants.beneficiaryAccountNumberParamName).value(beneficiaryAccountNumber)
                    .notNull().notBlank().notExceedingLengthOf(40).isAlphaNumeric();
        ...
        if (this.fromApiJsonHelper.parameterExists(ClientApiConstants.panParamName, element)) {
            ...
            baseDataValidator.reset().parameter(ClientApiConstants.panParamName).value(pan).ignoreIfNull()
                    .equalTo(10).isAlphaNumeric();
        }

            final String aadhaar = this.fromApiJsonHelper.extractStringNamed(ClientApiConstants.aadhaarParamName, element);
            baseDataValidator.reset().parameter(ClientApiConstants.aadhaarParamName).value(aadhaar).ignoreIfNull().validateAadhaar();

            final Integer accountTypeId = this.fromApiJsonHelper.extractIntegerSansLocaleNamed(ClientApiConstants.accountTypeIdParamName, element);
            baseDataValidator.reset().parameter(ClientApiConstants.accountTypeIdParamName).value(accountTypeId).integerGreaterThanZero().notNull();

        if (this.fromApiJsonHelper.parameterExists(ClientApiConstants.voterIdParamName, element)) {
            final String voterId = this.fromApiJsonHelper.extractStringNamed(ClientApiConstants.voterIdParamName, element);
            baseDataValidator.reset().parameter(ClientApiConstants.voterIdParamName).value(voterId).ignoreIfNull()
                    .notExceedingLengthOf(20).isAlphaNumeric();
        }

        if (this.fromApiJsonHelper.parameterExists(ClientApiConstants.passportNumberParamName, element)) {
            final String passportNumber = this.fromApiJsonHelper.extractStringNamed(ClientApiConstants.passportNumberParamName, element);
            baseDataValidator.reset().parameter(ClientApiConstants.passportNumberParamName).value(passportNumber).ignoreIfNull()
                    .notExceedingLengthOf(12).isAlphaNumeric();
        }

        if (this.fromApiJsonHelper.parameterExists(ClientApiConstants.drivingLicenseParamName, element)) {
            final String drivingLicense = this.fromApiJsonHelper.extractStringNamed(ClientApiConstants.drivingLicenseParamName, element);
            baseDataValidator.reset().parameter(ClientApiConstants.drivingLicenseParamName).value(drivingLicense).ignoreIfNull()
                    .notExceedingLengthOf(18).isAlphaNumeric();
        }

            final String address = this.fromApiJsonHelper.extractStringNamed(ClientApiConstants.addressParamName, element);
            baseDataValidator.reset().parameter(ClientApiConstants.addressParamName).value(address).notBlank().notNull()
                    .notExceedingLengthOf(250);

            final Long pinCode = this.fromApiJsonHelper.extractLongNamed(ClientApiConstants.pincodeParamName, element);
            baseDataValidator.reset().parameter(ClientApiConstants.pincodeParamName).value(pinCode).notNull().notBlank()
                    .equalTo(6).isNumeric();

        if (this.fromApiJsonHelper.parameterExists(ClientApiConstants.rationCardNumberParamName, element)) {
            final String rationCardNumber = this.fromApiJsonHelper.extractStringNamed(ClientApiConstants.rationCardNumberParamName, element);
            baseDataValidator.reset().parameter(ClientApiConstants.rationCardNumberParamName).value(rationCardNumber).ignoreIfNull()
    ...
    public void validateForUpdate(final String json) {
        ...
        if (this.fromApiJsonHelper.parameterExists(ClientApiConstants.beneficiaryAccountNumberParamName, element)) {
            atLeastOneParameterPassedForUpdate = true;
            final String beneficiaryAccountNumber = this.fromApiJsonHelper.extractStringNamed(ClientApiConstants.beneficiaryAccountNumberParamName,element);
            baseDataValidator.reset().parameter(ClientApiConstants.beneficiaryAccountNumberParamName).value(beneficiaryAccountNumber).notBlank().notNull()
                    .notExceedingLengthOf(40).isAlphaNumeric();
        }

        if (this.fromApiJsonHelper.parameterExists(ClientApiConstants.branchParamName, element)) {
            atLeastOneParameterPassedForUpdate = true;
            final String branch = this.fromApiJsonHelper.extractStringNamed(ClientApiConstants.branchParamName, element);
            baseDataValidator.reset().parameter(ClientApiConstants.branchParamName).value(branch).ignoreIfNull().isAlphaWithSpace()
                    .notExceedingLengthOf(40);
        ...
        if (this.fromApiJsonHelper.parameterExists(ClientApiConstants.mobileNoParamName, element)) {
            atLeastOneParameterPassedForUpdate = true;
            final String mobileNo = this.fromApiJsonHelper.extractStringNamed(ClientApiConstants.mobileNoParamName, element);
            baseDataValidator.reset().parameter(ClientApiConstants.mobileNoParamName).value(mobileNo).equalTo(10).notNull().notBlank().isNumeric();
        }
        ...
        if (this.fromApiJsonHelper.parameterExists(ClientApiConstants.ageParamName, element)) {
            atLeastOneParameterPassedForUpdate = true;
            final Integer age = this.fromApiJsonHelper.extractIntegerNamed(ClientApiConstants.ageParamName, element,Locale.getDefault());
            baseDataValidator.reset().parameter(ClientApiConstants.ageParamName).value(age).equalTo(2).isNumeric();
        }
        ...
        if (this.fromApiJsonHelper.parameterExists(ClientApiConstants.stateIdParamName, element)) {
            atLeastOneParameterPassedForUpdate = true;
            final Integer stateId = this.fromApiJsonHelper.extractIntegerSansLocaleNamed(ClientApiConstants.stateIdParamName, element);
            baseDataValidator.reset().parameter(ClientApiConstants.stateIdParamName).value(stateId).integerGreaterThanZero().notBlank();
        }
        ...
        if (this.fromApiJsonHelper.parameterExists(ClientApiConstants.cityParamName, element)) {
            atLeastOneParameterPassedForUpdate = true;
            final String city = this.fromApiJsonHelper.extractStringNamed(ClientApiConstants.cityParamName, element);
            baseDataValidator.reset().parameter(ClientApiConstants.cityParamName).value(city).notExceedingLengthOf(50).notNull().isAlphaWithSpace();
        }
...
//        }
       ...
       /* if (this.fromApiJsonHelper.parameterExists(ClientApiConstants.transactionTypePreferenceIdParamName, element)) {
        ...
        if (this.fromApiJsonHelper.parameterExists(ClientApiConstants.panParamName, element)) {
            atLeastOneParameterPassedForUpdate = true;
            String pan = this.fromApiJsonHelper.extractStringNamed(ClientApiConstants.panParamName, element);
             baseDataValidator.reset().parameter(ClientApiConstants.panParamName).value(pan)
                    .ignoreIfNull().equalTo(10).isAlphaNumeric();
        }

        if (this.fromApiJsonHelper.parameterExists(ClientApiConstants.aadhaarParamName, element)) {
            atLeastOneParameterPassedForUpdate = true;
            final String aadhaar = this.fromApiJsonHelper.extractStringNamed(ClientApiConstants.aadhaarParamName, element);
            baseDataValidator.reset().parameter(ClientApiConstants.aadhaarParamName).value(aadhaar).ignoreIfNull().equalTo(12)
                    .isAlphaNumeric();
        }

        if (this.fromApiJsonHelper.parameterExists(ClientApiConstants.ifscCodeParamName, element)) {
            atLeastOneParameterPassedForUpdate = true;
            final String ifscCode = this.fromApiJsonHelper.extractStringNamed(ClientApiConstants.ifscCodeParamName, element);
            baseDataValidator.reset().parameter(ClientApiConstants.ifscCodeParamName).value(ifscCode).equalTo(11).isAlphaNumeric().notNull().notBlank();
        }


        if (this.fromApiJsonHelper.parameterExists(ClientApiConstants.micrCodeParamName, element)) {
            atLeastOneParameterPassedForUpdate = true;
            final Long micrCode = this.fromApiJsonHelper.extractLongNamed(ClientApiConstants.micrCodeParamName,element);
            baseDataValidator.reset().parameter(ClientApiConstants.micrCodeParamName).value(micrCode).ignoreIfNull()
                    .equalTo(9).isNumeric();
        }
        ...
        if (this.fromApiJsonHelper.parameterExists(ClientApiConstants.swiftCodeParamName, element)) {
            atLeastOneParameterPassedForUpdate = true;
            final String swiftCode = this.fromApiJsonHelper.extractStringNamed(ClientApiConstants.swiftCodeParamName, element);
            baseDataValidator.reset().parameter(ClientApiConstants.swiftCodeParamName).value(swiftCode).ignoreIfNull().equalTo(11).isAlphaNumeric();
        }
        ...
        if (this.fromApiJsonHelper.parameterExists(ClientApiConstants.voterIdParamName, element)) {
            atLeastOneParameterPassedForUpdate = true;
            final String voterId = this.fromApiJsonHelper.extractStringNamed(ClientApiConstants.voterIdParamName, element);
            baseDataValidator.reset().parameter(ClientApiConstants.voterIdParamName).value(voterId).notExceedingLengthOf(20).ignoreIfNull()
                    .isAlphaNumeric();
        }
        ...
        if (this.fromApiJsonHelper.parameterExists(ClientApiConstants.addressParamName, element)) {
            final String address = this.fromApiJsonHelper.extractStringNamed(ClientApiConstants.addressParamName, element);
            baseDataValidator.reset().parameter(ClientApiConstants.addressParamName).value(address).notNull().notBlank()
                    .notExceedingLengthOf(250);
        }

        if (this.fromApiJsonHelper.parameterExists(ClientApiConstants.pincodeParamName, element)) {
            final Long pincode = this.fromApiJsonHelper.extractLongNamed(ClientApiConstants.pincodeParamName, element);
            baseDataValidator.reset().parameter(ClientApiConstants.pincodeParamName).value(pincode).notNull().notBlank()
                    .equalTo(6).isNumeric();
        }
    ...
    Map<String, Object> getParameterUpdateStatusAndDataValidationErrorsForUpdateOnClientNonPerson(JsonElement element) {
        ...
        if (this.fromApiJsonHelper.parameterExists(ClientApiConstants.accountTypeIdParamName, element)) {
            atLeastOneParameterPassedForUpdate = true;
            final Integer accountTypeId = this.fromApiJsonHelper.extractIntegerSansLocaleNamed(ClientApiConstants.accountTypeIdParamName, element);
            baseDataValidator.reset().parameter(ClientApiConstants.accountTypeIdParamName).value(accountTypeId).integerGreaterThanZero();
        }
    ...
    public void validateForAadhaar(final String aadhaar){
        final List<ApiParameterError> dataValidationErrors = new ArrayList<>();
        final DataValidatorBuilder baseDataValidator = new DataValidatorBuilder(dataValidationErrors)
                .resource(ClientApiConstants.CLIENT_RESOURCE_NAME);
        baseDataValidator.reset().parameter(ClientApiConstants.aadhaarParamName).value(aadhaar).validateAadhaar();
        throwExceptionIfValidationWarningsExist(dataValidationErrors);
    }
