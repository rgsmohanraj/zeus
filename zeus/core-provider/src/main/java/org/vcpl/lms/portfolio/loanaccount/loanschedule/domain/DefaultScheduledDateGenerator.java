...
public class DefaultScheduledDateGenerator implements ScheduledDateGenerator {
    ...
    public LocalDate generateNextRepaymentDate(final LocalDate lastRepaymentDate, final LoanApplicationTerms loanApplicationTerms,
        ...
        if (isFirstRepayment && firstRepaymentPeriodDate != null) {
            ...
            Integer nthDayType = CalendarUtils.getMonthOnDay(currentCalendar.getRecurrence());
            ...
            dueRepaymentPeriodDate = CalendarUtils.adjustDateForDueDate(dueRepaymentPeriodDate, loanApplicationTerms.getSeedDate(),
                    loanApplicationTerms.getRepaymentPeriodFrequencyType(), nthDayType);
            if (currentCalendar != null) {
                ...
                if(dueRepaymentPeriodDate.getMonthValue() !=2 && dueRepaymentPeriodDate.getMonthValue() != 4 && dueRepaymentPeriodDate.getMonthValue()!=6 && dueRepaymentPeriodDate.getMonthValue() != 9 && dueRepaymentPeriodDate.getMonthValue() !=11) {
                    dueRepaymentPeriodDate = CalendarUtils.generateNextDueDateBasedOnDueDate(reccuringString, seedDate, lastRepaymentDate,
                    ...
                    if (lastRepaymentDate.getMonthValue() == dueRepaymentPeriodDate.getMonthValue()) {
                        dueRepaymentPeriodDate = dueRepaymentPeriodDate.plusMonths(1);
                    }
                }

//                if(dueRepaymentPeriodDate.getMonth().getValue() !=2){
//
