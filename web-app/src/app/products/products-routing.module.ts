...
import { LoanProductServierFeeResolver } from './loan-products/loan-product-servier-fee.resolver';
// import { LoanProductServicerFeeConfigResolver } from './loan-products/loan-product-servicer-fee-config.resolver';
...
const routes: Routes = [
  Route.withShell([
    {
      path: 'products',
      data: { title: extract('Products'), breadcrumb: 'Products',routePermission:'READ_PRODUCT'},
      children: [
        {
          path: '',
        ...
        {
          path: 'loan-products',
          data: { title: extract('Loan Products'), breadcrumb: 'Loan Products', routePermission: 'READ_LOANPRODUCT'},
          children: [
            {
              path: '',
            ...
            },
            {
              ...
              data: { title: extract('Create Loan Product'), breadcrumb: 'Create', routePermission: 'CREATE_LOANPRODUCT'},
              resolve: {
              ...
              children: [
                {
                  ...
                  resolve: {
                    loanProduct: LoanProductResolver,
                    loanServiceData: LoanProductServierFeeResolver,
                ...
                },
                {
                  ...
                  data: { title: extract('Edit Loan Product'), breadcrumb: 'Edit', routeParamBreadcrumb: false, routePermission: 'UPDATE_LOANPRODUCT'},
                  resolve: {
        ...
        },
        {
          ...
          data: { title: extract('Saving Products'), breadcrumb: 'Saving Products',routePermission:'READ_SAVINGSPRODUCT' },
          children: [
            {
              path: '',
            ...
            },
            {
              ...
              data: { title: extract('Create Saving Product'), breadcrumb: 'Create',routePermission: 'CREATE_SAVINGSPRODUCT' },
              resolve: {
            ...
            },
            {
              ...
              children: [
                ...
                },
                {
                  ...
                  data: { title: extract('Edit Saving Product'), breadcrumb: 'Edit', routeParamBreadcrumb: false,routePermission:'UPDATE_SAVINGSPRODUCT' },
                  resolve: {
        ...
        },
        {
          ...
          children: [
            ...
            },
            {
              ...
              data: { title: extract('Create Share Product'), breadcrumb: 'Create',routePermission:'CREATE_SHAREPRODUCT' },
              resolve: {
            ...
            },
            {
              ...
              children: [
                ...
                },
                {
                  ...
                  data: { title: extract('Edit Share Product'), breadcrumb: 'Edit', routeParamBreadcrumb: false,routePermission:'UPDATE_SHAREPRODUCT' },
                  resolve: {
                ...
                {
                  path: 'dividends',
                  data: { title: extract('Share Products Dividends'), breadcrumb: 'Dividends', routeParamBreadcrumb: false,routePermission:'READ_DIVIDEND_SHAREPRODUCT'},
                  children: [
                    {
                      path: '',
                    ...
                    },
                    {
                      ...
                      data: { title: extract('Create Dividend'), breadcrumb: 'Create', routeParamBreadcrumb: false,routePermission:'CREATE_DIVIDEND_SHAREPRODUCT' },
                      resolve: {
                        shareProduct: ShareProductResolver
                      }
                    },
        ...
        },
        {
          ...
          children: [
            ...
            {
              path: 'tax-components',
              data: { title: extract('Manage Tax Components'), breadcrumb: 'Tax Components',routePermission:'READ_TAXCOMPONENT'},
              children: [
                {
                  path: '',
                ...
                },
                {
                  ...
                  data: { title: extract('Create Tax Component'), breadcrumb: 'Create',routePermission:'CREATE_TAXCOMPONENT' },
                  resolve: {
                ...
                },
                {
                  ...
                  children: [
                    ...
                    {
                      path: 'edit',
                      data: { title: extract('Edit Tax Component'), breadcrumb: 'Edit', routeParamBreadcrumb: false,routePermission:'UPDATE_TAXCOMPONENT' },
            ...
            {
              path: 'tax-groups',
              data: { title: extract('Manage Tax Groups'), breadcrumb: 'Tax Groups',routePermission:'READ_TAXGROUP'},
              children: [
                {
                  path: '',
                ...
                },
                {
                  ...
                  data: { title: extract('Create Tax Group'), breadcrumb: 'Create',routePermission:'CREATE_TAXGROUP' },
                  resolve: {
                ...
                },
                {
                  ...
                  children: [
                    ...
                    {
                      path: 'edit',
                      data: { title: extract('Edit Tax Group'), breadcrumb: 'Edit', routeParamBreadcrumb: false,routePermission:'UPDATE_TAXGROUP' },
        ...
        },
        {
          ...
          data: { title:  extract('Recurring Deposit Products'), breadcrumb: 'Recurring Deposit Products',routePermission:'READ_RECURRINGDEPOSITPRODUCT' },
          children: [
            {
              path: 'create',
              component: CreateRecurringDepositProductComponent,
              data: { title: extract('Create Recurring Deposit Product'), breadcrumb: 'Create',routePermission:'CREATE_RECURRINGDEPOSITPRODUCT' },
              resolve: {
            ...
            },
            {
              ...
              children: [
                ...
                {
                  path: 'edit',
                  data: { title: extract('Edit Recurring Deposit Product'), breadcrumb: 'edit', routeParamBreadcrumb: false,routePermission:'UPDATE_RECURRINGDEPOSITPRODUCT' },
        ...
        },
        {
          ...
          data: { title:  extract('Fixed Deposit Products'), breadcrumb: 'Fixed Deposit Products',routePermission:'READ_FIXEDDEPOSITPRODUCT' },
          children: [
            {
              path: 'create',
              component: CreateFixedDepositProductComponent,
              data: { title: extract('Create Fixed Deposit Product'), breadcrumb: 'Create',routePermission:'CREATE_FIXEDDEPOSITPRODUCT' },
              resolve: {
            ...
            },
            {
              ...
              children: [
                ...
                {
                  path: 'edit',
                  data: { title: extract('Edit Fixed Deposit Product'), breadcrumb: 'edit', routeParamBreadcrumb: false,routePermission:'UPDATE_FIXEDDEPOSITPRODUCT' },
        ...
        {
          path: 'products-mix',
          data: { title:  extract('Products Mix'), breadcrumb: 'Products Mix',routePermission:'READ_PRODUCTMIX' },
          children: [
            {
              path: 'create',
              component: CreateProductMixComponent,
              data: { title: extract('Create Product Mix'), breadcrumb: 'Create',routePermission:'CREATE_PRODUCTMIX' },
              resolve: {
            ...
            },
            {
              ...
              children: [
                ...
                {
                  path: 'edit',
                  data: { title: extract('Edit Product Mix'), breadcrumb: 'Edit', routeParamBreadcrumb: false,routePermission:'UPDATE_PRODUCTMIX' },
        ...
        {
          path: 'floating-rates',
          data: { title: extract('Floating Rates'), breadcrumb: 'Floating Rates',routePermission:'READ_FLOATINGRATE' },
          children: [
            {
              path: '',
            ...
            },
            {
              ...
              data: { title: extract('Create Floating Rate'), breadcrumb: 'Create',routePermission:'CREATE_FLOATINGRATE' }
            },
            {
              path: ':id',
              ...
              children: [
                ...
                },
                {
                  ...
                  data: { title: extract('Edit Floating Rate'), breadcrumb: 'Edit', routeParamBreadcrumb: false,routePermission:'UPDATE_FLOATINGRATE' },
                  resolve: {
                    floatingRate: FloatingRateResolver
                  }
                }
        ...
        {
          path: 'charges',
          data: { title: extract('Charges'), breadcrumb: 'Charges',routePermission:'READ_CHARGE' },
          children: [
            {
              path: 'create',
              component: CreateChargeComponent,
              data: { title: extract('Create Charge'), breadcrumb: 'Create Charge',routePermission:'CREATE_CHARGE' },
              resolve: {
            ...
            },
            {
              ...
              children: [
                ...
                },
                {
                  ...
                  data: { title: extract('Edit Charge'), breadcrumb: 'Edit', routeParamBreadcrumb: false,routePermission:'UPDATE_CHARGE' },
                  resolve: {
...
@NgModule({
  ...
  providers: [
    ...
    LoanProductResolver,
    LoanProductServierFeeResolver,
//    LoanProductServicerFeeConfigResolver,
