...
public interface LoanScheduleModelPeriod {
    ...
    BigDecimal selfPrincipal();

    BigDecimal partnerPrincipal();

    BigDecimal selfInterestCharged();

    BigDecimal partnerInterestCharged();

    BigDecimal selfDue();

    BigDecimal partnerDue();
    ...
    void addSelfPrincipal(Money selfPrincipal);
    void addPartnerPrincipal(Money partnerPrincipal);
    void addSelfInterestCharged(Money selfInterestCharged);
    void addPartnerInterestCharged(Money partnerInterestCharged);
