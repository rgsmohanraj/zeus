 ...
 * under the License.
 */
package org.vcpl.lms.useradministration.api;
...
import org.vcpl.lms.useradministration.data.PermissionData;
import org.vcpl.lms.useradministration.service.PermissionReadPlatformService;
...
@Tag(name = "Permissions", description = "An API capability to support management of application permissions for user administration.\n"
        + "\n" + "There is no Zeus functionality for creating or deleting permissions. Permissions come pre-installed.\n" + "\n"
...
public class PermissionsApiResource {
    ...
    @Operation(summary = "List Application Permissions", description = "ARGUMENTS\n"
            ...
            + "\n" + "Note: Each Zeus transaction is associated with a permission.\n" + "\n" + "Example Requests:\n" + "\n"
