 ...
 * under the License.
 */
package org.vcpl.lms.portfolio.collectionsheet.service;

import static org.vcpl.lms.portfolio.collectionsheet.CollectionSheetConstants.calendarIdParamName;
import static org.vcpl.lms.portfolio.collectionsheet.CollectionSheetConstants.officeIdParamName;
import static org.vcpl.lms.portfolio.collectionsheet.CollectionSheetConstants.staffIdParamName;
...
import org.vcpl.lms.portfolio.calendar.domain.CalendarRepositoryWrapper;
...
import org.vcpl.lms.portfolio.collectionsheet.data.IndividualClientData;
import org.vcpl.lms.portfolio.collectionsheet.data.IndividualCollectionSheetData;
import org.vcpl.lms.portfolio.collectionsheet.data.IndividualCollectionSheetLoanFlatData;
import org.vcpl.lms.portfolio.collectionsheet.data.JLGClientData;
import org.vcpl.lms.portfolio.collectionsheet.data.JLGCollectionSheetData;
import org.vcpl.lms.portfolio.collectionsheet.data.JLGCollectionSheetFlatData;
import org.vcpl.lms.portfolio.collectionsheet.data.JLGGroupData;
import org.vcpl.lms.portfolio.collectionsheet.data.LoanDueData;
import org.vcpl.lms.portfolio.collectionsheet.data.SavingsDueData;
import org.vcpl.lms.portfolio.collectionsheet.serialization.CollectionSheetGenerateCommandFromApiJsonDeserializer;
...
import org.vcpl.lms.portfolio.meeting.attendance.service.AttendanceDropdownReadPlatformService;
import org.vcpl.lms.portfolio.meeting.attendance.service.AttendanceEnumerations;
...
public class CollectionSheetReadPlatformServiceImpl implements CollectionSheetReadPlatformService {
    ...
    private static final class JLGCollectionSheetFaltDataMapper implements RowMapper<JLGCollectionSheetFlatData> {
        ...
        public JLGCollectionSheetFlatData mapRow(final ResultSet rs, @SuppressWarnings("unused") final int rowNum) throws SQLException {
            ...
            final BigDecimal selfPrincipal = rs.getBigDecimal("selfPrincipal");
            final BigDecimal partnerPrincipal = rs.getBigDecimal("partnerPrincipal");
            final BigDecimal selfInterestCharged = rs.getBigDecimal("selfInterestCharged");
            final BigDecimal partnerInterestCharged = rs.getBigDecimal("partnerInterestCharged");
            final BigDecimal selfDue = rs.getBigDecimal("selfDue");
            final BigDecimal partnerDue = rs.getBigDecimal("partnerDue");
            ...
            return new JLGCollectionSheetFlatData(groupName, groupId, staffId, staffName, levelId, levelName, clientName, clientId, loanId,
                    ...
                    interestDue, interestPaid, chargesDue, attendanceType, feeDue, feePaid,selfPrincipal,partnerPrincipal,selfInterestCharged,partnerInterestCharged,selfDue,partnerDue);
        }
    ...
    private static final class IndividualCollectionSheetFaltDataMapper implements RowMapper<IndividualCollectionSheetLoanFlatData> {
        ...
        public IndividualCollectionSheetLoanFlatData mapRow(ResultSet rs, @SuppressWarnings("unused") int rowNum) throws SQLException {
            ...
            final BigDecimal feeDue = rs.getBigDecimal("feeDue");
            final BigDecimal feePaid = rs.getBigDecimal("feePaid");
            final BigDecimal selfPrincipal = rs.getBigDecimal("feePaid");
            final BigDecimal partnerPrincipal = rs.getBigDecimal("feePaid");
            final BigDecimal selfInterestCharged = rs.getBigDecimal("feePaid");
            final BigDecimal partnerInterestCharged = rs.getBigDecimal("feePaid");
            final BigDecimal selfDue = rs.getBigDecimal("selfDue");
            final BigDecimal partnerDue = rs.getBigDecimal("partnerDue");
            ...
            return new IndividualCollectionSheetLoanFlatData(clientName, clientId, loanId, accountId, accountStatusId, productShortName,
                    ...
                    feePaid,selfPrincipal,partnerPrincipal,selfInterestCharged,partnerInterestCharged,selfDue,partnerDue);
        }
