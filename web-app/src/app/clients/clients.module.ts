...
import { ClientBeneficiaryTabComponent } from './clients-view/client-beneficiary-tab/client-beneficiary-tab.component';
...
@NgModule({
  ...
  declarations: [
    ...
    ClientBeneficiaryStepperComponent,
    ClientDetailsTabComponent,
    ClientBeneficiaryTabComponent,
    AadharUpdateDialogComponent
  ],
  providers: [ ],
