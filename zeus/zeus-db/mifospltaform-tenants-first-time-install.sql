...
--
-- Host: localhost    Database: lms_tenants
-- ------------------------------------------------------
...
(1,'default','default','lms_default','Asia/Kolkata',NULL,NULL,NULL,NULL,'localhost','3306',NULL,'root','mysql',1,5,30000,1,60,1,50,1,40,20,10,60,34000,60000);
