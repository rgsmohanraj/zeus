...
import { LoanProductSignatureStepComponent } from './loan-products/loan-product-stepper/loan-product-signature-step/loan-product-signature-step.component';
import { LoanProductServicerFeeStepComponent } from './loan-products/loan-product-stepper/loan-product-servicer-fee-step/loan-product-servicer-fee-step.component';
import { LoanProductCollectionStepComponent } from './loan-products/loan-product-stepper/loan-product-collection-step/loan-product-collection-step.component';
...
@NgModule({
  ...
  declarations: [
    ...
    LoanProductSignatureStepComponent,
    LoanProductServicerFeeStepComponent,
    LoanProductCollectionStepComponent,
  ],
  providers: [ ]
})
