...
export class TransactionsTabComponent implements OnInit {
  ...
  displayedColumns: string[] = ['transactionDate','valueDate', 'transactionType', 'amount', 'principal', 'interest', 'advance','fee', 'penalties', 'bounce', 'loanBalance', 'actions'];
  displayedColumnsSplit: string[] = ['transactionDate','valueDate', 'transactionType', 'amount', 'principal', 'interest','fee', 'penalties', 'bounce', 'loanBalance', 'actions'];
  ...
  ngOnInit() {
    ...
    /** this.transactions.forEach((element: any) => {
           if (element.amount==0) {
             this.transactions = this.removeItem(this.transactions, element);
           }
         });*/
