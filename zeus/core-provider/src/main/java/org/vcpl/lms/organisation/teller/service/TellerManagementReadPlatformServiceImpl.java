...
import org.vcpl.lms.organisation.teller.data.CashierData;
import org.vcpl.lms.organisation.teller.data.CashierTransactionData;
import org.vcpl.lms.organisation.teller.data.CashierTransactionTypeTotalsData;
import org.vcpl.lms.organisation.teller.data.CashierTransactionsWithSummaryData;
import org.vcpl.lms.organisation.teller.data.TellerData;
import org.vcpl.lms.organisation.teller.data.TellerJournalData;
import org.vcpl.lms.organisation.teller.data.TellerTransactionData;
import org.vcpl.lms.organisation.teller.domain.CashierTxnType;
import org.vcpl.lms.organisation.teller.domain.TellerStatus;
...
public class TellerManagementReadPlatformServiceImpl implements TellerManagementReadPlatformService {
    ...
    @Cacheable(value = "tellers", key = "T(org.vcpl.lms.infrastructure.core.service.ThreadLocalContextUtil).getTenant().getTenantIdentifier().concat(#root.target.context.authenticatedUser().getOffice().getHierarchy()+'of')")
