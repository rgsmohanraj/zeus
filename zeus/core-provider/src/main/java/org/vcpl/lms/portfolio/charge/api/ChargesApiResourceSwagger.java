...
final class ChargesApiResourceSwagger {
    ...
    public static final class PostChargesRequest {
        ...
        @Schema(example = "true")
        public Boolean enableGstCharges;
        @Schema(example = "10")
        ...
        public Integer type;
        @Schema(example = "55")
        public Integer feesChargeType;
        @Schema(example = "1")
        public Integer chargeDecimal;
        @Schema(example = "Half Up")
        public String chargeRoundingMode;
        @Schema(example = "0")
        public Integer chargeDecimalRegex;
        @Schema(example = "0")
        public Integer gstDecimal;
        @Schema(example = "UP")
        public String gstRoundingMode;
        @Schema(example = "2")
        public Integer gstDecimalRegex;
        @Schema(example = "2")
        public BigDecimal gstSlabLimitValue;
        @Schema(example = "true")
        public Boolean isGstSlabEnabled;

        @Schema(example = "1")
        public Integer gstSlabLimitOperator;

        @Schema(example = "1")
        public Integer gstSlabLimitApplyFor;
    ...
    public static final class PutChargesChargeIdRequest {
        ...
        @Schema(example = "Processing Fee(changed)")
        public String name;
