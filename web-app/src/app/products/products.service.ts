...
export class ProductsService {
  ...
  createLoanProduct(loanProduct: string): Observable<any> {
   ...
   createServicerFeeLoanProduct(loanServiceData : any ): Observable<any> {
      return this.http.post('/loans/servicerfee', loanServiceData);
    }
  ...
  getLoanProduct(loanProductId: string, template: boolean = false): Observable<any> {
   ...
   getServicerFee(loanProductId: string, template: boolean = false): Observable<any> {
      const httpParams = new HttpParams().set('template', template.toString());
      return this.http.get(`/loans/servicerfee/${loanProductId}`, { params: httpParams });
    }

    getServicerFeeConfigId(loanProductId: string, template: boolean = false): Observable<any> {
    const httpParams = new HttpParams().set('template', template.toString());
    return this.http.get(`/loans/servicerfee/servicerFeeConfigId/${loanProductId}`, { params: httpParams });
  }
  ...
  updateServicerFeeLoanProduct(loanProductId: string, loanServiceData: any): Observable<any> {
    return this.http.put(`/loans/servicerfee/${loanProductId}`, loanServiceData);
    }
