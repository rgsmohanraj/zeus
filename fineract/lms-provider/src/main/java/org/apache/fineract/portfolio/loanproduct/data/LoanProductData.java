...
//    private final Integer maxValue;
    ...
    private final Integer selfInterestRate;
    ...
    private final String selectPartner;
    ...
    private final Collection<LoanProductClassData> classOptions;
    private final Collection<LoanProductTypeData> typeOptions;
...
//        final Integer maxValue = null;
        ...
        final Integer selfInterestRate =null;
        ...
        final Integer interestRate =null;
        final String selectPartner =null;
        ...
        return new LoanProductData(id, name, shortName, description, currency, principal, minPrincipal, maxPrincipal, tolerance,
                ...
                fixedPrincipalPercentagePerInstallment,classId,typeId,coBorrower,eodBalance,securedLoan,nonEquatedInstallment,
...
//        final Integer maxValue = null;
        ...
        return new LoanProductData(id, name, shortName, description, currency, principal, minPrincipal, maxPrincipal, tolerance,
                ...
                applyForeclosureLockingPeriod,foreclosureLockingPeriod);
...
//        final Integer maxValue = null;
        ...
        return new LoanProductData(id, name, shortName, description, currency, principal, minPrincipal, maxPrincipal, tolerance,
                ...
                brokenInterestCalculationPeriod,repaymentStrategyForNpaId,loanForeclosureStrategy,brokenInterestDaysInYears,brokenInterestDaysInMonth,
                brokenInterestStrategy,enableColendingLoan,byPercentageSplit,selfPrincipalShare,selfFeeShare,selfPenaltyShare,
                selfOverpaidShares,selfInterestRate, principalShare,feeShare,penaltyShare,overpaidShare,interestRate,selectPartner,enableChargeWiseBifacation,
                ...
                applyPrepaidLockingPeriod,prepayLockingPeriod,applyForeclosureLockingPeriod,foreclosureLockingPeriod);
...
//        final Integer maxValue = null;
    ...
    public LoanProductData(final Long id, final String name, final String shortName, final String description, final CurrencyData currency,
                           ...
                           final BigDecimal fixedPrincipalPercentagePerInstallment,final Long classId,final Long typeId,final boolean coBorrower,final boolean eodBalance,
                           final boolean securedLoan,final boolean nonEquatedInstallment,
                           final boolean advanceEMI,final boolean termBasedOnLoanCycle,final boolean isNetOffApplied,final boolean allowApprovalOverAmountApplied,
                           ...
                           final String brokenInterestDaysInYears,final String brokenInterestDaysInMonth,final String brokenInterestStrategy,final boolean enableColendingLoan,final boolean byPercentageSplit,final Integer selfPrincipalShare,final Integer selfFeeShare,
                           final Integer selfPenaltyShare,final Integer selfOverpaidShares,final Integer selfInterestRate,final Integer principalShare,final Integer feeShare,final Integer penaltyShare,
                           final Integer overpaidShare, final Integer interestRate,
                           final String selectPartner,
                           final boolean enableChargeWiseBifacation,final String selectCharge,
                           final Integer colendingCharge,
                           final Integer selfCharge,
                           final Integer partnerCharge,final Boolean selectAcceptedDates,final String acceptedDateType,final Integer acceptedStartDate,final Integer acceptedEndDate,final Integer acceptedDate,
                           final boolean applyPrepaidLockingPeriod,final Integer prepayLockingPeriod,final boolean applyForeclosureLockingPeriod,final Integer foreclosureLockingPeriod) {
        this.id = id;
        this.name = name;
...
//        this.maxValue = maximumValue;
    ...
    public LoanProductData(final LoanProductData productData, final Collection<ChargeData> chargeOptions,
                           ...
                           final Collection<FundData> fundOptions, final Collection<LoanProductClassData> classOptions, final Collection<LoanProductTypeData> typeOptions, Collection<TransactionProcessingStrategyData> transactionStrategyOptions,
...
//       this.repaymentStrategyForNpa = productData.repaymentStrategyForNpa;
        ...
        this.selectPartner=productData.selectPartner;
...
//        this.allowAgeCriteria = productData.allowAgeCriteria;
//        this.minValue = productData.minValue;
//        this.maxValue = productData.maxValue;
...
//    }
    ...
    public Collection<LoanProductClassData> getClassOptions() {
        return this.classOptions;
    }

    public Collection<LoanProductTypeData> getTypeOptions() {
