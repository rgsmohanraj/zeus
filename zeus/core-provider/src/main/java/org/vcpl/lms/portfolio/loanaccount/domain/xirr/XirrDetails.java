...
class XirrDetails {
    public static Collector<XirrTransaction, XirrDetails, XirrDetails> collector() {
        return Collector.of(XirrDetails::new, XirrDetails::accumulate,
                XirrDetails::combine,
    ...
    public void accumulate(final XirrTransaction tx) {
