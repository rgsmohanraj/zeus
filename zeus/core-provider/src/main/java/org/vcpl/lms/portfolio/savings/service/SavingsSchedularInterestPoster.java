...
import org.vcpl.lms.batch.command.CommandStrategyProvider;
import org.vcpl.lms.batch.service.ResolutionHelper;
...
public class SavingsSchedularInterestPoster implements Callable<Void> {
    ...
    private ZeusPlatformTenant tenant;
    ...
    public void setTenant(ZeusPlatformTenant tenant) {
        this.tenant = tenant;
    }
    ...
    public Void call() throws org.vcpl.lms.infrastructure.jobs.exception.JobExecutionException {
