...
//    public static final String TRANSACTIONTYPEPREFERENCE = "TransactionTypePreference";
    ...
    public static final String beneficiaryAccountNumberParamName = "beneficiaryAccountNumber";
    public static final String ifscCodeParamName = "ifscCode";
    public static final String micrCodeParamName = "micrCode";
    public static final String voterIdParamName = "voterId";
    public static final String passportNumberParamName = "passportNumber";
    public static final String drivingLicenseParamName = "drivingLicense";
    public static final String swiftCodeParamName = "swiftCode";
    public static final String branchParamName = "branch";
    ...
    public static final String repaymentModeIdParamName = "repaymentModeId";
    public static final String repaymentModeParamName = "repaymentMode";
//    public static final String transactionTypePreferenceIdParamName = "transactionTypePreferenceId";
//    public static final String transactionTypePreferenceParamName = "transactionTypePreference";
    ...
    public static final String aadhaarParamName = "aadhaar";
    ...
    public static final String maskAadhaarPrefix = "XXXXXXXX";

    public static final String rationCardNumberParamName = "rationCardNumber";
    /**
     *
     */
    ...
    protected static final Set<String> CLIENT_RESPONSE_DATA_PARAMETERS = new HashSet<>(Arrays.asList(idParamName, accountNoParamName,
            ...
            lastnameParamName,beneficiaryNameParamName,cityParamName,beneficiaryAccountNumberParamName,ifscCodeParamName,micrCodeParamName,swiftCodeParamName,branchParamName, fullnameParamName, displayNameParamName, mobileNoParamName,ageParamName, emailAddressParamName, officeIdParamName,
            ...
            staffOptionsParamName, dateOfBirthParamName, genderParamName,stateParamName,repaymentModeParamName, clientTypeParamName, clientClassificationParamName,
            legalFormParamName, clientNonPersonDetailsParamName, isStaffParamName,panParamName,aadhaarParamName,accountTypeParamName,voterIdParamName,passportNumberParamName,drivingLicenseParamName,addressParamName,pincodeParamName,rationCardNumberParamName));
