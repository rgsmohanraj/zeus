...
public enum LoanStatus {
    ...
    FORECLOSED(710, "loanStatusType.foreclosed.reschedule.outstanding.amount"),
    COOLING_OFF(720, "loanStatusType.coolingOff.reschedule.outstanding.amount");
    ...
    public static LoanStatus fromInt(final Integer statusValue) {
        ...
        switch (statusValue) {
            ...
            break;
            case 710:
                enumeration = LoanStatus.FORECLOSED;
                break;
            case 720:
                enumeration = LoanStatus.COOLING_OFF;
                break;
        }
        return enumeration;
    }
    ...
    public boolean isForeclosed() {
        return this.value.equals(LoanStatus.FORECLOSED.getValue());
    }

    public boolean isLoanCoolingOff() {
        return this.value.equals(LoanStatus.COOLING_OFF.getValue());
    }
}
